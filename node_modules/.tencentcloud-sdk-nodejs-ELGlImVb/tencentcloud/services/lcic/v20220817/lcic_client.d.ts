...
import { CreateRoomRequest, DescribeQuestionListRequest, ModifyRoomResponse, LoginOriginIdRequest, DescribeAppDetailResponse, DeleteSupervisorRequest, DeleteUserRequest, DescribeSupervisorsResponse, DescribeWhiteBoardSnapshotRequest, DeleteUserResponse, DeleteWhiteBoardSnapshotRequest, BatchDeleteRecordRequest, DescribePlayRecordsResponse, ModifyAppResponse, UnblockKickedUserResponse, CreateGroupLiveCodesRequest, BatchRegisterRequest, StartRecordRequest, DeleteRoomResponse, ModifyUserProfileRequest, CreateGroupWithMembersRequest, DescribeDocumentsByRoomRequest, BatchCreateGroupWithMembersResponse, CreateGroupLiveCodesResponse, DeleteAppCustomContentRequest, SendRoomNotificationMessageResponse, BatchAddGroupMemberResponse, ModifyUserProfileResponse, GetWatermarkResponse, DescribePlaybackListResponse, BatchRegisterResponse, LoginOriginIdWithRoomRequest, BindDocumentToRoomResponse, StopRecordResponse, CreateGroupWithSubGroupRequest, DescribeLiveRelayConfigResponse, DescribeRoomForbiddenUserRequest, DescribeRoomRequest, BatchDescribeDocumentRequest, RegisterUserRequest, BatchCreateRoomResponse, DescribeEditVersionsRequest, LoginUserWithRoomRequest, UnbindDocumentFromRoomResponse, CreateDocumentResponse, DescribeMarqueeRequest, SetWatermarkRequest, DescribeGroupResponse, SetAppCustomContentResponse, UnblockKickedUserRequest, DeleteWhiteBoardSnapshotResponse, LoginUserResponse, ModifyGroupRequest, DescribeAppDetailRequest, KickUserFromRoomResponse, DeleteGroupRequest, StartRoomRequest, AddGroupMemberRequest, DescribeGroupListRequest, GetRoomMessageRequest, DescribeDocumentsResponse, DescribeRecordRequest, DeleteDocumentResponse, DeleteRecordRequest, BatchDeleteGroupMemberResponse, CreateGroupWithSubGroupResponse, DescribeDocumentsRequest, GetRoomEventRequest, DescribeRecordResponse, DescribeDocumentResponse, DeleteGroupMemberResponse, DescribeGroupMemberListResponse, SetMarqueeRequest, ForbidSendMsgRequest, DescribeGroupLiveCodesRequest, DescribeScoreListRequest, DescribeRecordStreamRequest, DeleteRecordResponse, DescribeAnswerListRequest, BatchCreateRoomRequest, DescribeGroupMemberListRequest, DescribeRoomForbiddenUserResponse, DescribeUserResponse, GetEditVersionTokenRequest, DescribeScoreListResponse, DescribeDocumentRequest, BatchDeleteRecordResponse, BatchGetPlaybackTokenRequest, SetAppCustomContentRequest, DescribeUserRequest, RegisterUserResponse, DescribeLiveRelayConfigRequest, DescribePlaybackListRequest, BindDocumentToRoomRequest, CreateDocumentRequest, GetRoomMessageResponse, BatchAddGroupMemberRequest, StartRecordResponse, LoginUserWithRoomResponse, DescribeUserDetailResponse, DescribeRoomResponse, LoginOriginIdWithRoomResponse, DescribeRecordStreamResponse, DescribeCurrentMemberListRequest, SendRoomNotificationMessageRequest, GetEditVersionTokenResponse, DescribeSdkAppIdUsersResponse, DescribeAnswerListResponse, DescribeGroupLiveCodesResponse, DescribeRoomStatisticsResponse, DeleteDocumentRequest, DescribeRecordTaskResponse, DescribeSupervisorsRequest, DeleteGroupMemberRequest, EndRoomResponse, GetPlaybackTokenRequest, EndRoomRequest, SetMainEditVersionResponse, DescribeEditVersionsResponse, CreateGroupWithMembersResponse, BatchDeleteGroupMemberRequest, ModifyAppRequest, UnbindDocumentFromRoomRequest, LoginUserRequest, StopRecordRequest, GetRoomEventResponse, ModifyLiveRelayConfigResponse, GetPlaybackTokenResponse, SendRoomNormalMessageResponse, DeleteSupervisorResponse, SetWatermarkResponse, DescribeMarqueeResponse, DescribeRoomStatisticsRequest, DescribeDocumentsByRoomResponse, LoginOriginIdResponse, DescribeQuestionListResponse, DescribeUserDetailRequest, GetRoomsResponse, SetMarqueeResponse, KickUserFromRoomRequest, SetMainEditVersionRequest, GetRoomsRequest, BatchGetPlaybackTokenResponse, ForbidSendMsgResponse, SendRoomNormalMessageRequest, DescribeRecordTaskRequest, DescribeDeveloperRequest, BatchDescribeDocumentResponse, DeleteGroupResponse, CreateRoomResponse, DescribeWhiteBoardSnapshotResponse, DescribeSdkAppIdUsersRequest, AddGroupMemberResponse, StartRoomResponse, CreateSupervisorResponse, DeleteRoomRequest, BatchCreateGroupWithMembersRequest, ModifyLiveRelayConfigRequest, DescribeGroupRequest, CreateSupervisorRequest, DeletePlaybackItemRequest, DeleteAppCustomContentResponse, ModifyGroupResponse, DescribeCurrentMemberListResponse, GetWatermarkRequest, DescribeGroupListResponse, ModifyRoomRequest, DescribeDeveloperResponse, DeletePlaybackItemResponse, DescribePlayRecordsRequest } from "./lcic_models";
/**
 * lcic client
 * @class
 */
...
注意：不支持屏幕共享中的板书导出。
     ...
     * 获取课堂的所有编辑版本（含源版本）
     */
    DescribeEditVersions(req: DescribeEditVersionsRequest, cb?: (error: string, rep: DescribeEditVersionsResponse) => void): Promise<DescribeEditVersionsResponse>;
    /**
     * 开始录制
     */
     ...
     * 获取转推配置
     */
    DescribeLiveRelayConfig(req: DescribeLiveRelayConfigRequest, cb?: (error: string, rep: DescribeLiveRelayConfigResponse) => void): Promise<DescribeLiveRelayConfigResponse>;
    /**
     * 获取文档信息
     */
     ...
     * 切换课堂的主编辑版本
     */
    SetMainEditVersion(req: SetMainEditVersionRequest, cb?: (error: string, rep: SetMainEditVersionResponse) => void): Promise<SetMainEditVersionResponse>;
    /**
     ...
     */
    LoginOriginIdWithRoom(req: LoginOriginIdWithRoomRequest, cb?: (error: string, rep: LoginOriginIdWithRoomResponse) => void): Promise<LoginOriginIdWithRoomResponse>;
    /**
     ...
     * 创建分组直播参加码
     */
    CreateGroupLiveCodes(req: CreateGroupLiveCodesRequest, cb?: (error: string, rep: CreateGroupLiveCodesResponse) => void): Promise<CreateGroupLiveCodesResponse>;
    /**
     ...
     * 登录课堂
     */
    LoginUserWithRoom(req: LoginUserWithRoomRequest, cb?: (error: string, rep: LoginUserWithRoomResponse) => void): Promise<LoginUserWithRoomResponse>;
    /**
     * 获取群组列表
     */
...
被禁言用户退出房间之后再进入同一房间，禁言仍然有效。
     ...
     * 修改转推配置
     */
    ModifyLiveRelayConfig(req: ModifyLiveRelayConfigRequest, cb?: (error: string, rep: ModifyLiveRelayConfigResponse) => void): Promise<ModifyLiveRelayConfigResponse>;
    /**
...
删除课堂前，请先删除该课堂下的各类资源（包括录制文件、板书等），并解绑相关课件。
     ...
     * 获取分组直播参加码
     */
    DescribeGroupLiveCodes(req: DescribeGroupLiveCodesRequest, cb?: (error: string, rep: DescribeGroupLiveCodesResponse) => void): Promise<DescribeGroupLiveCodesResponse>;
    /**
     * 获取剪辑信令回放token
     */
    GetEditVersionToken(req: GetEditVersionTokenRequest, cb?: (error: string, rep: GetEditVersionTokenResponse) => void): Promise<GetEditVersionTokenResponse>;
    /**
     * 此接口会聚合子群组创建联合群组
     */
