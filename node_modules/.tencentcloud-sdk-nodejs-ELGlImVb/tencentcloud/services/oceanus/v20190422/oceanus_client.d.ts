...
import { ParseConnectorRequest, CreateResourceRequest, ModifyFolderRequest, DescribeJobSubmissionLogResponse, DeleteJobsRequest, ModifyWorkSpaceRequest, ModifyJobResponse, ModifyMetaTableResponse, CreateJobConfigResponse, CreateResourceConfigResponse, CreateJobConfigRequest, DescribeTreeJobsResponse, CopyJobsRequest, CopyJobsResponse, CreateConnectorResponse, TriggerJobSavepointRequest, ScaleOceanusClusterRequest, DescribeWorkSpaceUsersResponse, DescribeJobConfigsRequest, StopJobsRequest, CreateMetaDatabaseRequest, RunSqlGatewayStatementRequest, DescribeFolderResponse, ModifyConnectorRequest, RenewOceanusClusterResponse, DescribeWorkSpacesRequest, CreateOceanusClusterResponse, DescribeTreeResourcesRequest, DescribeResourceConfigsResponse, DescribeClustersRequest, CreateWorkSpaceResponse, CreateJobResponse, DeleteResourcesResponse, DescribeVariablesRequest, DescribeJobRuntimeInfoResponse, CreateFolderRequest, DeleteJobConfigsResponse, DeleteTableConfigRequest, CreateConnectorRequest, DeleteTableConfigResponse, GetMetaTableResponse, FetchSqlGatewayStatementResultResponse, DescribeJobSavepointResponse, ModifyMetaTableRequest, CreateWorkSpaceRequest, DeleteResourceConfigsRequest, DescribeVariablesResponse, DeleteFoldersRequest, DeleteWorkSpaceRequest, DescribeJobRuntimeInfoRequest, DescribeWorkSpacesResponse, CreateOceanusClusterRequest, CreateResourceResponse, DescribeSystemResourcesRequest, CreateFolderResponse, DescribeResourcesResponse, DescribeResourceRelatedJobsResponse, DescribeClustersResponse, CheckConnectorNameResponse, DescribeSystemResourcesResponse, CheckSavepointRequest, DeleteJobConfigsRequest, RenewOceanusClusterRequest, CreateMetaTableResponse, RunJobsRequest, DeleteWorkSpaceResponse, TriggerJobSavepointResponse, DeleteJobsResponse, CreateMetaTableRequest, RunSqlGatewayStatementResponse, DescribeResourceRelatedJobsRequest, DescribeTreeResourcesResponse, CreateVariableResponse, DeleteResourcesRequest, RunJobsResponse, DescribeJobSavepointRequest, ModifyJobRequest, GetMetaTableRequest, DeleteResourceConfigsResponse, CreateVariableRequest, DeleteOceanusClusterRequest, DescribeJobSubmissionLogRequest, DescribeJobsRequest, DescribeResourceConfigsRequest, ModifyFolderResponse, ModifyWorkSpaceResponse, CreateJobRequest, ScaleOceanusClusterResponse, DescribeFolderRequest, DescribeWorkSpaceUsersRequest, DeleteFoldersResponse, ParseConnectorResponse, CreateResourceConfigRequest, ModifyConnectorResponse, CheckConnectorNameRequest, StopJobsResponse, DescribeResourcesRequest, DescribeJobEventsRequest, CheckSavepointResponse, DeleteOceanusClusterResponse, DescribeJobsResponse, CreateMetaDatabaseResponse, DescribeTreeJobsRequest, DescribeJobConfigsResponse, FetchSqlGatewayStatementResultRequest, DescribeJobEventsResponse } from "./oceanus_models";
/**
 * oceanus client
 * @class
 */
export declare class Client extends AbstractClient {
     ...
     * 修改元数据表
     */
    ModifyMetaTable(req: ModifyMetaTableRequest, cb?: (error: string, rep: ModifyMetaTableResponse) => void): Promise<ModifyMetaTableResponse>;
    /**
     ...
     * 创建Connector
     */
    CreateConnector(req: CreateConnectorRequest, cb?: (error: string, rep: CreateConnectorResponse) => void): Promise<CreateConnectorResponse>;
    /**
     * 创建元数据库
     */
    CreateMetaDatabase(req: CreateMetaDatabaseRequest, cb?: (error: string, rep: CreateMetaDatabaseResponse) => void): Promise<CreateMetaDatabaseResponse>;
    /**
     * 查找Savepoint列表
     */
     ...
     * 销毁Oceanus集群
     */
    DeleteOceanusCluster(req: DeleteOceanusClusterRequest, cb?: (error: string, rep: DeleteOceanusClusterResponse) => void): Promise<DeleteOceanusClusterResponse>;
    /**
     * 查询作业实例启动日志
     */
     ...
     * 创建变量
     */
    CreateVariable(req: CreateVariableRequest, cb?: (error: string, rep: CreateVariableResponse) => void): Promise<CreateVariableResponse>;
    /**
     * 作业列表删除文件夹
     */
     ...
     * 工作空间用户列表
     */
    DescribeWorkSpaceUsers(req: DescribeWorkSpaceUsersRequest, cb?: (error: string, rep: DescribeWorkSpaceUsersResponse) => void): Promise<DescribeWorkSpaceUsersResponse>;
    /**
     * 触发Savepoint
     */
     ...
     * 解析用户上传connector
     */
    ParseConnector(req: ParseConnectorRequest, cb?: (error: string, rep: ParseConnectorResponse) => void): Promise<ParseConnectorResponse>;
    /**
     * 查询资源名是否重复
     */
    CheckConnectorName(req: CheckConnectorNameRequest, cb?: (error: string, rep: CheckConnectorNameResponse) => void): Promise<CheckConnectorNameResponse>;
    /**
     * 批量删除作业接口，批量操作数量上限20
     */
     ...
     * 续费Oceanus集群
     */
    RenewOceanusCluster(req: RenewOceanusClusterRequest, cb?: (error: string, rep: RenewOceanusClusterResponse) => void): Promise<RenewOceanusClusterResponse>;
    /**
     * 自定义树状结构页面拖拽文件夹
     */
     ...
     * 创建元数据表
     */
    CreateMetaTable(req: CreateMetaTableRequest, cb?: (error: string, rep: CreateMetaTableResponse) => void): Promise<CreateMetaTableResponse>;
    /**
     * 获取资源关联作业信息
     */
     ...
     * 变量列表展示
     */
    DescribeVariables(req: DescribeVariablesRequest, cb?: (error: string, rep: DescribeVariablesResponse) => void): Promise<DescribeVariablesResponse>;
    /**
     * 查询作业
     */
...
假设作业暂停状态，则将作业更改为停止状态，中间状态丢失
     ...
     * 修改Connector
     */
    ModifyConnector(req: ModifyConnectorRequest, cb?: (error: string, rep: ModifyConnectorResponse) => void): Promise<ModifyConnectorResponse>;
    /**
     * 创建资源接口
     */
     ...
     * 扩缩容Oceanus集群
     */
    ScaleOceanusCluster(req: ScaleOceanusClusterRequest, cb?: (error: string, rep: ScaleOceanusClusterResponse) => void): Promise<ScaleOceanusClusterResponse>;
    /**
     * 创建Oceanus集群
     */
    CreateOceanusCluster(req: CreateOceanusClusterRequest, cb?: (error: string, rep: CreateOceanusClusterResponse) => void): Promise<CreateOceanusClusterResponse>;
    /**
     * 查询元数据表
     */
