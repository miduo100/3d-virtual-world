...
export declare class Client extends AbstractClient {
     ...
     * gtid校验
     */
    DescribeSyncGtidCompareReport(req: DescribeSyncGtidCompareReportRequest, cb?: (error: string, rep: DescribeSyncGtidCompareReportResponse) => void): Promise<DescribeSyncGtidCompareReportResponse>;
    /**
...
修改同步配置的完整流程：修改同步任务配置->创建修改同步任务配置的校验任务->查询修改配置的校验任务的结果->启动修改配置任务
     ...
     * gtid校验
     */
    DescribeMigrateGtidCompareReport(req: DescribeMigrateGtidCompareReportRequest, cb?: (error: string, rep: DescribeMigrateGtidCompareReportResponse) => void): Promise<DescribeMigrateGtidCompareReportResponse>;
    /**
...
调用此接口后可通过查询迁移服务列表接口`DescribeMigrationJobs`来查询当前任务状态。
     ...
     */
    DescribeCompareDiffItems(req: DescribeCompareDiffItemsRequest, cb?: (error: string, rep: DescribeCompareDiffItemsResponse) => void): Promise<DescribeCompareDiffItemsResponse>;
    /**
     * 恢复处于已暂停状态的数据同步任务。
     */
...
校验成功后,迁移任务若有修改, 则必须重新校验并通过后, 才能开始迁移
     ...
     * 本接口用于查询一致性校验任务中，不一致数据块的详情信息
     */
    DescribeSyncCompareDiffItems(req: DescribeSyncCompareDiffItemsRequest, cb?: (error: string, rep: DescribeSyncCompareDiffItemsResponse) => void): Promise<DescribeSyncCompareDiffItemsResponse>;
    /**
