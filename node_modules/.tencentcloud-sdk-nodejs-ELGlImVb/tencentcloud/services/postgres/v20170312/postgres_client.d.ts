...
import { SetAutoRenewFlagRequest, DeleteBackupPlanResponse, DescribeAccountPrivilegesResponse, DescribeDatabasesRequest, DescribeDBXlogsRequest, DescribeAuditLogsRequest, DescribeMaintainTimeWindowRequest, DescribeAccountsRequest, DeleteReadOnlyGroupResponse, OpenDBExtranetAccessRequest, CreateInstancesRequest, ModifyDBInstanceSSLConfigRequest, CreateDBInstanceNetworkAccessResponse, DescribeAvailableRecoveryTimeResponse, CreateBaseBackupRequest, ModifyDBInstanceReadOnlyGroupResponse, SwitchDBInstancePrimaryRequest, DescribeCloneDBInstanceSpecRequest, DescribeDBInstanceSecurityGroupsResponse, RestoreDBInstanceObjectsResponse, ModifyDBInstanceDeletionProtectionRequest, DeleteLogBackupResponse, ModifyReadOnlyGroupConfigRequest, AddDBInstanceToReadOnlyGroupRequest, DescribeProductConfigRequest, RemoveDBInstanceFromReadOnlyGroupRequest, CreateAccountRequest, DescribeTasksResponse, DescribeMaintainTimeWindowResponse, DescribeDedicatedClustersResponse, RenewInstanceRequest, DescribeBackupOverviewRequest, DescribeRegionsResponse, DescribeAuditInstanceListResponse, UpgradeDBInstanceMajorVersionResponse, ModifyBackupDownloadRestrictionRequest, ModifyDBInstanceDeploymentRequest, DeleteReadOnlyGroupNetworkAccessRequest, DescribeBackupPlansRequest, OpenDBExtranetAccessResponse, CreateDatabaseRequest, DescribeBackupSummariesRequest, CreateBackupPlanRequest, ModifyDBInstancesProjectResponse, CreateBaseBackupResponse, LockAccountResponse, CloneDBInstanceResponse, ModifyDBInstanceReadOnlyGroupRequest, AddDBInstanceToReadOnlyGroupResponse, CreateReadOnlyDBInstanceResponse, DescribeAvailableRecoveryTimeRequest, CloseAccountCAMRequest, DescribeDBProxySpecsResponse, DescribeTasksRequest, DescribeDBInstanceParametersRequest, DescribeOrdersResponse, DescribeBackupDownloadURLResponse, ModifyBaseBackupExpireTimeResponse, ModifyMaintainTimeWindowResponse, InquiryPriceCreateDBInstancesResponse, DeleteAuditLogFileResponse, CreateDBInstanceNetworkAccessRequest, ModifySwitchTimePeriodResponse, InquiryPriceCreateDBInstancesRequest, DescribeDefaultParametersResponse, DescribeBackupPlansResponse, DescribeDBInstancesRequest, ModifyDBInstanceSpecRequest, ModifyAccountRemarkResponse, RefreshAccountPasswordRequest, OpenAccountCAMResponse, DescribeZonesRequest, ModifyMaintainTimeWindowRequest, ModifyBackupDownloadRestrictionResponse, DescribeLogBackupsRequest, ModifyDBInstanceParametersRequest, CreateAuditLogFileResponse, DeleteDatabaseResponse, DestroyDBProxyRequest, DescribeDBInstanceAttributeRequest, ResetAccountPasswordResponse, RemoveDBInstanceFromReadOnlyGroupResponse, ModifyDBProxyAddressRequest, DescribeDatabaseObjectsRequest, DescribeParameterTemplatesResponse, UpgradeDBInstanceKernelVersionRequest, OpenAuditServiceRequest, DestroyDBProxyResponse, SwitchDBInstancePrimaryResponse, ModifyReadOnlyDBInstanceWeightResponse, ModifyDBInstanceHAConfigRequest, DescribeAuditLogFilesResponse, DeleteReadOnlyGroupNetworkAccessResponse, DescribeBackupSummariesResponse, DescribeDBErrlogsRequest, UnlockAccountResponse, DeleteBackupPlanRequest, CloneDBInstanceRequest, DeleteParameterTemplateRequest, DescribeClassesRequest, ReloadBalanceDBProxyNodeRequest, DescribeParamsEventRequest, CreateInstancesResponse, DescribeDBBackupsResponse, DescribeRegionsRequest, DescribeSlowQueryListResponse, CreateReadOnlyGroupRequest, ModifyDBInstanceSSLConfigResponse, DescribeParamsEventResponse, CloseAuditServiceResponse, ModifyDBProxyRequest, ModifyDBInstanceSecurityGroupsRequest, CloseAuditServiceRequest, DescribeDedicatedClustersRequest, CreateReadOnlyGroupNetworkAccessRequest, RestartDBInstanceRequest, DescribeDBInstanceHAConfigRequest, CreateParameterTemplateResponse, DescribeLogBackupsResponse, IsolateDBInstancesResponse, CreateDBProxyResponse, InquiryPriceUpgradeDBInstanceRequest, DescribeDBInstanceHAConfigResponse, DescribeDatabaseObjectsResponse, IsolateDBInstancesRequest, ModifyDBInstanceNameRequest, DescribeDBInstanceSSLConfigResponse, CloseAccountCAMResponse, ReloadBalanceDBProxyNodeResponse, InquiryPriceRenewDBInstanceResponse, DescribeSlowQueryAnalysisRequest, DescribeParameterTemplatesRequest, DestroyDBInstanceRequest, InquiryPriceRenewDBInstanceRequest, RenewInstanceResponse, DescribeBackupOverviewResponse, DescribeDBInstanceParametersResponse, OpenAccountCAMRequest, DescribeClassesResponse, DeleteDBInstanceNetworkAccessRequest, ModifyDBInstanceDeploymentResponse, UnlockAccountRequest, DeleteParameterTemplateResponse, ModifyReadOnlyDBInstanceWeightRequest, DescribeAuditInstanceListRequest, ModifyAccountPrivilegesResponse, DeleteDatabaseRequest, DeleteReadOnlyGroupRequest, DescribeDBBackupsRequest, SetAutoRenewFlagResponse, RestartDBInstanceResponse, DescribeReadOnlyGroupsRequest, DescribeBackupDownloadURLRequest, ModifyParameterTemplateRequest, DescribeDBVersionsResponse, ModifyAuditServiceRequest, ModifyDBInstanceSecurityGroupsResponse, ModifyDBInstanceNameResponse, UpgradeDBInstanceMajorVersionRequest, CloseDBExtranetAccessResponse, DescribeBackupDownloadRestrictionResponse, CreateReadOnlyDBInstanceRequest, DescribeCloneDBInstanceSpecResponse, DescribeZonesResponse, DescribeDatabasesResponse, DescribeProductConfigResponse, DescribeOrdersRequest, OpenAuditServiceResponse, CloseDBExtranetAccessRequest, ModifyParameterTemplateResponse, DescribeDBProxyRequest, DescribeEncryptionKeysRequest, RebalanceReadOnlyGroupRequest, ModifyBackupPlanResponse, DeleteAccountRequest, CreateReadOnlyGroupResponse, DeleteDBInstanceNetworkAccessResponse, ModifyAccountPrivilegesRequest, ModifyDBInstanceParametersResponse, ModifyReadOnlyGroupConfigResponse, ModifyAccountRemarkRequest, DescribeParameterTemplateAttributesRequest, DescribeDBErrlogsResponse, ModifyDBProxyResponse, ModifyBackupPlanRequest, DeleteBaseBackupRequest, ModifyDBProxyAddressResponse, InquiryPriceUpgradeDBInstanceResponse, DisIsolateDBInstancesResponse, ModifyDatabaseOwnerResponse, CreateParameterTemplateRequest, DescribeDBInstanceSSLConfigRequest, CreateAuditLogFileRequest, DeleteAuditLogFileRequest, ModifySwitchTimePeriodRequest, CreateAccountResponse, DescribeSlowQueryListRequest, CreateDBProxyRequest, ModifyDatabaseOwnerRequest, DisIsolateDBInstancesRequest, CreateBackupPlanResponse, LockAccountRequest, DescribeDBInstancesResponse, DescribeDBInstanceSecurityGroupsRequest, DescribeBackupDownloadRestrictionRequest, ModifyBaseBackupExpireTimeRequest, ModifyDBInstanceHAConfigResponse, CreateDatabaseResponse, RebalanceReadOnlyGroupResponse, ResetAccountPasswordRequest, DescribeSlowQueryAnalysisResponse, ModifyDBInstanceDeletionProtectionResponse, DescribeDefaultParametersRequest, DescribeDBProxyResponse, DescribeAccountPrivilegesRequest, DescribeReadOnlyGroupsResponse, RestoreDBInstanceObjectsRequest, DescribeAccountsResponse, ModifyDBInstanceChargeTypeRequest, DescribeParameterTemplateAttributesResponse, UpgradeDBInstanceKernelVersionResponse, DescribeDBVersionsRequest, ModifyDBInstancesProjectRequest, ModifyAuditServiceResponse, DestroyDBInstanceResponse, DescribeDBInstanceAttributeResponse, DescribeDBProxySpecsRequest, DeleteLogBackupRequest, DeleteBaseBackupResponse, DescribeAuditLogFilesRequest, ModifyDBInstanceSpecResponse, RefreshAccountPasswordResponse, DescribeBaseBackupsResponse, DescribeDBXlogsResponse, ModifyDBInstanceChargeTypeResponse, DescribeBaseBackupsRequest, DescribeEncryptionKeysResponse, CreateReadOnlyGroupNetworkAccessResponse, DeleteAccountResponse, DescribeAuditLogsResponse } from "./postgres_models";
/**
 * postgres client
 * @class
 */
...
注：本接口中展示的步骤为总结性步骤，可能伴随着版本迭代进行调整，不建议作为关键逻辑使用
     ...
     * 修改代理地址配置
     */
    ModifyDBProxyAddress(req: ModifyDBProxyAddressRequest, cb?: (error: string, rep: ModifyDBProxyAddressResponse) => void): Promise<ModifyDBProxyAddressResponse>;
    /**
...
- 不可逆操作：数据库一经删除，数据将无法恢复。执行前请确认已做好必要的数据备份。
     ...
     */
    ReloadBalanceDBProxyNode(req: ReloadBalanceDBProxyNodeRequest, cb?: (error: string, rep: ReloadBalanceDBProxyNodeResponse) => void): Promise<ReloadBalanceDBProxyNodeResponse>;
    /**
...
<li>半同步实例使用同步复制或异步复制的条件配置</li>
     ...
     * 查询代理可售规格
     */
    DescribeDBProxySpecs(req: DescribeDBProxySpecsRequest, cb?: (error: string, rep: DescribeDBProxySpecsResponse) => void): Promise<DescribeDBProxySpecsResponse>;
    /**
...
<li>只有主实例可以执行该操作</li>
     ...
     */
    ModifyDBProxy(req: ModifyDBProxyRequest, cb?: (error: string, rep: ModifyDBProxyResponse) => void): Promise<ModifyDBProxyResponse>;
    /**
     ...
     */
    DestroyDBProxy(req: DestroyDBProxyRequest, cb?: (error: string, rep: DestroyDBProxyResponse) => void): Promise<DestroyDBProxyResponse>;
    /**
     ...
     */
    CreateDBProxy(req: CreateDBProxyRequest, cb?: (error: string, rep: CreateDBProxyResponse) => void): Promise<CreateDBProxyResponse>;
    /**
     ...
     */
    DescribeDBProxy(req: DescribeDBProxyRequest, cb?: (error: string, rep: DescribeDBProxyResponse) => void): Promise<DescribeDBProxyResponse>;
    /**
     * 开启数据库实例的审计功能
     */
