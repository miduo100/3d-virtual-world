...
export declare class Client extends AbstractClient {
     ...
     */
    UploadSkillSecScan(req: UploadSkillSecScanRequest, cb?: (error: string, rep: UploadSkillSecScanResponse) => void): Promise<UploadSkillSecScanResponse>;
    /**
     * 解除门神规则的状态锁
     */
     ...
     * API安全事件详情查询接口
     */
    DescribeApiSecEventDetail(req: DescribeApiSecEventDetailRequest, cb?: (error: string, rep: DescribeApiSecEventDetailResponse) => void): Promise<DescribeApiSecEventDetailResponse>;
    /**
     * 查询用户所有域名的详细信息
     */
...
支持批量操作。
     ...
     * 修改域名新规则状态
     */
    ModifyOwaspDomainUpdateStatus(req: ModifyOwaspDomainUpdateStatusRequest, cb?: (error: string, rep: ModifyOwaspDomainUpdateStatusResponse) => void): Promise<ModifyOwaspDomainUpdateStatusResponse>;
    /**
     * 删除攻击日志下载任务记录
     */
     ...
     * api安全事件列表
     */
    DescribeApiSecEventList(req: DescribeApiSecEventListRequest, cb?: (error: string, rep: DescribeApiSecEventListResponse) => void): Promise<DescribeApiSecEventListResponse>;
    /**
     * clb-waf中获取防护域名列表
     */
...
3. API返回数据包最大49MB，建议启用 gzip 压缩（HTTP Request Header Accept-Encoding:gzip）。
     ...
     */
    DescribeSkillSecScanResult(req: DescribeSkillSecScanResultRequest, cb?: (error: string, rep: DescribeSkillSecScanResultResponse) => void): Promise<DescribeSkillSecScanResultResponse>;
    /**
     * 查询规则引擎的规则列表
     */
