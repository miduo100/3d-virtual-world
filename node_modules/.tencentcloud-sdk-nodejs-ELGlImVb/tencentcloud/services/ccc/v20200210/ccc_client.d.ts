...
该功能需购买语音智能体通话套餐，并且仅限自有电话号码使用。详情请参考 [语音智能体通话购买指引](https://cloud.tencent.com/document/product/679/125953)。
     ...
     * 获取AI 会话交互事件流
     */
    DescribeAICallInteractionRecords(req: DescribeAICallInteractionRecordsRequest, cb?: (error: string, rep: DescribeAICallInteractionRecordsResponse) => void): Promise<DescribeAICallInteractionRecordsResponse>;
    /**
     * 获取主被叫受保护的电话服务记录与录音
     */
