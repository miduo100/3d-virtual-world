...
export class Client extends AbstractClient {
    ...
    async DescribeNDRAssetIdentificationCursorList(req, cb) {
        return this.request("DescribeNDRAssetIdentificationCursorList", req, cb);
    }
    async DescribeUnHandleEventTabList(req, cb) {
        return this.request("DescribeUnHandleEventTabList", req, cb);
    }
    async DescribeCfwLogs(req, cb) {
    ...
    async DeleteNatFwDnatRule(req, cb) {
        return this.request("DeleteNatFwDnatRule", req, cb);
    }
    async CreateBlockIgnoreRuleList(req, cb) {
        return this.request("CreateBlockIgnoreRuleList", req, cb);
    }
    async DescribeCfwAlerts(req, cb) {
    ...
    async DescribeCfwSwitches(req, cb) {
    ...
    async CreateNatFwDnatRule(req, cb) {
        return this.request("CreateNatFwDnatRule", req, cb);
    }
    ...
    async CloseClusterNatFwSwitch(req, cb) {
    ...
    async RemoveOfflineExportTask(req, cb) {
    ...
    async DescribeNatCcnFwSwitch(req, cb) {
    ...
    async ModifyClusterFwBypass(req, cb) {
        return this.request("ModifyClusterFwBypass", req, cb);
    }
    ...
    async DescribeSerialRegion(req, cb) {
        return this.request("DescribeSerialRegion", req, cb);
    }
    ...
    async DescribeCfwStatusMonitor(req, cb) {
    ...
    async DescribeNatFwClusterRegionStatus(req, cb) {
        return this.request("DescribeNatFwClusterRegionStatus", req, cb);
    }
    ...
    async DescribeOfflineExportTask(req, cb) {
    ...
    async OpenClusterNatFwSwitch(req, cb) {
        return this.request("OpenClusterNatFwSwitch", req, cb);
    }
    async DescribeEdgeIpSimple(req, cb) {
        return this.request("DescribeEdgeIpSimple", req, cb);
    }
    async ExportLogsOffline(req, cb) {
    ...
    async DescribeCfwRiskOverview(req, cb) {
    ...
    async DescribeCfwRuleOptimization(req, cb) {
    ...
    async DescribeOfflineExportTemporaryCredentials(req, cb) {
