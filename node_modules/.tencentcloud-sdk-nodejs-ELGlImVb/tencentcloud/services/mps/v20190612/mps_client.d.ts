...
import { ModifySampleSnapshotTemplateResponse, ModifyWatermarkTemplateRequest, CreateStreamPackageSSAIChannelRequest, DescribeAigcAudioTaskRequest, DeleteStreamLinkFlowRequest, ExtractBlindWatermarkRequest, CreateAiDramaTaskRequest, DeleteStreamLinkSecurityGroupResponse, DeleteStreamPackageLinearAssemblyProgramsByChannelRequest, CreateTranscodeTemplateRequest, ProcessLiveStreamResponse, DeleteLiveRecordTemplateRequest, DescribeAnimatedGraphicsTemplatesRequest, DescribeStreamLinkSecurityGroupsResponse, CloneViralRequest, DeleteAnimatedGraphicsTemplateResponse, DescribeSmartSubtitleTemplatesRequest, DeleteScheduleResponse, DisableScheduleResponse, ManageTaskResponse, ModifyStreamPackageSSAIChannelRequest, BatchDeleteStreamLinkFlowRequest, DeleteWorkflowRequest, CreateAiFissionTaskResponse, ModifySampleSnapshotTemplateRequest, ModifyStreamPackageSourceLocationResponse, ManageTaskRequest, CreateSmartEraseTemplateRequest, DescribeTextToSpeechAsyncTaskRequest, CreateWorkflowRequest, ModifyStreamLinkEventRequest, DescribeStreamLinkEventRequest, DescribeAsrHotwordsRequest, DescribeStreamPackageLinearAssemblyChannelsRequest, DescribeStreamPackageSourcesResponse, ModifyAIAnalysisTemplateRequest, CreateImageSpriteTemplateRequest, DescribeAigcImageTaskRequest, DeleteStreamPackageSSAIChannelRequest, DeleteStreamLinkSecurityGroupRequest, ModifySmartEraseTemplateResponse, ModifyStreamLinkFlowResponse, DeleteAIRecognitionTemplateResponse, DeleteContentReviewTemplateRequest, ActivateStreamPackageResponse, StartStreamLinkFlowResponse, DescribeStreamLinkFlowStatisticsResponse, ModifyContentReviewTemplateResponse, ModifyScheduleRequest, DescribeWatermarkTemplatesRequest, DescribeStreamLinkActivateStateRequest, ResetWorkflowResponse, ModifyWordSampleResponse, ModifyStreamPackageSourceResponse, CreateProjectResponse, ModifyProcessImageTemplateRequest, DeletePersonSampleRequest, DeleteProjectResponse, DescribeStreamLinkFlowRealtimeStatusResponse, ParseLiveStreamProcessNotificationResponse, DescribeVideoDatabaseEntryTaskDetailRequest, CreateStreamPackageLinearAssemblyProgramRequest, DescribeBatchTaskDetailResponse, RecognizeAudioResponse, StartStreamPackageLinearAssemblyChannelResponse, ModifyStreamPackageLinearAssemblyProgramResponse, CreateAdaptiveDynamicStreamingTemplateRequest, CreateProcessImageTemplateResponse, ModifyStreamLinkFlowRequest, DescribeImageSpriteTemplatesRequest, DeleteWorkflowResponse, DeleteStreamPackageLinearAssemblyProgramRequest, CreateStreamLinkEventRequest, CreatePersonSampleRequest, DescribeStreamLinkFlowSRTStatisticsRequest, CreateScheduleResponse, ModifyLiveRecordTemplateResponse, DeleteAIRecognitionTemplateRequest, UpdateVoiceRequest, TextToSpeechResponse, CreateStreamLinkSecurityGroupRequest, DescribeStreamLinkEventResponse, CreateAiDramaTaskResponse, CreateStreamLinkFlowResponse, DescribeMDPMPSUserInfoResponse, DeleteStreamPackageLinearAssemblyProgramsRequest, DisassociateSecurityGroupResponse, CreateAigcVideoTaskResponse, ModifyAdaptiveDynamicStreamingTemplateResponse, CreateVideoDatabaseEntryTaskRequest, CreateStreamLinkFlowRequest, CreateBlindWatermarkTemplateRequest, CreateAigcAudioTaskResponse, RecognizeMediaForZhiXueRequest, ModifyTranscodeTemplateRequest, ModifyStreamLinkOutputInfoRequest, ModifyAIAnalysisTemplateResponse, DescribeWordSamplesResponse, UpdateProjectRequest, DescribeAIRecognitionTemplatesResponse, DescribeImageTaskDetailRequest, EditMediaResponse, ExtractBlindWatermarkResponse, TextToSpeechRequest, DescribeSnapshotByTimeOffsetTemplatesRequest, ModifyStreamLinkEventResponse, ModifySnapshotByTimeOffsetTemplateResponse, DescribeAigcAudioTaskResponse, DisableScheduleRequest, ProcessMediaResponse, CreateWordSamplesResponse, CreateScheduleRequest, ParseNotificationRequest, CreateWordSamplesRequest, CreateQualityControlTemplateRequest, CreateMediaEvaluationResponse, DescribeStreamLinkEventsResponse, DescribeSmartEraseTemplatesRequest, StartStreamPackageLinearAssemblyChannelRequest, DescribeStreamLinkFlowStatisticsRequest, DescribeAigcTaskListResponse, DescribeStreamPackageSSAIChannelRequest, CreateAigcImageTaskResponse, ModifyStreamPackageSSAIChannelResponse, ModifyAnimatedGraphicsTemplateResponse, DeleteAdaptiveDynamicStreamingTemplateRequest, ModifyPersonSampleResponse, ModifyStreamPackageSourceLocationRequest, CreateWorkflowResponse, DeleteStreamPackageSourceRequest, DeleteAIAnalysisTemplateRequest, DescribeMDPMPSUserInfoRequest, DescribeBlindWatermarkTemplatesRequest, DeleteVoiceRequest, CreateStreamLinkOutputInfoResponse, DescribeAsrHotwordsListRequest, CloneVoiceResponse, DescribeStreamPackageLinearAssemblyProgramSchedulesResponse, DescribeAdaptiveDynamicStreamingTemplatesResponse, DescribeStreamPackageActivateStateRequest, DeleteBlindWatermarkTemplateResponse, BatchStartStreamLinkFlowRequest, DescribeStreamPackageLinearAssemblyChannelRequest, BatchProcessMediaResponse, DescribeStreamPackageActivateStateResponse, DescribeStreamLinkEventAttachedFlowsRequest, CreatePersonSampleResponse, CreateContentReviewTemplateResponse, ModifyBlindWatermarkTemplateResponse, DescribeStreamPackageSSAIChannelsResponse, DescribeAIAnalysisTemplatesRequest, DeleteWordSamplesRequest, DescribeLiveRecordTemplatesResponse, EnableScheduleRequest, EnableWorkflowRequest, DescribeLiveRecordTemplatesRequest, DescribeStreamPackageSourceLocationsRequest, DescribeStreamPackageSourceLocationResponse, CreateAigcAudioTaskRequest, DeleteStreamPackageLinearAssemblyChannelRequest, DeleteQualityControlTemplateRequest, ModifyAdaptiveDynamicStreamingTemplateRequest, DescribeQualityControlTemplatesRequest, ModifyWordSampleRequest, DeleteStreamPackageSourceLocationResponse, CreateStreamPackageSourceRequest, DescribeStreamPackageLinearAssemblyProgramRequest, DescribeStreamPackageLinearAssemblyChannelAlertsRequest, DescribeAigcImageTaskResponse, BatchStopStreamLinkFlowRequest, DeleteStreamPackageLinearAssemblyProgramsByChannelResponse, CreateAsrHotwordsResponse, CreateSnapshotByTimeOffsetTemplateRequest, CreateStreamLinkEventResponse, DeleteStreamLinkEventRequest, DescribeProcessImageTemplatesResponse, ProcessMediaRequest, ModifyStreamPackageLinearAssemblyProgramRequest, ProcessImageResponse, DescribeStreamPackageLinearAssemblyChannelAlertsResponse, CreateBlindWatermarkTemplateResponse, ModifyProcessImageTemplateResponse, DeleteStreamPackageSSAIChannelResponse, DeleteStreamPackageSourceResponse, CreateAigcVideoTaskRequest, DescribeSchedulesResponse, ModifySubtitleEmbedTemplateRequest, DescribeStreamLinkRegionsResponse, DescribeVideoSearchTaskDetailResponse, DescribeStreamLinkFlowRealtimeStatusRequest, DeleteStreamPackageLinearAssemblyChannelsResponse, DeleteContentReviewTemplateResponse, DesignVoiceAsyncRequest, DescribeStreamPackageSSAIUsageRequest, ModifyQualityControlTemplateResponse, RecognizeMediaForZhiXueResponse, EmbeddingDataRequest, QueryProjectResponse, DescribeAigcTaskStatusResponse, DescribeDesignTaskRequest, DescribeGroupAttachFlowsByIdRequest, DescribeWorkflowsResponse, SyncDubbingRequest, DeleteImageSpriteTemplateResponse, DescribeContentReviewTemplatesResponse, DescribeStreamLinkActivateStateResponse, DescribeStreamPackageSourceLocationRequest, QueryProjectRequest, DescribeContentReviewTemplatesRequest, DescribeStreamPackageSourcesRequest, ModifyAsrHotwordsResponse, CreateStreamPackageLinearAssemblyChannelResponse, DescribeTextToSpeechAsyncTaskResponse, ModifyImageSpriteTemplateResponse, CreateWatermarkTemplateRequest, CreateMediaEvaluationRequest, DetectVideoSubtitleAreaRequest, DescribePersonSamplesRequest, DescribeStreamPackageLinearAssemblyProgramsRequest, DescribeSubtitleEmbedTemplatesRequest, DeleteAdaptiveDynamicStreamingTemplateResponse, CreateVideoSearchTaskResponse, CreateVideoSearchTaskRequest, ExecuteFunctionResponse, DesignVoiceAsyncResponse, DeleteStreamPackageLinearAssemblyChannelsRequest, CreateDocToVideoTaskRequest, DeleteAIAnalysisTemplateResponse, CreateQualityControlTemplateResponse, CreateAIRecognitionTemplateResponse, DeleteBlindWatermarkTemplateRequest, DeleteTranscodeTemplateRequest, ModifyAsrHotwordsRequest, BatchStartStreamLinkFlowResponse, DisassociateSecurityGroupRequest, CreateProcessImageTemplateRequest, StopStreamLinkFlowRequest, DescribeStreamLinkFlowSRTStatisticsResponse, DescribeAsrHotwordsListResponse, DeleteVoiceResponse, DescribeBlindWatermarkTemplatesResponse, TextToSpeechAsyncResponse, DescribeAigcTaskStatusRequest, DescribeDesignTaskResponse, CreateProjectRequest, ProcessImageRequest, DeleteSampleSnapshotTemplateResponse, DeleteSmartSubtitleTemplateResponse, ResetWorkflowRequest, DeleteSubtitleEmbedTemplateRequest, DeleteSmartEraseTemplateRequest, DeletePersonSampleResponse, StartStreamLinkFlowRequest, CreateSnapshotByTimeOffsetTemplateResponse, ModifyStreamLinkOutputInfoResponse, ModifyContentReviewTemplateRequest, StopStreamLinkFlowResponse, DeleteScheduleRequest, CreateAdaptiveDynamicStreamingTemplateResponse, DeleteSampleSnapshotTemplateRequest, DescribeTranscodeTemplatesResponse, DeleteAsrHotwordsResponse, DeleteStreamLinkFlowResponse, CreateAsrHotwordsRequest, WithdrawsWatermarkResponse, DescribeSubtitleEmbedTemplatesResponse, DescribeStreamPackageSSAIChannelResponse, ActivateStreamPackageRequest, DescribeSSAIActivateStateResponse, DescribeCloneViralTaskResponse, DescribeStreamLinkFlowMediaStatisticsResponse, DescribeStreamLinkFlowsResponse, StopStreamPackageLinearAssemblyChannelResponse, CreateVideoDatabaseEntryTaskResponse, DescribeMediaMetaDataResponse, DetectVideoSubtitleAreaResponse, DescribeSSAIActivateStateRequest, DescribeBatchTaskDetailRequest, DescribeUsageDataResponse, DescribeSampleSnapshotTemplatesRequest, DisableWorkflowResponse, DeleteStreamPackageLinearAssemblyProgramsResponse, DescribeQualityControlTemplatesResponse, DescribeStreamPackageSourceRequest, DescribeStreamLinkEventsRequest, CreateStreamLinkSecurityGroupResponse, ModifyAIRecognitionTemplateRequest, ParseNotificationResponse, CreateSampleSnapshotTemplateResponse, ParseLiveStreamProcessNotificationRequest, CreateLiveRecordTemplateResponse, DescribeAsrHotwordsResponse, TextToSpeechAsyncRequest, CreateSubtitleEmbedTemplateResponse, CreateStreamPackageSourceLocationResponse, DeleteSmartSubtitleTemplateRequest, DescribeStreamPackageLinearAssemblyProgramSchedulesRequest, CreateAIAnalysisTemplateResponse, CreateSmartEraseTemplateResponse, CreateAiFissionTaskRequest, CreateDocToVideoTaskResponse, ModifySmartSubtitleTemplateResponse, CreateVideoRedrawTaskRequest, DescribeStreamPackageLinearAssemblyProgramsResponse, DescribeStreamPackageSourceResponse, WithdrawsWatermarkRequest, DeleteStreamLinkOutputRequest, ModifyPersonSampleRequest, CreateStreamPackageSSAIChannelResponse, CreateAIRecognitionTemplateRequest, DescribeTaskDetailRequest, ModifyAIRecognitionTemplateResponse, DescribeStreamPackageLinearAssemblyUsageRequest, ModifyAnimatedGraphicsTemplateRequest, ModifyStreamLinkSecurityGroupRequest, BatchProcessMediaRequest, DeleteWordSamplesResponse, DescribeImageTasksResponse, DeleteStreamLinkOutputResponse, EnableWorkflowResponse, UpdateVoiceResponse, CreateStreamLinkOutputInfoRequest, ModifyStreamLinkInputRequest, ModifyStreamPackageSourceRequest, DescribeStreamLinkEventAttachedFlowsResponse, ModifyTranscodeTemplateResponse, CreateLiveRecordTemplateRequest, CreateContentReviewTemplateRequest, CreateVideoRedrawTaskResponse, ModifyQualityControlTemplateRequest, DescribeImageSpriteTemplatesResponse, UpdateProjectResponse, DeleteProjectRequest, DescribeStreamLinkRegionsRequest, ModifySmartEraseTemplateRequest, ModifyStreamLinkInputResponse, DescribeStreamLinkFlowMediaStatisticsRequest, DescribeTaskDetailResponse, DeleteImageSpriteTemplateRequest, DeleteProcessImageTemplateResponse, DescribeStreamLinkSecurityGroupsRequest, DeleteStreamLinkEventResponse, DescribeStreamPackageSourceAlertsRequest, DescribeTasksResponse, ModifyImageSpriteTemplateRequest, CreateStreamPackageSourceResponse, EditMediaRequest, ModifySnapshotByTimeOffsetTemplateRequest, SyncDubbingResponse, DescribeVideoSearchTaskDetailRequest, DeleteLiveRecordTemplateResponse, DescribeCloneViralTaskRequest, DescribeSnapshotByTimeOffsetTemplatesResponse, DeleteSnapshotByTimeOffsetTemplateResponse, DescribeTasksRequest, CreateTranscodeTemplateResponse, DescribeStreamLinkFlowResponse, CreateStreamPackageLinearAssemblyChannelRequest, CreateAIAnalysisTemplateRequest, DescribeWorkflowsRequest, DescribeSchedulesRequest, ProcessLiveStreamRequest, DescribeSmartEraseTemplatesResponse, DeleteWatermarkTemplateRequest, DescribeWordSamplesRequest, DeleteAsrHotwordsRequest, CreateSmartSubtitleTemplateRequest, TextTranslationRequest, CloneViralResponse, DescribeSampleSnapshotTemplatesResponse, DescribeProcessImageTemplatesRequest, CreateAigcImageTaskRequest, ModifySubtitleEmbedTemplateResponse, DeleteSubtitleEmbedTemplateResponse, DescribeStreamPackageSSAIUsageResponse, DescribeTranscodeTemplatesRequest, DetectVideoWatermarkRequest, DescribeSmartSubtitleTemplatesResponse, DescribeUsageDataRequest, DeleteStreamPackageLinearAssemblyChannelResponse, BatchDeleteStreamLinkFlowResponse, DisableWorkflowRequest, DescribeWatermarkTemplatesResponse, DescribeStreamLinkFlowLogsRequest, ModifyStreamPackageLinearAssemblyChannelRequest, DeleteQualityControlTemplateResponse, CreateAnimatedGraphicsTemplateRequest, ExecuteFunctionRequest, DescribeStreamLinkFlowLogsResponse, DescribeVoicesResponse, DescribeVideoDatabaseEntryTaskDetailResponse, DeleteTranscodeTemplateResponse, DescribeStreamPackageSourceLocationsResponse, DescribeImageTaskDetailResponse, DescribePersonSamplesResponse, DescribeStreamLinkFlowsRequest, ModifyScheduleResponse, ActivateSSAIResponse, DescribeAIAnalysisTemplatesResponse, CloneVoiceRequest, DescribeAigcVideoTaskRequest, CreateSampleSnapshotTemplateRequest, DescribeAigcVideoTaskResponse, DeleteSmartEraseTemplateResponse, ModifyStreamPackageLinearAssemblyChannelResponse, ModifyBlindWatermarkTemplateRequest, DescribeStreamLinkFlowRequest, DetectVideoWatermarkResponse, DescribeVoicesRequest, ActivateSSAIRequest, DescribeStreamPackageSSAIChannelsRequest, DescribeAdaptiveDynamicStreamingTemplatesRequest, CreateWatermarkTemplateResponse, DeleteStreamPackageSourceLocationRequest, DescribeStreamPackageLinearAssemblyProgramResponse, CreateStreamLinkInputRequest, TextTranslationResponse, ModifyStreamLinkSecurityGroupResponse, ModifyLiveRecordTemplateRequest, ModifySmartSubtitleTemplateRequest, DeleteAnimatedGraphicsTemplateRequest, DeleteSnapshotByTimeOffsetTemplateRequest, DescribeAnimatedGraphicsTemplatesResponse, CreateSubtitleEmbedTemplateRequest, DescribeStreamPackageSourceAlertsResponse, DescribeStreamPackageLinearAssemblyChannelResponse, EnableScheduleResponse, CreateStreamPackageLinearAssemblyProgramResponse, DeleteProcessImageTemplateRequest, CreateAnimatedGraphicsTemplateResponse, DeleteStreamPackageLinearAssemblyProgramResponse, RecognizeAudioRequest, CreateStreamLinkInputResponse, CreateSmartSubtitleTemplateResponse, DescribeGroupAttachFlowsByIdResponse, DescribeStreamPackageLinearAssemblyUsageResponse, BatchStopStreamLinkFlowResponse, DescribeAigcTaskListRequest, CreateStreamPackageSourceLocationRequest, DeleteWatermarkTemplateResponse, DescribeStreamPackageLinearAssemblyChannelsResponse, StopStreamPackageLinearAssemblyChannelRequest, EmbeddingDataResponse, DescribeMediaMetaDataRequest, DescribeImageTasksRequest, CreateImageSpriteTemplateResponse, DescribeAIRecognitionTemplatesRequest, ModifyWatermarkTemplateResponse } from "./mps_models";
/**
 * mps client
 * @class
 */
export declare class Client extends AbstractClient {
     ...
     * 删除音色（通过音色克隆或设计创建的）。
     */
    DeleteVoice(req: DeleteVoiceRequest, cb?: (error: string, rep: DeleteVoiceResponse) => void): Promise<DeleteVoiceResponse>;
    /**
...
4. 视频级别：转场、倍数播放、拼接、剪切、字幕、画中画、音画分离、出入场动效等
     ...
     * 创建ai视频裂变任务
     */
    CreateAiFissionTask(req: CreateAiFissionTaskRequest, cb?: (error: string, rep: CreateAiFissionTaskResponse) => void): Promise<CreateAiFissionTaskResponse>;
    /**
     * 同步接口，使用该接口从参考音频克隆一个音色
     */
    CloneVoice(req: CloneVoiceRequest, cb?: (error: string, rep: CloneVoiceResponse) => void): Promise<CloneVoiceResponse>;
    /**
...
该接口不用于发起网络调用，而是用来帮助生成各个语言平台的 SDK，您可以参考 SDK 中的解析实现事件通知的解析。
     ...
     */
    CloneViral(req: CloneViralRequest, cb?: (error: string, rep: CloneViralResponse) => void): Promise<CloneViralResponse>;
    /**
...
* 只能查询到最近七天（168小时）内的任务。
     ...
     * 快速探测视频文件的硬字幕区域
     */
    DetectVideoSubtitleArea(req: DetectVideoSubtitleAreaRequest, cb?: (error: string, rep: DetectVideoSubtitleAreaResponse) => void): Promise<DetectVideoSubtitleAreaResponse>;
    /**
     * 创建媒体传输的传输流配置。
     */
     ...
     * 图片处理任务查询接口。
     */
    DescribeImageTasks(req: DescribeImageTasksRequest, cb?: (error: string, rep: DescribeImageTasksResponse) => void): Promise<DescribeImageTasksResponse>;
    /**
     * 剧集项目更新
     */
...
智能字幕（语音全文、语音热词、语音翻译）
     ...
     * 快速探测视频文件是否包含水印
     */
    DetectVideoWatermark(req: DetectVideoWatermarkRequest, cb?: (error: string, rep: DetectVideoWatermarkResponse) => void): Promise<DetectVideoWatermarkResponse>;
    /**
...
5. 美颜滤镜；
     ...
     * 模型embedding 接口
     */
    EmbeddingData(req: EmbeddingDataRequest, cb?: (error: string, rep: EmbeddingDataResponse) => void): Promise<EmbeddingDataResponse>;
    /**
     * 删除用户自定义数字水印模板。
     */
...
可选在任务完成后向回调方发送任务完成状态信息。
     ...
     */
    CreateAiDramaTask(req: CreateAiDramaTaskRequest, cb?: (error: string, rep: CreateAiDramaTaskResponse) => void): Promise<CreateAiDramaTaskResponse>;
    /**
     * 查询Source信息列表。
     */
...
注意：创建工作流成功后是禁用状态，需要手动启用。
     ...
     * 异步语音合成接口，支持长文本转语音
     */
    TextToSpeechAsync(req: TextToSpeechAsyncRequest, cb?: (error: string, rep: TextToSpeechAsyncResponse) => void): Promise<TextToSpeechAsyncResponse>;
    /**
     * 创建图片处理模板
     */
...
注意：创建编排成功后是禁用状态，需要手动启用。
   ...
   2. 查询时间跨度不超过90天。
     ...
     * 查询爆款复刻任务结果
     */
    DescribeCloneViralTask(req: DescribeCloneViralTaskRequest, cb?: (error: string, rep: DescribeCloneViralTaskResponse) => void): Promise<DescribeCloneViralTaskResponse>;
    /**
...
该接口不用于发起网络调用，而是用来帮助生成各个语言平台的 SDK，您可以参考 SDK 中的解析函数，实现事件通知的解析。
     ...
     * 调用该接口，用于查询AIGC生视频任务的进度以及获取生成结果。
     */
    DescribeAigcAudioTask(req: DescribeAigcAudioTaskRequest, cb?: (error: string, rep: DescribeAigcAudioTaskResponse) => void): Promise<DescribeAigcAudioTaskResponse>;
    /**
     * 修改媒体包装Source信息。
     */
     ...
     * 查询异步语音合成任务结果
     */
    DescribeTextToSpeechAsyncTask(req: DescribeTextToSpeechAsyncTaskRequest, cb?: (error: string, rep: DescribeTextToSpeechAsyncTaskResponse) => void): Promise<DescribeTextToSpeechAsyncTaskResponse>;
    /**
     * 更新音色信息
     */
    UpdateVoice(req: UpdateVoiceRequest, cb?: (error: string, rep: UpdateVoiceResponse) => void): Promise<UpdateVoiceResponse>;
    /**
     * 查询媒体输入流的配置信息。
     */
...
直播流处理事件通知支持HTTP回调，也支持实时写入用户指定的消息队列 CMQ 中，用户从消息队列 CMQ 中获取事件通知结果，同时处理过程中存在输出文件的，会写入用户指定的输出文件的目标存储中。
     ...
     * 查询AIGC任务列表详细信息
     */
    DescribeAigcTaskList(req: DescribeAigcTaskListRequest, cb?: (error: string, rep: DescribeAigcTaskListResponse) => void): Promise<DescribeAigcTaskListResponse>;
    /**
     * 删除编排
     */
