...
import { AttachRemoteDisksResponse, ModifyRemoteDiskAttributesRequest, ModifyDiskExtraPerformanceRequest, SwitchParameterCreateRemoteDisksResponse, ModifyDiskAttributesResponse, DescribeDiskBackupsRequest, InquirePriceModifyDiskBackupQuotaRequest, ModifySnapshotsSharePermissionRequest, AttachRemoteDisksRequest, CopySnapshotCrossRegionsResponse, DescribeSnapshotGroupsRequest, ModifyDiskBackupQuotaRequest, InquiryPriceCreateDisksResponse, BindAutoSnapshotPolicyRequest, CreateSnapshotResponse, DescribeAutoSnapshotPoliciesRequest, InquirePriceRenewRemoteDisksRequest, TerminateRemoteDisksRequest, DescribeRemoteDisksRequest, ModifySnapshotsSharePermissionResponse, DescribeRemoteDisksResponse, DeleteDiskBackupsRequest, DescribeRemoteDiskConfigQuotaResponse, InitializeDisksResponse, DescribeDiskStoragePoolRequest, DescribeDiskBackupsResponse, RenewDiskRequest, DescribeRemoteDisksDeniedActionsRequest, InquirePriceModifyDiskExtraPerformanceResponse, CreateDisksRequest, AttachDisksRequest, DescribeDiskAssociatedAutoSnapshotPolicyRequest, DescribeSnapshotsRequest, ModifyAutoSnapshotPolicyAttributeRequest, DescribeDiskConfigQuotaResponse, SwitchParameterCreateRemoteDisksRequest, ApplyDiskBackupResponse, InquiryPriceResizeDiskResponse, ResizeDiskResponse, TerminateDisksResponse, ApplySnapshotResponse, DetachDisksRequest, DescribeSnapshotGroupsResponse, DescribeSnapshotOverviewResponse, ModifyDisksChargeTypeResponse, CreateSnapshotRequest, DescribeInstancesDiskNumRequest, DescribeSnapshotSharePermissionResponse, ModifyDiskBackupQuotaResponse, InquiryPriceRenewDisksRequest, DescribeSnapshotSharePermissionRequest, CreateSnapshotGroupRequest, DeleteDiskBackupsResponse, DeleteSnapshotsRequest, ModifyDisksRenewFlagResponse, SwitchParameterRenewRemoteDisksRequest, CopyAutoSnapshotPolicyCrossAccountResponse, DeleteAutoSnapshotPoliciesResponse, DescribeDisksResponse, DeleteSnapshotsResponse, ModifyDisksRenewFlagRequest, ModifySnapshotAttributeResponse, CopyAutoSnapshotPolicyCrossAccountRequest, ModifyDiskAttributesRequest, DescribeRemoteDisksDeniedActionsResponse, GetSnapOverviewRequest, DetachRemoteDisksResponse, ModifyAutoSnapshotPolicyAttributeResponse, TerminateDisksRequest, DescribeInstancesDiskNumResponse, InquirePriceCreateRemoteDisksRequest, ResizeDiskRequest, ApplyDiskBackupRequest, ModifyDisksChargeTypeRequest, InitializeDisksRequest, CreateRemoteDisksRequest, CreateAutoSnapshotPolicyResponse, ModifySnapshotAttributeRequest, UnbindAutoSnapshotPolicyRequest, DescribeRemoteDiskConfigQuotaRequest, CreateDiskBackupResponse, InquirePriceModifyDiskBackupQuotaResponse, DeleteAutoSnapshotPoliciesRequest, DeleteSnapshotGroupResponse, ApplySnapshotGroupResponse, DescribeSnapshotOverviewRequest, InquiryPriceCreateDisksRequest, DescribeSnapshotsResponse, CreateDisksResponse, AttachDisksResponse, CreateDiskBackupRequest, InquirePriceCreateRemoteDisksResponse, DeleteSnapshotGroupRequest, BindAutoSnapshotPolicyResponse, SwitchParameterRenewRemoteDisksResponse, DescribeDisksRequest, DetachDisksResponse, ModifyRemoteDiskAttributesResponse, CreateRemoteDisksResponse, InquiryPriceRenewDisksResponse, DescribeDiskStoragePoolResponse, InquirePriceRenewRemoteDisksResponse, ModifyDiskExtraPerformanceResponse, RenewRemoteDiskRequest, InquirePriceModifyDiskExtraPerformanceRequest, InquiryPriceResizeDiskRequest, DescribeDiskConfigQuotaRequest, DescribeDiskAssociatedAutoSnapshotPolicyResponse, ApplySnapshotGroupRequest, GetSnapOverviewResponse, CopySnapshotCrossRegionsRequest, RenewDiskResponse, TerminateRemoteDisksResponse, RenewRemoteDiskResponse, DescribeAutoSnapshotPoliciesResponse, UnbindAutoSnapshotPolicyResponse, CreateAutoSnapshotPolicyRequest, CreateSnapshotGroupResponse, DetachRemoteDisksRequest, ApplySnapshotRequest } from "./cbs_models";
/**
 * cbs client
 * @class
 */
...
* 如果参数为空，返回当前用户一定数量（`Limit`所指定的数量，默认为20）的定期快照策略表。
     ...
     */
    RenewRemoteDisk(req: RenewRemoteDiskRequest, cb?: (error: string, rep: RenewRemoteDiskResponse) => void): Promise<RenewRemoteDiskResponse>;
    /**
     * 本接口用于销毁一个或多个弹性单副本SSD硬盘。仅支持弹性盘类型，且要求硬盘处于 INITED 或 UNINIT 状态。
     */
    TerminateRemoteDisks(req: TerminateRemoteDisksRequest, cb?: (error: string, rep: TerminateRemoteDisksResponse) => void): Promise<TerminateRemoteDisksResponse>;
    /**
     * 该接口用于获取续费弹性单副本SSD硬盘的订单参数，生成的订单参数由前端透传到计费系统用于续费。
     */
    SwitchParameterRenewRemoteDisks(req?: SwitchParameterRenewRemoteDisksRequest, cb?: (error: string, rep: SwitchParameterRenewRemoteDisksResponse) => void): Promise<SwitchParameterRenewRemoteDisksResponse>;
    /**
     * 本接口用于创建弹性单副本SSD硬盘并自动挂载到指定实例。弹性盘在创建时就需要绑定目标实例，计费回调后由CBS自身完成装箱+挂载的全流程。
     */
    CreateRemoteDisks(req: CreateRemoteDisksRequest, cb?: (error: string, rep: CreateRemoteDisksResponse) => void): Promise<CreateRemoteDisksResponse>;
    /**
...
* 本接口为异步接口，当挂载云盘的请求成功返回时，表示后台已发起挂载云盘的操作，可通过接口[DescribeDisks](/document/product/362/16315)来查询对应云盘的状态，如果云盘的状态由“ATTACHING”变为“ATTACHED”，则为挂载成功。
     ...
     */
    DescribeRemoteDisks(req: DescribeRemoteDisksRequest, cb?: (error: string, rep: DescribeRemoteDisksResponse) => void): Promise<DescribeRemoteDisksResponse>;
    /**
...
* 可选择挂载在实例上的全部或部分盘创建快照组。
     ...
     */
    SwitchParameterCreateRemoteDisks(req: SwitchParameterCreateRemoteDisksRequest, cb?: (error: string, rep: SwitchParameterCreateRemoteDisksResponse) => void): Promise<SwitchParameterCreateRemoteDisksResponse>;
    /**
...
* 如果快照组内的快照有关联镜像，则删除失败，所有快照均不会删除；如果需要同时删除快照绑定的镜像，可传入参数DeleteBindImages等于true。
     ...
     */
    InquirePriceCreateRemoteDisks(req: InquirePriceCreateRemoteDisksRequest, cb?: (error: string, rep: InquirePriceCreateRemoteDisksResponse) => void): Promise<InquirePriceCreateRemoteDisksResponse>;
    /**
...
* 支持批量操作。如果多个快照存在无法删除的快照，则操作不执行，以特定的错误码返回。
     ...
     */
    DescribeRemoteDisksDeniedActions(req: DescribeRemoteDisksDeniedActionsRequest, cb?: (error: string, rep: DescribeRemoteDisksDeniedActionsResponse) => void): Promise<DescribeRemoteDisksDeniedActionsResponse>;
    /**
...
* “快照名称”仅为方便用户管理之用，腾讯云并不以此名称作为提交工单或是进行快照管理操作的依据。
     ...
     */
    ModifyRemoteDiskAttributes(req: ModifyRemoteDiskAttributesRequest, cb?: (error: string, rep: ModifyRemoteDiskAttributesResponse) => void): Promise<ModifyRemoteDiskAttributesResponse>;
    /**
     * 该接口用于查询续费弹性单副本SSD硬盘的价格。
     */
    InquirePriceRenewRemoteDisks(req: InquirePriceRenewRemoteDisksRequest, cb?: (error: string, rep: InquirePriceRenewRemoteDisksResponse) => void): Promise<InquirePriceRenewRemoteDisksResponse>;
    /**
     ...
     */
    DetachRemoteDisks(req: DetachRemoteDisksRequest, cb?: (error: string, rep: DetachRemoteDisksResponse) => void): Promise<DetachRemoteDisksResponse>;
    /**
...
*  如果参数为空，返回当前用户一定数量（`Limit`所指定的数量，默认为20）的快照列表。
     ...
     */
    DescribeRemoteDiskConfigQuota(req: DescribeRemoteDiskConfigQuotaRequest, cb?: (error: string, rep: DescribeRemoteDiskConfigQuotaResponse) => void): Promise<DescribeRemoteDiskConfigQuotaResponse>;
    /**
...
获取快照概览信息
     ...
     */
    AttachRemoteDisks(req: AttachRemoteDisksRequest, cb?: (error: string, rep: AttachRemoteDisksResponse) => void): Promise<AttachRemoteDisksResponse>;
    /**
