...
3、子用户使用该接口时，应具备QcloudFinanceRenewManageFullAccess权限策略。
     ...
     * 批量查询成员可用余额信息
     */
    DescribeOrgMemberAccountBalance(req: DescribeOrgMemberAccountBalanceRequest, cb?: (error: string, rep: DescribeOrgMemberAccountBalanceResponse) => void): Promise<DescribeOrgMemberAccountBalanceResponse>;
    /**
     * 获取预算详细信息
     */
