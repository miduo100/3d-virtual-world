...
import { StopInstanceRequest, DescribeServicesCallInfoResponse, TerminateInstancesResponse, ResizeInstanceDiskRequest, DescribeDeployTemplatesResponse, DescribeScenesResponse, RunInstancesRequest, DescribeInstancesResponse, DescribeRegionsResponse, DeleteServiceRequest, StartInstanceResponse, DescribeApplicationsResponse, DescribeServiceLoginSettingsResponse, StartInstanceRequest, DeployInferServiceResponse, DescribeMuskPromptsResponse, UpdateServiceConfigsResponse, RunInstancesResponse, DescribeServicesCallInfoRequest, StopInstanceResponse, DeployInferServiceRequest, CreateInferServiceByTemplateRequest, DescribeRegionsRequest, DescribeServicesRequest, DescribeInstanceNetworkStatusRequest, InquirePriceRunInstancesRequest, ResetInstancesPasswordResponse, DeleteServiceResponse, InquirePriceUpdateServiceConfigsRequest, CreateInferServiceByTemplateResponse, CreateMuskPromptResponse, ResetInstancesPasswordRequest, DescribeInstancesRequest, DescribeServiceLoginSettingsRequest, DescribeDeployTemplatesRequest, ResizeInstanceDiskResponse, InquirePriceUpdateServiceConfigsResponse, DescribeModelsRequest, CreateMuskPromptRequest, DescribeInstanceNetworkStatusResponse, InquirePriceRunInstancesResponse, TerminateInstancesRequest, DescribeServicesResponse, DescribeMuskPromptsRequest, DescribeApplicationsRequest, CreateApplicationRequest, UpdateServiceConfigsRequest, DescribeScenesRequest, CreateApplicationResponse, DescribeModelsResponse } from "./hai_models";
/**
 * hai client
 * @class
 */
