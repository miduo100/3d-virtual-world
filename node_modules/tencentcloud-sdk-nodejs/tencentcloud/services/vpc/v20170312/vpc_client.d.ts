...
- 支持对弹性公网 IPv6 和传统弹性公网 IPv6 实例名称进行修改。
     ...
     * 创建云联网策略路由下一跳
     */
    CreateCcnPolicyBasedRoutingNextHop(req: CreateCcnPolicyBasedRoutingNextHopRequest, cb?: (error: string, rep: CreateCcnPolicyBasedRoutingNextHopResponse) => void): Promise<CreateCcnPolicyBasedRoutingNextHopResponse>;
    /**
...
接口。
     ...
     * 删除云联网策略路由下一跳
     */
    DeleteCcnPolicyBasedRoutingNextHop(req: DeleteCcnPolicyBasedRoutingNextHopRequest, cb?: (error: string, rep: DeleteCcnPolicyBasedRoutingNextHopResponse) => void): Promise<DeleteCcnPolicyBasedRoutingNextHopResponse>;
    /**
...
* vpc-max-ula-ipv6-cidrs （每个VPC可创建的ULA IPv6 CIDR个数）。
     ...
     * 更新云联网策略路由下一跳参数
     */
    ModifyCcnPolicyBasedRoutingNextHopAttribute(req: ModifyCcnPolicyBasedRoutingNextHopAttributeRequest, cb?: (error: string, rep: ModifyCcnPolicyBasedRoutingNextHopAttributeResponse) => void): Promise<ModifyCcnPolicyBasedRoutingNextHopAttributeResponse>;
    /**
...
* 每个子网只能分配一个IPv6网段。
     ...
     * 删除云联网策略路由匹配规则
     */
    DeleteCcnPolicyBasedRoutingRule(req: DeleteCcnPolicyBasedRoutingRuleRequest, cb?: (error: string, rep: DeleteCcnPolicyBasedRoutingRuleResponse) => void): Promise<DeleteCcnPolicyBasedRoutingRuleResponse>;
    /**
...
* SecurityGroupPolicySet.Version 用于指定要操作的安全组的版本。传入 Version 版本号若不等于当前安全组的最新版本，将返回失败；若不传 Version 则直接删除指定PolicyIndex的规则。
     ...
     * 创建云联网策略路由匹配规则
     */
    CreateCcnPolicyBasedRoutingRules(req: CreateCcnPolicyBasedRoutingRulesRequest, cb?: (error: string, rep: CreateCcnPolicyBasedRoutingRulesResponse) => void): Promise<CreateCcnPolicyBasedRoutingRulesResponse>;
    /**
...
子网段如果还有IP占用且未回收，则子网段无法释放。
     ...
     * 更新云联网策略路由匹配规则参数
     */
    ModifyCcnPolicyBasedRoutingRuleAttribute(req: ModifyCcnPolicyBasedRoutingRuleAttributeRequest, cb?: (error: string, rep: ModifyCcnPolicyBasedRoutingRuleAttributeResponse) => void): Promise<ModifyCcnPolicyBasedRoutingRuleAttributeResponse>;
    /**
...
<font color="#FF0000">本接口即将下线，仅供存量用户使用，暂停新增用户。</font>
     ...
     * 查询云联网策略路由匹配规则
     */
    DescribeCcnPolicyBasedRoutingRule(req: DescribeCcnPolicyBasedRoutingRuleRequest, cb?: (error: string, rep: DescribeCcnPolicyBasedRoutingRuleResponse) => void): Promise<DescribeCcnPolicyBasedRoutingRuleResponse>;
    /**
...
* 删除IPv6规则，需要传入NetworkAclIpv6EntryId。
     ...
     */
    DescribeNatGatewayZones(req?: DescribeNatGatewayZonesRequest, cb?: (error: string, rep: DescribeNatGatewayZonesResponse) => void): Promise<DescribeNatGatewayZonesResponse>;
    /**
...
本接口是异步完成，如需查询异步任务执行结果，请使用本接口返回的`RequestId`轮询[DescribeVpcTaskResult](https://cloud.tencent.com/document/api/215/59037) `接口。
     ...
     */
    UpgradeNatGatewayProductVersion(req: UpgradeNatGatewayProductVersionRequest, cb?: (error: string, rep: UpgradeNatGatewayProductVersionResponse) => void): Promise<UpgradeNatGatewayProductVersionResponse>;
    /**
     * 查询高优路由表。
     */
...
* 检测辅助CIDR是否与当前VPC的对等连接，对端VPC下的主CIDR或辅助CIDR存在重叠。
     ...
     */
    DescribeSecurityGroupExpandedPolicies(req: DescribeSecurityGroupExpandedPoliciesRequest, cb?: (error: string, rep: DescribeSecurityGroupExpandedPoliciesResponse) => void): Promise<DescribeSecurityGroupExpandedPoliciesResponse>;
    /**
...
本接口是异步完成，如需查询异步任务执行结果，请使用本接口返回的`RequestId`轮询[DescribeVpcTaskResult](https://cloud.tencent.com/document/api/215/59037) 接口。
     ...
     * 查询云联网策略路由下一跳
     */
    DescribeCcnPolicyBasedRoutingNextHop(req: DescribeCcnPolicyBasedRoutingNextHopRequest, cb?: (error: string, rep: DescribeCcnPolicyBasedRoutingNextHopResponse) => void): Promise<DescribeCcnPolicyBasedRoutingNextHopResponse>;
    /**
     * 查询专线绑定NAT的路由
     */
...
- 如需调整弹性公网 IPv6 实例的带宽上限，请使用 [ModifyIPv6AddressesBandwidth](https://cloud.tencent.com/document/product/215/113674) 接口。
     ...
     * 本接口（ReplaceRoutes）根据路由策略ID（RouteId）修改指定的路由策略（Route），支持批量修改。
     */
    ReplaceRoutesWithRoutePolicy(req: ReplaceRoutesWithRoutePolicyRequest, cb?: (error: string, rep: ReplaceRoutesWithRoutePolicyResponse) => void): Promise<ReplaceRoutesWithRoutePolicyResponse>;
    /**
