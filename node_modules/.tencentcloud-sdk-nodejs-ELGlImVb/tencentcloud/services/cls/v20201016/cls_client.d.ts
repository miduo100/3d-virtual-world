...
import { DescribeLogHistogramRequest, DescribeNetworkApplicationDetailRequest, DeleteShipperRequest, DeleteConsoleResponse, CreateRebuildIndexTaskResponse, CreateSearchViewRequest, DescribeAgentConfigsResponse, CheckFunctionRequest, ModifyNetworkApplicationResponse, CreateLogsetRequest, CreateScheduledSqlResponse, CreateConsoleSharingRequest, SearchLogResponse, DeleteMetricSubscribeResponse, DescribePartitionsRequest, CheckFunctionResponse, ModifyAlarmResponse, PreviewKafkaRechargeRequest, CreateConfigExtraResponse, DescribeClusterBaseMetricConfigsRequest, DescribeConfigExtrasResponse, DeleteMetricSubscribeRequest, DeleteMachineGroupResponse, CreateDlcDeliverResponse, CreateConsumerGroupRequest, ModifyMachineGroupResponse, DescribeConsumerPreviewRequest, CreateRecordingRuleTaskResponse, DeleteDashboardResponse, OpenClsServiceRequest, DescribeRecordingRuleYamlTaskResponse, DeleteExportResponse, DescribeDashboardSubscribesRequest, CreateNoticeContentResponse, OpenClsServiceResponse, ModifyAlarmRequest, RetryShipperTaskResponse, SplitPartitionRequest, CreateAlarmShieldRequest, DeleteAlarmShieldResponse, CreateIndexRequest, CreateTopicRequest, ModifyDataTransformRequest, CreateDlcDeliverRequest, ModifyScheduledSqlRequest, DeleteConfigResponse, CreateDeliverCloudFunctionRequest, ModifyDlcDeliverResponse, ModifyDashboardResponse, DescribeMetricSubscribesResponse, CreateWebCallbackRequest, DescribeClusterMetricConfigsRequest, DescribeConfigsRequest, DescribeKafkaConsumerTopicsResponse, QueryMetricRequest, DescribeAlarmNoticesResponse, DeleteDataTransformRequest, DescribeRemoteWriteTasksResponse, AddMachineGroupInfoRequest, DescribeKafkaRechargesRequest, CreateHostMetricConfigResponse, ModifyConsumerGroupRequest, CreateTopicResponse, DeleteAlarmResponse, DeleteConsoleSharingResponse, DescribeTopicBaseMetricConfigsRequest, DescribeDlcDeliversResponse, ModifyIndexRequest, GetAlarmLogRequest, DeleteCosRechargeResponse, DeleteTopicRequest, ModifyShipperRequest, DescribeKafkaConsumerPreviewRequest, DescribeAgentApplicationsRequest, CreateDeliverCloudFunctionResponse, DescribeDashboardsResponse, ModifyRemoteWriteTaskResponse, CreateConfigResponse, CreateCloudProductLogCollectionResponse, SearchCosRechargeInfoResponse, CreateEsRechargeResponse, ModifyMachineGroupRequest, DescribeHostMetricConfigsResponse, CreateNoticeContentRequest, CreateDashboardRequest, DeleteAlarmNoticeRequest, DeleteLogsetRequest, DescribeConsumersRequest, ModifyRecordingRuleYamlTaskResponse, CreateMachineGroupRequest, DescribeExportsResponse, DescribeCloudProductLogTasksRequest, CreateAlarmNoticeRequest, DescribeTopicMetricConfigsRequest, ModifyLogsetRequest, SearchDashboardSubscribeResponse, ModifyCosRechargeRequest, DescribeClusterMetricConfigsResponse, DescribeWebCallbacksRequest, DescribeKafkaConsumerGroupListResponse, CreateMetricSubscribeResponse, DescribeMachinesRequest, DeleteSplunkDeliverResponse, DescribeTopicMetricConfigsResponse, DeleteDashboardSubscribeRequest, DeleteAlarmNoticeResponse, DeleteAlarmShieldRequest, ModifyEsRechargeRequest, CreateNetworkApplicationRequest, ModifyS3RechargeResponse, DeleteLogsetResponse, DeleteDlcDeliverResponse, DescribeShipperTasksResponse, DescribeAlarmShieldsResponse, ModifyConfigExtraResponse, DeleteConsoleSharingRequest, UploadLogRequest, ModifyConsoleSharingRequest, CommitConsumerOffsetsRequest, ModifyConsoleResponse, DescribeAlarmsRequest, DescribeShippersResponse, ModifyShipperResponse, GetMetricLabelValuesResponse, QueryMetricResponse, DescribeScheduledSqlInfoResponse, OpenKafkaConsumerResponse, CreateSplunkDeliverResponse, ModifyScheduledSqlResponse, QueryRangeMetricRequest, DescribeMachineGroupsRequest, ModifySearchViewResponse, DescribeConfigsResponse, DeleteDataTransformResponse, CreateConsumerResponse, DeleteMachineGroupRequest, DescribeSplunkDeliversResponse, SearchDashboardSubscribeRequest, DescribePartitionsResponse, ModifyHostMetricConfigResponse, DescribeConsumerOffsetsRequest, ModifyAlarmNoticeRequest, CreateAlarmRequest, DeleteScheduledSqlResponse, DescribeConsumersResponse, DescribeEsRechargesResponse, CheckRechargeKafkaServerRequest, DeleteDashboardSubscribeResponse, DescribeLogHistogramResponse, DescribeConsumerGroupsRequest, CreateWebCallbackResponse, DeleteConsumerGroupRequest, OpenKafkaConsumerRequest, CreateConsumerGroupResponse, ModifyMetricConfigResponse, DeleteSearchViewRequest, SearchS3RechargeInfoRequest, DescribeConsumerResponse, EstimateRebuildIndexTaskRequest, DescribeClusterBaseMetricConfigsResponse, ModifyKafkaRechargeRequest, DescribeS3RechargesRequest, CreateIndexResponse, ModifyDashboardSubscribeResponse, DescribeSplunkPreviewRequest, ModifyConfigRequest, CreateMetricConfigResponse, DeleteConfigFromMachineGroupResponse, PreviewKafkaRechargeResponse, DeleteLogResponse, DescribeAlarmsResponse, DeleteIndexResponse, CreateRemoteWriteTaskRequest, DescribeSplunkDeliversRequest, DeleteScheduledSqlRequest, ModifyKafkaConsumerRequest, DescribeS3RechargesResponse, ModifyRecordingRuleYamlTaskRequest, DescribeConsumerGroupsResponse, CreateDataTransformResponse, DescribeKafkaConsumerTopicsRequest, CreateConfigExtraRequest, CreateConsumerRequest, DeleteHostMetricConfigRequest, DeleteMetricConfigResponse, DescribeRemoteWriteTasksRequest, ApplyConfigToMachineGroupResponse, DeleteAlarmRequest, DescribeLogContextResponse, ModifyConsoleSharingResponse, EstimateRebuildIndexTaskResponse, DeleteDashboardRequest, CreateCosRechargeResponse, ModifyLogsetResponse, CreateDashboardResponse, GetMetricLabelValuesRequest, ModifyMetricSubscribeResponse, DescribeIndexResponse, DescribeConsumerPreviewResponse, DeleteRecordingRuleTaskResponse, DeleteMachineGroupInfoResponse, CheckRechargeKafkaServerResponse, DeleteNetworkApplicationResponse, DeleteNoticeContentRequest, DescribeKafkaConsumerRequest, DeleteRecordingRuleTaskRequest, DescribeDataTransformInfoResponse, ModifyCosRechargeResponse, DescribeEsRechargePreviewRequest, MergePartitionResponse, CreateScheduledSqlRequest, DescribeKafkaConsumerGroupDetailResponse, ModifyDashboardRequest, SendConsumerHeartbeatResponse, DeleteHostMetricConfigResponse, GetClsServiceResponse, DescribeAgentApplicationsResponse, DeleteMetricConfigRequest, CreateEsRechargeRequest, DescribeDashboardsRequest, DeleteNoticeContentResponse, CreateAgentApplicationResponse, ModifyS3RechargeRequest, DeleteCloudProductLogCollectionRequest, DescribeKafkaConsumerResponse, DeleteKafkaRechargeResponse, DeleteDlcDeliverRequest, ModifyNetworkApplicationRequest, DescribeHostMetricConfigsRequest, SplitPartitionResponse, DescribeConsoleSharingListResponse, CreateLogsetResponse, ModifyHostMetricConfigRequest, ModifyAlarmShieldResponse, CreateCosRechargeRequest, ChatCompletionsResponse, DescribeNoticeContentsResponse, CreateAlarmShieldResponse, DescribeConsumerRequest, DeleteConfigExtraResponse, ModifyConsumerRequest, ModifyMetricConfigRequest, ModifyDashboardSubscribeRequest, CreateDashboardSubscribeRequest, DescribeConfigMachineGroupsResponse, ModifySplunkDeliverRequest, DeleteAgentApplicationResponse, CreateMetricSubscribeRequest, DescribeConfigMachineGroupsRequest, DescribeMetricSubscribePreviewRequest, DeleteConsumerResponse, DescribeTopicsRequest, ModifySplunkDeliverResponse, RetryShipperTaskRequest, DeleteCosRechargeRequest, CreateHostMetricConfigRequest, ModifyWebCallbackResponse, ModifyCloudProductLogCollectionResponse, DeleteConsumerRequest, CreateNetworkApplicationResponse, DeleteIndexRequest, DeleteAgentApplicationRequest, DescribeAlertRecordHistoryRequest, ChatCompletionsRequest, DeleteNetworkApplicationRequest, CreateS3RechargeResponse, CreateExportRequest, CancelRebuildIndexTaskRequest, DescribeConsoleSharingListRequest, DescribeLogsetsResponse, DescribeKafkaConsumerPreviewResponse, ModifySearchViewRequest, CreateAlarmNoticeResponse, ModifyTopicResponse, CreateConfigRequest, DeleteEsRechargeResponse, DescribeNetworkApplicationsRequest, DescribeKafkaRechargesResponse, ModifyDlcDeliverRequest, CreateRecordingRuleTaskRequest, DeleteCloudProductLogCollectionResponse, DeleteS3RechargeRequest, DescribeWebCallbacksResponse, DeleteExportRequest, ModifyKafkaConsumerGroupOffsetRequest, ModifyRemoteWriteTaskRequest, DescribeConsolesRequest, CreateConsoleResponse, ModifyConfigResponse, ModifyConsoleRequest, DescribeRebuildIndexTasksResponse, ModifyAlarmNoticeResponse, DescribeConsumerOffsetsResponse, CreateConsoleSharingResponse, ModifyKafkaConsumerResponse, DescribeAlertRecordHistoryResponse, DescribeEsRechargesRequest, DescribeAlarmNoticesRequest, DescribeEsRechargePreviewResponse, DeleteS3RechargeResponse, MergePartitionRequest, DescribeRecordingRuleTaskRequest, ModifyAgentApplicationResponse, ApplyConfigToMachineGroupRequest, DescribeMachineGroupConfigsResponse, DescribeConfigExtrasRequest, DescribeMachineGroupConfigsRequest, DescribeSearchViewsRequest, ModifyWebCallbackRequest, DeleteTopicResponse, CreateExportResponse, CancelRebuildIndexTaskResponse, DescribeRecordingRuleYamlTaskRequest, UploadLogResponse, CreateAlarmResponse, DescribeMetricSubscribesRequest, DescribeLogContextRequest, DescribeMetricCorrectDimensionRequest, CreateRecordingRuleYamlTaskRequest, DescribeCosRechargesResponse, CreateSplunkDeliverRequest, CreateMachineGroupResponse, DeleteRecordingRuleYamlTaskResponse, OpenClawServiceRequest, CreateAgentApplicationRequest, SearchCosRechargeInfoRequest, DescribeNoticeContentsRequest, DescribeDlcDeliversRequest, DescribeNetworkApplicationDetailResponse, GetClsServiceRequest, DescribeShipperTasksRequest, ModifyLogRequest, CreateCloudProductLogCollectionRequest, DescribeIndexRequest, DescribeKafkaConsumerGroupListRequest, CreateConsoleRequest, DeleteMachineGroupInfoRequest, ModifyNoticeContentResponse, DeleteWebCallbackResponse, DescribeSearchViewsResponse, CreateS3RechargeRequest, DescribeAlarmShieldsRequest, CreateRecordingRuleYamlTaskResponse, DescribeTopicsResponse, CreateRemoteWriteTaskResponse, DescribeRebuildIndexTasksRequest, DescribeShippersRequest, DescribeCloudProductLogTasksResponse, DescribeCosRechargesRequest, DescribeNetworkApplicationsResponse, DescribeTopicBaseMetricConfigsResponse, CloseKafkaConsumerResponse, DeleteLogRequest, GetAlarmLogResponse, CreateDashboardSubscribeResponse, DescribeExportsRequest, CreateKafkaRechargeResponse, ModifyIndexResponse, QueryRangeMetricResponse, DescribeDashboardSubscribesResponse, CreateMetricConfigRequest, ModifyConsumerResponse, CreateSearchViewResponse, DeleteSearchViewResponse, DeleteConfigRequest, DeleteWebCallbackRequest, CloseKafkaConsumerRequest, ModifyAlarmShieldRequest, DeleteConfigExtraRequest, DeleteRemoteWriteTaskRequest, ModifyKafkaConsumerGroupOffsetResponse, CreateShipperRequest, CreateShipperResponse, ModifyCloudProductLogCollectionRequest, DeleteRemoteWriteTaskResponse, OpenClawServiceResponse, DescribeDataTransformInfoRequest, CreateRebuildIndexTaskRequest, DeleteShipperResponse, ModifyTopicRequest, DeleteSplunkDeliverRequest, ModifyEsRechargeResponse, ModifyLogResponse, ModifyConsumerGroupResponse, SearchS3RechargeInfoResponse, CreateKafkaRechargeRequest, DeleteKafkaRechargeRequest, ModifyDataTransformResponse, ModifyNoticeContentRequest, ModifyKafkaRechargeResponse, DescribeAgentConfigsRequest, DescribeMachinesResponse, DeleteEsRechargeRequest, ModifyMetricSubscribeRequest, DeleteRecordingRuleYamlTaskRequest, DeleteConfigFromMachineGroupRequest, DescribeRecordingRuleTaskResponse, AddMachineGroupInfoResponse, ModifyRecordingRuleTaskRequest, DescribeMetricSubscribePreviewResponse, DescribeScheduledSqlInfoRequest, DeleteConsumerGroupResponse, SearchLogRequest, DescribeKafkaConsumerGroupDetailRequest, DescribeMetricCorrectDimensionResponse, DeleteConsoleRequest, ModifyConfigExtraRequest, CreateDataTransformRequest, DescribeMachineGroupsResponse, DescribeLogsetsRequest, ModifyRecordingRuleTaskResponse, ModifyAgentApplicationRequest, DescribeConsolesResponse, SendConsumerHeartbeatRequest, CommitConsumerOffsetsResponse, DescribeSplunkPreviewResponse } from "./cls_models";
/**
 * cls client
 * @class
 */
...
API 中 Region 填写任意一个地域均可，建议使用广州(ap-guangzhou)
     */
    GetClsService(req?: GetClsServiceRequest, cb?: (error: string, rep: GetClsServiceResponse) => void): Promise<GetClsServiceResponse>;
    /**
     * 该接口用于获取通知渠道组列表
     */
...
如果该时刻向前推5分钟内均无指标数据，则无相应的查询结果。
     ...
     * 本接口用于获取cos导入配置
     */
    DescribeS3Recharges(req: DescribeS3RechargesRequest, cb?: (error: string, rep: DescribeS3RechargesResponse) => void): Promise<DescribeS3RechargesResponse>;
    /**
     * 本接口用于删除日志集。
     */
...
API 中 Region 填写任意一个地域均可开通所有地域的 CLS，建议使用广州(ap-guangzhou)
     */
    OpenClsService(req?: OpenClsServiceRequest, cb?: (error: string, rep: OpenClsServiceResponse) => void): Promise<OpenClsServiceResponse>;
    /**
     * 获取es导入配置
     */
     ...
     * 修改日志信息
     */
    DeleteLog(req: DeleteLogRequest, cb?: (error: string, rep: DeleteLogResponse) => void): Promise<DeleteLogResponse>;
    /**
     * 本接口用于创建日志或指标主题。
     */
     ...
     * 新建查询视图
     */
    CreateSearchView(req: CreateSearchViewRequest, cb?: (error: string, rep: CreateSearchViewResponse) => void): Promise<CreateSearchViewResponse>;
    /**
     * 获取告警历史，例如今天未恢复的告警
     */
     ...
     * 本接口用于修改aws导入任务
     */
    ModifyS3Recharge(req: ModifyS3RechargeRequest, cb?: (error: string, rep: ModifyS3RechargeResponse) => void): Promise<ModifyS3RechargeResponse>;
    /**
     * 取消重建索引任务
     */
     ...
     * 获取查询视图列表
     */
    DescribeSearchViews(req: DescribeSearchViewsRequest, cb?: (error: string, rep: DescribeSearchViewsResponse) => void): Promise<DescribeSearchViewsResponse>;
    /**
     * 内部云产品接入使用相关接口
     */
     ...
     * 本接口用于删除Agent应用
     */
    DeleteAgentApplication(req: DeleteAgentApplicationRequest, cb?: (error: string, rep: DeleteAgentApplicationResponse) => void): Promise<DeleteAgentApplicationResponse>;
    /**
     * 删除投递Ckafka任务
     */
     ...
     * 删除RemoteWrite任务
     */
    DeleteRemoteWriteTask(req: DeleteRemoteWriteTaskRequest, cb?: (error: string, rep: DeleteRemoteWriteTaskResponse) => void): Promise<DeleteRemoteWriteTaskResponse>;
    /**
     * 本接口用于获取告警策略列表。
     */
     ...
     * 删除查询视图
     */
    DeleteSearchView(req: DeleteSearchViewRequest, cb?: (error: string, rep: DeleteSearchViewResponse) => void): Promise<DeleteSearchViewResponse>;
    /**
     * 打开Kafka协议消费功能
     */
     ...
     * 本接口用于删除预聚合分析任务
     */
    DeleteRecordingRuleTask(req: DeleteRecordingRuleTaskRequest, cb?: (error: string, rep: DeleteRecordingRuleTaskResponse) => void): Promise<DeleteRecordingRuleTaskResponse>;
    /**
     * 创建机器组
     */
     ...
     * 创建remote write投递任务
     */
    CreateRemoteWriteTask(req: CreateRemoteWriteTaskRequest, cb?: (error: string, rep: CreateRemoteWriteTaskResponse) => void): Promise<CreateRemoteWriteTaskResponse>;
    /**
     * 本接口用于获取索引配置信息
     */
     ...
     * 通过yaml文件创建指标预聚合任务
     */
    CreateRecordingRuleYamlTask(req: CreateRecordingRuleYamlTaskRequest, cb?: (error: string, rep: CreateRecordingRuleYamlTaskResponse) => void): Promise<CreateRecordingRuleYamlTaskResponse>;
    /**
     * 本接口用于删除DataSight控制台
     */
...
2. API返回数据包最大49MB，建议启用 gzip 压缩（HTTP Request Header Accept-Encoding:gzip）。
     ...
     * 本接口用于获取yaml预聚合任务列表
     */
    DescribeRecordingRuleYamlTask(req: DescribeRecordingRuleYamlTaskRequest, cb?: (error: string, rep: DescribeRecordingRuleYamlTaskResponse) => void): Promise<DescribeRecordingRuleYamlTaskResponse>;
    /**
     * 本接口用于修改投递Ckafka任务
     */
     ...
     * 本接口用于修改定时预聚合任务
     */
    ModifyRecordingRuleTask(req: ModifyRecordingRuleTaskRequest, cb?: (error: string, rep: ModifyRecordingRuleTaskResponse) => void): Promise<ModifyRecordingRuleTaskResponse>;
    /**
     * 获取agent对应的采集配置
     */
    DescribeAgentConfigs(req: DescribeAgentConfigsRequest, cb?: (error: string, rep: DescribeAgentConfigsResponse) => void): Promise<DescribeAgentConfigsResponse>;
    /**
     * 删除投递COS任务
     */
     ...
     * 本接口用于预览aws导入信息
     */
    SearchS3RechargeInfo(req: SearchS3RechargeInfoRequest, cb?: (error: string, rep: SearchS3RechargeInfoResponse) => void): Promise<SearchS3RechargeInfoResponse>;
    /**
     * 该接口用于创建告警渠道回调配置。
     */
     ...
     * 本接口用于创建aws导入任务
     */
    CreateS3Recharge(req: CreateS3RechargeRequest, cb?: (error: string, rep: CreateS3RechargeResponse) => void): Promise<CreateS3RechargeResponse>;
    /**
     * 修改日志信息
     */
    ModifyLog(req: ModifyLogRequest, cb?: (error: string, rep: ModifyLogResponse) => void): Promise<ModifyLogResponse>;
    /**
     * 本接口用于删除日志下载任务
     */
...
⚠️注意：通过SSE流式调用此接口时，请务必设置请求域名（Endpoint）为 cls.ai.tencentcloudapi.com (VPC内网环境可配置 cls.ai.internal.tencentcloudapi.com）。
     ...
     * 创建指标预聚合任务
     */
    CreateRecordingRuleTask(req: CreateRecordingRuleTaskRequest, cb?: (error: string, rep: CreateRecordingRuleTaskResponse) => void): Promise<CreateRecordingRuleTaskResponse>;
    /**
     * 本接口用于获取预聚合任务列表
     */
    DescribeRecordingRuleTask(req: DescribeRecordingRuleTaskRequest, cb?: (error: string, rep: DescribeRecordingRuleTaskResponse) => void): Promise<DescribeRecordingRuleTaskResponse>;
    /**
     * 本接口用于获取仪表盘订阅列表，支持分页
     */
     ...
     * 本接口用于删除aws导入任务
     */
    DeleteS3Recharge(req: DeleteS3RechargeRequest, cb?: (error: string, rep: DeleteS3RechargeResponse) => void): Promise<DeleteS3RechargeResponse>;
    /**
     * 修改机器组。
注意：修改接口直接覆盖历史数据，改为本次合法入参数据，请谨慎调用此接口。
     ...
     * 本接口用于删除yaml预聚合任务
     */
    DeleteRecordingRuleYamlTask(req: DeleteRecordingRuleYamlTaskRequest, cb?: (error: string, rep: DeleteRecordingRuleYamlTaskResponse) => void): Promise<DeleteRecordingRuleYamlTaskResponse>;
    /**
     ...
     * 通过yaml文件修改指标预聚合任务
     */
    ModifyRecordingRuleYamlTask(req: ModifyRecordingRuleYamlTaskRequest, cb?: (error: string, rep: ModifyRecordingRuleYamlTaskResponse) => void): Promise<ModifyRecordingRuleYamlTaskResponse>;
    /**
     ...
     * 本接口用于创建Agent应用
     */
    CreateAgentApplication(req: CreateAgentApplicationRequest, cb?: (error: string, rep: CreateAgentApplicationResponse) => void): Promise<CreateAgentApplicationResponse>;
    /**
     * 获取指标订阅配置
     */
     ...
     * 本接口用于修改Agent应用
     */
    ModifyAgentApplication(req: ModifyAgentApplicationRequest, cb?: (error: string, rep: ModifyAgentApplicationResponse) => void): Promise<ModifyAgentApplicationResponse>;
    /**
     * 获取时序label values列表
     */
     ...
     * 获取Agent应用列表
     */
    DescribeAgentApplications(req: DescribeAgentApplicationsRequest, cb?: (error: string, rep: DescribeAgentApplicationsResponse) => void): Promise<DescribeAgentApplicationsResponse>;
    /**
     * 获取Kafka协议消费组详情
     */
     ...
     */
    DescribeRemoteWriteTasks(req: DescribeRemoteWriteTasksRequest, cb?: (error: string, rep: DescribeRemoteWriteTasksResponse) => void): Promise<DescribeRemoteWriteTasksResponse>;
    /**
     * ## 提示
...
将生成的 cls.pb.h 头文件引入代码中，调用接口进行数据格式封装。
     ...
     * 修改查询视图
     */
    ModifySearchView(req: ModifySearchViewRequest, cb?: (error: string, rep: ModifySearchViewResponse) => void): Promise<ModifySearchViewResponse>;
    /**
...
API返回数据包最大49MB，建议启用 gzip 压缩（HTTP Request Header Accept-Encoding:gzip）。
     ...
     * 修改RemoteWrite任务
     */
    ModifyRemoteWriteTask(req: ModifyRemoteWriteTaskRequest, cb?: (error: string, rep: ModifyRemoteWriteTaskResponse) => void): Promise<ModifyRemoteWriteTaskResponse>;
}
