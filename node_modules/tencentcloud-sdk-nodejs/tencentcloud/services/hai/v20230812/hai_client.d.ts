...
import { InquirePriceRunInstancesResponse, ResizeInstanceDiskResponse, DescribeServiceLoginSettingsResponse, ResetInstancesPasswordResponse, DescribeInstanceNetworkStatusResponse, TerminateInstancesRequest, InquirePriceUpdateServiceConfigsRequest, TerminateInstancesResponse, DescribeApplicationsResponse, StartInstanceRequest, ResizeInstanceDiskRequest, StopInstanceRequest, DescribeMuskPromptsRequest, DescribeScenesResponse, DescribeApplicationsRequest, CreateApplicationRequest, ResetInstancesPasswordRequest, RunInstancesRequest, DescribeInstancesResponse, UpdateServiceConfigsResponse, UpdateServiceConfigsRequest, RunInstancesResponse, DescribeInstancesRequest, DescribeScenesRequest, DescribeRegionsResponse, InquirePriceRunInstancesRequest, InquirePriceUpdateServiceConfigsResponse, StartInstanceResponse, CreateMuskPromptResponse, DescribeServiceLoginSettingsRequest, CreateApplicationResponse, CreateMuskPromptRequest, DescribeRegionsRequest, DescribeInstanceNetworkStatusRequest, StopInstanceResponse, DescribeMuskPromptsResponse } from "./hai_models";
/**
 * hai client
 * @class
 */
