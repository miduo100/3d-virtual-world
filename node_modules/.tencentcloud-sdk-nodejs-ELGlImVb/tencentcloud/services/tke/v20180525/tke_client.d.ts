...
export declare class Client extends AbstractClient {
     ...
     * 查询集群发布序列标签
     */
    DescribeClusterRollOutSequenceTags(req: DescribeClusterRollOutSequenceTagsRequest, cb?: (error: string, rep: DescribeClusterRollOutSequenceTagsResponse) => void): Promise<DescribeClusterRollOutSequenceTagsResponse>;
    /**
     * 修改日志采集配置
     */
     ...
     * 创建集群维护时间窗口和排除项
     */
    CreateClusterMaintenanceWindowAndExclusions(req: CreateClusterMaintenanceWindowAndExclusionsRequest, cb?: (error: string, rep: CreateClusterMaintenanceWindowAndExclusionsResponse) => void): Promise<CreateClusterMaintenanceWindowAndExclusionsResponse>;
    /**
...
查询边缘容器集群可用的自定义参数
     ...
     * 创建全局维护时间窗口和排除项
     */
    CreateGlobalMaintenanceWindowAndExclusions(req: CreateGlobalMaintenanceWindowAndExclusionsRequest, cb?: (error: string, rep: CreateGlobalMaintenanceWindowAndExclusionsResponse) => void): Promise<CreateGlobalMaintenanceWindowAndExclusionsResponse>;
    /**
     * 扩容独立集群master节点
     */
     ...
     * 轮转集群的token
     */
    RotateClusterToken(req?: RotateClusterTokenRequest, cb?: (error: string, rep: RotateClusterTokenResponse) => void): Promise<RotateClusterTokenResponse>;
    /**
...
边缘计算支持版本和k8s版本
     ...
     * 查询计划升级任务详情
     */
    DescribeUpgradeTaskDetail(req: DescribeUpgradeTaskDetailRequest, cb?: (error: string, rep: DescribeUpgradeTaskDetailResponse) => void): Promise<DescribeUpgradeTaskDetailResponse>;
    /**
     * 查询边缘集群列表
     */
     ...
     * 查询插件日志采集配置
     */
    DescribeControlPlaneLogs(req: DescribeControlPlaneLogsRequest, cb?: (error: string, rep: DescribeControlPlaneLogsResponse) => void): Promise<DescribeControlPlaneLogsResponse>;
    /**
     * 获取集群版本信息
     */
     ...
     * 删除集群发布序列
     */
    DeleteRollOutSequence(req: DeleteRollOutSequenceRequest, cb?: (error: string, rep: DeleteRollOutSequenceResponse) => void): Promise<DeleteRollOutSequenceResponse>;
    /**
     * 查询边缘集群自定义参数
     */
...
获取边缘脚本链接，此接口用于添加第三方节点，通过下载脚本从而将节点添加到边缘集群。
     ...
     * 查询集群调度策略
     */
    DescribeClusterSchedulerPolicy(req: DescribeClusterSchedulerPolicyRequest, cb?: (error: string, rep: DescribeClusterSchedulerPolicyResponse) => void): Promise<DescribeClusterSchedulerPolicyResponse>;
    /**
     * 修改2.0实例告警策略
     */
     ...
     * 获取集群维护时间窗口和排除项
     */
    DescribeClusterMaintenanceWindowAndExclusions(req: DescribeClusterMaintenanceWindowAndExclusionsRequest, cb?: (error: string, rep: DescribeClusterMaintenanceWindowAndExclusionsResponse) => void): Promise<DescribeClusterMaintenanceWindowAndExclusionsResponse>;
    /**
     * 更新集群自定义参数，只支持托管集群
     */
    ModifyClusterExtraArgs(req: ModifyClusterExtraArgsRequest, cb?: (error: string, rep: ModifyClusterExtraArgsResponse) => void): Promise<ModifyClusterExtraArgsResponse>;
    /**
     * 扩展(新建)集群节点
     */
     ...
     * 删除插件日志采集配置
     */
    DisableControlPlaneLogs(req: DisableControlPlaneLogsRequest, cb?: (error: string, rep: DisableControlPlaneLogsResponse) => void): Promise<DisableControlPlaneLogsResponse>;
    /**
     * 获取镜像信息
     */
     ...
     * 查询计划升级任务
     */
    DescribeUpgradeTasks(req: DescribeUpgradeTasksRequest, cb?: (error: string, rep: DescribeUpgradeTasksResponse) => void): Promise<DescribeUpgradeTasksResponse>;
    /**
     * 更新镜像缓存接口
     */
     ...
     * 删除全集维护时间窗口和排除项
     */
    DeleteGlobalMaintenanceWindowAndExclusion(req: DeleteGlobalMaintenanceWindowAndExclusionRequest, cb?: (error: string, rep: DeleteGlobalMaintenanceWindowAndExclusionResponse) => void): Promise<DeleteGlobalMaintenanceWindowAndExclusionResponse>;
    /**
     * 获取一个addon的参数
     */
     ...
     * 更新全局维护时间窗口和排除项
     */
    ModifyGlobalMaintenanceWindowAndExclusions(req: ModifyGlobalMaintenanceWindowAndExclusionsRequest, cb?: (error: string, rep: ModifyGlobalMaintenanceWindowAndExclusionsResponse) => void): Promise<ModifyGlobalMaintenanceWindowAndExclusionsResponse>;
    /**
     * 更新容器实例
     */
     ...
     * 创建集群发布序列
     */
    CreateRollOutSequence(req: CreateRollOutSequenceRequest, cb?: (error: string, rep: CreateRollOutSequenceResponse) => void): Promise<CreateRollOutSequenceResponse>;
    /**
     * 驱逐超级节点
     */
     ...
     */
    ModifyMasterComponent(req: ModifyMasterComponentRequest, cb?: (error: string, rep: ModifyMasterComponentResponse) => void): Promise<ModifyMasterComponentResponse>;
    /**
     * 修改集群镜像
     */
     ...
     * 暂停或者取消集群更新参数任务
     */
    ModifyClusterExtraArgsTaskState(req: ModifyClusterExtraArgsTaskStateRequest, cb?: (error: string, rep: ModifyClusterExtraArgsTaskStateResponse) => void): Promise<ModifyClusterExtraArgsTaskStateResponse>;
    /**
     * 查询集群巡检结果历史列表
     */
     ...
     */
    DescribeUserPermissions(req: DescribeUserPermissionsRequest, cb?: (error: string, rep: DescribeUserPermissionsResponse) => void): Promise<DescribeUserPermissionsResponse>;
    /**
     * 创建集群路由
     */
     ...
     * Eks集群开启事件持久化功能
     */
    EnableEksEventPersistence(req: EnableEksEventPersistenceRequest, cb?: (error: string, rep: EnableEksEventPersistenceResponse) => void): Promise<EnableEksEventPersistenceResponse>;
    /**
     * 取消升级计划
     */
    CancelUpgradePlan(req: CancelUpgradePlanRequest, cb?: (error: string, rep: CancelUpgradePlanResponse) => void): Promise<CancelUpgradePlanResponse>;
    /**
     ...
     */
    GrantUserPermissions(req: GrantUserPermissionsRequest, cb?: (error: string, rep: GrantUserPermissionsResponse) => void): Promise<GrantUserPermissionsResponse>;
    /**
     * 查询集群变配记录
     */
     ...
     * 更新集群发布序列标签
     */
    ModifyClusterRollOutSequenceTags(req: ModifyClusterRollOutSequenceTagsRequest, cb?: (error: string, rep: ModifyClusterRollOutSequenceTagsResponse) => void): Promise<ModifyClusterRollOutSequenceTagsResponse>;
    /**
     * 切换集群网络访问链路为直连
     */
    SwitchClusterEndpoint(req: SwitchClusterEndpointRequest, cb?: (error: string, rep: SwitchClusterEndpointResponse) => void): Promise<SwitchClusterEndpointResponse>;
    /**
     * 创建告警规则
     */
     ...
     * 获取全局维护时间窗口和排除项
     */
    DescribeGlobalMaintenanceWindowAndExclusions(req: DescribeGlobalMaintenanceWindowAndExclusionsRequest, cb?: (error: string, rep: DescribeGlobalMaintenanceWindowAndExclusionsResponse) => void): Promise<DescribeGlobalMaintenanceWindowAndExclusionsResponse>;
    /**
     * 查询备份仓库信息
     */
     ...
     * 修改集群调度策略
     */
    ModifyClusterSchedulerPolicy(req: ModifyClusterSchedulerPolicyRequest, cb?: (error: string, rep: ModifyClusterSchedulerPolicyResponse) => void): Promise<ModifyClusterSchedulerPolicyResponse>;
    /**
     * 修改聚合规则yaml方式
     */
     ...
     * 删除集群维护时间窗口和排除项
     */
    DeleteClusterMaintenanceWindowAndExclusion(req: DeleteClusterMaintenanceWindowAndExclusionRequest, cb?: (error: string, rep: DeleteClusterMaintenanceWindowAndExclusionResponse) => void): Promise<DeleteClusterMaintenanceWindowAndExclusionResponse>;
    /**
     * 获取模板关联实例信息，针对V2版本实例
     */
     ...
     * 更新集群发布序列
     */
    ModifyRollOutSequence(req: ModifyRollOutSequenceRequest, cb?: (error: string, rep: ModifyRollOutSequenceResponse) => void): Promise<ModifyRollOutSequenceResponse>;
    /**
     * 获取弹性容器集群的接入认证信息
     */
     ...
     * 创建插件日志采集配置
     */
    EnableControlPlaneLogs(req: EnableControlPlaneLogsRequest, cb?: (error: string, rep: EnableControlPlaneLogsResponse) => void): Promise<EnableControlPlaneLogsResponse>;
    /**
     * 获得实例级别抓取配置
     */
     ...
     * 查询集群发布序列
     */
    DescribeRollOutSequences(req: DescribeRollOutSequencesRequest, cb?: (error: string, rep: DescribeRollOutSequencesResponse) => void): Promise<DescribeRollOutSequencesResponse>;
    /**
     * 检查给定节点列表中哪些是可升级的
     */
     ...
     * 查询集群可用的自定义参数
     */
    DescribeClusterAvailableExtraArgs(req: DescribeClusterAvailableExtraArgsRequest, cb?: (error: string, rep: DescribeClusterAvailableExtraArgsResponse) => void): Promise<DescribeClusterAvailableExtraArgsResponse>;
    /**
     ...
     */
    DeleteUserPermissions(req: DeleteUserPermissionsRequest, cb?: (error: string, rep: DeleteUserPermissionsResponse) => void): Promise<DeleteUserPermissionsResponse>;
    /**
     * 删除集群内采集规则
     */
     ...
     */
    DescribeMasterComponent(req: DescribeMasterComponentRequest, cb?: (error: string, rep: DescribeMasterComponentResponse) => void): Promise<DescribeMasterComponentResponse>;
    /**
     * 启用集群删除保护
     */
     ...
     * 更新集群维护时间窗口和排除项
     */
    ModifyClusterMaintenanceWindowAndExclusions(req: ModifyClusterMaintenanceWindowAndExclusionsRequest, cb?: (error: string, rep: ModifyClusterMaintenanceWindowAndExclusionsResponse) => void): Promise<ModifyClusterMaintenanceWindowAndExclusionsResponse>;
    /**
     * 删除集群中的实例
     */
