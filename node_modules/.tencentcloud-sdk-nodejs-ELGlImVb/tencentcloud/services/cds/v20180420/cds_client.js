...
class Client extends abstract_client_1.AbstractClient {
     ...
     * 查询报表列表
     */
    async DescribeReportList(req, cb) {
        return this.request("DescribeReportList", req, cb);
    }
    /**
     * 新建报表任务
     */
    async CreateTimerReport(req, cb) {
     ...
     * 查询报表任务列表
     */
    async DescribeReportMissionList(req, cb) {
     ...
     * 查询资产列表
     */
    async DescribeAssetsList(req, cb) {
