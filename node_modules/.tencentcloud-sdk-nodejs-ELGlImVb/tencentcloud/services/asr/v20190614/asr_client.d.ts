...
import { CreateCustomizationResponse, ModifyCustomizationStateRequest, CreateRecTaskResponse, UpdateAsrVocabResponse, DeleteAsrKeyWordLibResponse, CreateAsrKeyWordLibRequest, VoicePrintGroupVerifyRequest, GetCustomizationListResponse, CloseAsyncRecognitionTaskRequest, VoicePrintGroupListRequest, DeleteCustomizationResponse, GetCustomizationListRequest, SentenceRecognitionRequest, VoicePrintCountRequest, VoicePrintCompareResponse, SetVocabStateResponse, VoicePrintDeleteRequest, DescribeAsyncRecognitionTasksRequest, GetAsrKeyWordLibListResponse, VoicePrintEnrollResponse, CreateAsrKeyWordLibResponse, CreateAsyncRecognitionTaskRequest, GetAsrVocabRequest, DescribeTaskStatusResponse, DownloadAsrVocabResponse, ModifyCustomizationResponse, GetAsrVocabListRequest, VoicePrintUpdateRequest, DeleteAsrVocabRequest, UpdateAsrVocabRequest, CreateAsrVocabResponse, SentenceRecognitionResponse, DescribeAsyncRecognitionTasksResponse, GetAsrVocabListResponse, DownloadCustomizationRequest, GetAsrVocabResponse, UpdateAsrKeyWordLibRequest, GetUsageByDateResponse, VoicePrintDeleteResponse, DownloadCustomizationResponse, CreateRecTaskRequest, DownloadAsrVocabRequest, ModifyCustomizationRequest, VoicePrintUpdateResponse, GetModelInfoResponse, DescribeTaskStatusRequest, VoicePrintCompareRequest, DeleteCustomizationRequest, VoicePrintCountResponse, CloseAsyncRecognitionTaskResponse, VoicePrintGroupVerifyResponse, CreateCustomizationRequest, UpdateAsrKeyWordLibResponse, CreateAsyncRecognitionTaskResponse, GetAsrKeyWordLibListRequest, DeleteAsrVocabResponse, VoicePrintVerifyRequest, SetVocabStateRequest, VoicePrintGroupListResponse, CreateAsrVocabRequest, VoicePrintVerifyResponse, DeleteAsrKeyWordLibRequest, GetModelInfoRequest, ModifyCustomizationStateResponse, GetUsageByDateRequest, VoicePrintEnrollRequest } from "./asr_models";
/**
 * asr client
 * @class
 */
...
<br>• 默认单账号限制并发数为20路，如您有提高并发限制的需求，请提[工单](https://console.cloud.tencent.com/workorder/category)进行咨询。
     ...
     * 返回注册的说话人分组信息列表
     */
    VoicePrintGroupList(req?: VoicePrintGroupListRequest, cb?: (error: string, rep: VoicePrintGroupListResponse) => void): Promise<VoicePrintGroupListResponse>;
    /**
