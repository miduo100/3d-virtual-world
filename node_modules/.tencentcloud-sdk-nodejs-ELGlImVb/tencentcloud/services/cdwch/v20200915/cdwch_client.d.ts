...
import { CreateInstanceNewResponse, DescribeInstanceStateRequest, DescribeClusterConfigsResponse, ActionAlterCkUserRequest, ScaleOutInstanceResponse, DescribeInstanceNodesResponse, DescribeInstancesNewResponse, DescribeBackUpJobDetailResponse, RecoverBackUpJobRequest, ScaleOutInstanceRequest, ModifyClusterConfigsRequest, DescribeInstanceShardsResponse, DeleteBackUpDataRequest, ResizeDiskResponse, DescribeEventTasksResponse, DescribeInstanceNodesRequest, ModifyUserNewPrivilegeRequest, DescribeCkSqlApisRequest, OpenBackUpRequest, CreateInstanceNewRequest, DescribeBackUpScheduleResponse, CreateBackUpScheduleRequest, DescribeSpecRequest, ActionAlterCkUserResponse, DescribeInstanceStateResponse, DestroyInstanceResponse, DescribeEventTasksRequest, DescribeInstanceShardsRequest, ResizeDiskRequest, DescribeInstanceKeyValConfigsRequest, OpenBackUpResponse, DescribeCNInstancesRequest, DescribeSpecResponse, ModifyInstanceKeyValConfigsResponse, DescribeBackUpTablesResponse, DescribeInstanceClustersResponse, DescribeInstanceKeyValConfigsResponse, DescribeInstancesNewRequest, DescribeClusterConfigsRequest, CreateBackUpScheduleResponse, DescribeInstanceResponse, DescribeBackUpJobResponse, DescribeCkSqlApisResponse, DescribeBackUpScheduleRequest, RestartInstanceResponse, ScaleCNOutUpInstanceResponse, DescribeInstanceClustersRequest, DescribeCNInstancesResponse, DestroyInstanceRequest, RestartInstanceRequest, ModifyClusterConfigsResponse, DeleteBackUpDataResponse, ModifyInstanceKeyValConfigsRequest, ScaleCNOutUpInstanceRequest, RecoverBackUpJobResponse, ScaleUpInstanceRequest, DescribeBackUpJobDetailRequest, DescribeInstanceRequest, DescribeBackUpJobRequest, DescribeBackUpTablesRequest, ScaleUpInstanceResponse, ModifyUserNewPrivilegeResponse } from "./cdwch_models";
/**
 * cdwch client
 * @class
 */
export declare class Client extends AbstractClient {
     ...
     * 获取产生的事件
     */
    DescribeEventTasks(req: DescribeEventTasksRequest, cb?: (error: string, rep: DescribeEventTasksResponse) => void): Promise<DescribeEventTasksResponse>;
    /**
     * 获取实例节点信息列表
     */
     ...
     * 获取云原生实例列表
     */
    DescribeCNInstances(req: DescribeCNInstancesRequest, cb?: (error: string, rep: DescribeCNInstancesResponse) => void): Promise<DescribeCNInstancesResponse>;
    /**
     * 扩容磁盘，包含扩容数据节点，zk节点
     */
