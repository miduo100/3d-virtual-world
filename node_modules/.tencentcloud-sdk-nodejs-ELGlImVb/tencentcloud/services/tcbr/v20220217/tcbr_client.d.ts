...
export declare class Client extends AbstractClient {
     ...
     * 更新配置并使用最新镜像发布
     */
    SubmitServerConfigChangeDiff(req: SubmitServerConfigChangeDiffRequest, cb?: (error: string, rep: SubmitServerConfigChangeDiffResponse) => void): Promise<SubmitServerConfigChangeDiffResponse>;
    /**
     ...
     * 停止版本实例
     */
    StopVersionInstance(req: StopVersionInstanceRequest, cb?: (error: string, rep: StopVersionInstanceResponse) => void): Promise<StopVersionInstanceResponse>;
    /**
     * 回滚版本
     */
     ...
     * 启动版本实例
     */
    StartVersionInstance(req: StartVersionInstanceRequest, cb?: (error: string, rep: StartVersionInstanceResponse) => void): Promise<StartVersionInstanceResponse>;
    /**
     * 查询云托管部署记录
     */
