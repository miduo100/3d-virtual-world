...
注意：不支持屏幕共享中的板书导出。
     ...
     * 获取课堂的所有编辑版本（含源版本）
     */
    async DescribeEditVersions(req, cb) {
     ...
     * 获取转推配置
     */
    async DescribeLiveRelayConfig(req, cb) {
     ...
     * 切换课堂的主编辑版本
     */
    async SetMainEditVersion(req, cb) {
...
被禁言用户退出房间之后再进入同一房间，禁言仍然有效。
     ...
     * 修改转推配置
     */
    async ModifyLiveRelayConfig(req, cb) {
...
删除课堂前，请先删除该课堂下的各类资源（包括录制文件、板书等），并解绑相关课件。
     ...
     * 获取剪辑信令回放token
     */
    async GetEditVersionToken(req, cb) {
