...
class Client extends abstract_client_1.AbstractClient {
     ...
     */
    async DescribeMemoryPlusSpaces(req, cb) {
     ...
     */
    async RecoverMemoryPlusSpace(req, cb) {
     ...
     */
    async DestroyMemoryPlusSpace(req, cb) {
     ...
     */
    async CreateMemoryPlusSpace(req, cb) {
     ...
     */
    async DescribeServiceAccessKey(req, cb) {
     ...
     */
    async ModifyMemoryPlusSpace(req, cb) {
     ...
     */
    async IsolateMemoryPlusSpace(req, cb) {
