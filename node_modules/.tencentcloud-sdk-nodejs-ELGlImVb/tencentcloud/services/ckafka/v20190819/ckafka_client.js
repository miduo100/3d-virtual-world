...
class Client extends abstract_client_1.AbstractClient {
     ...
     * 连接器实例同步任务-元数据同步
     */
    async CreateMetaSyncDatahubTask(req, cb) {
     ...
     */
    async CreateMetaDataAndOffsetSyncDatahubTask(req, cb) {
        return this.request("CreateMetaDataAndOffsetSyncDatahubTask", req, cb);
    }
    /**
     * 连接器实例同步任务-元数据、消息同步
     */
    async CreateMetaAndDataSyncDatahubTask(req, cb) {
...
本接口（DescribeTopic）用于在用户获取消息队列 CKafka 实例的主题列表
     ...
     */
    async IsolatedInstancePre(req, cb) {
