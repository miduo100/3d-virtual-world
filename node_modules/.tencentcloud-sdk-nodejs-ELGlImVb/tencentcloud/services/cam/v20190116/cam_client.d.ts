...
export declare class Client extends AbstractClient {
     ...
     * 获取CAM密码设置规则
     */
    GetPasswordRules(req?: GetPasswordRulesRequest, cb?: (error: string, rep: GetPasswordRulesResponse) => void): Promise<GetPasswordRulesResponse>;
    /**
     * 获取自定义多因子Token关联信息
     */
     ...
     * 更新CAM密码设置规则
     */
    UpdatePasswordRules(req: UpdatePasswordRulesRequest, cb?: (error: string, rep: UpdatePasswordRulesResponse) => void): Promise<UpdatePasswordRulesResponse>;
    /**
     * 查询用户组详情
     */
...
如果已存在策略版本，本接口会直接更新策略的默认版本，不会创建新版本，如果不存在任何策略版本，则直接创建一个默认版本。
     ...
     * 查询所有账号列表
     */
    ListAccounts(req: ListAccountsRequest, cb?: (error: string, rep: ListAccountsResponse) => void): Promise<ListAccountsResponse>;
    /**
     * 用户加入到用户组
     */
