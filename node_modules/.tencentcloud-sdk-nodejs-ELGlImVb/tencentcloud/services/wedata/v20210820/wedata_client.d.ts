...
export declare class Client extends AbstractClient {
     ...
     */
    DescribeInstancesByExecutors(req: DescribeInstancesByExecutorsRequest, cb?: (error: string, rep: DescribeInstancesByExecutorsResponse) => void): Promise<DescribeInstancesByExecutorsResponse>;
    /**
     * 数据集成分页获取数据库SCHEMA信息
     */
