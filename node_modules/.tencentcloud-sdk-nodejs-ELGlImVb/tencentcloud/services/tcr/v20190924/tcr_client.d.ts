...
import { DeleteInstanceCustomizedDomainResponse, ManageImageLifecycleGlobalPersonalResponse, DescribeImagePersonalResponse, DescribeUserQuotaPersonalRequest, DeleteSignaturePolicyRequest, DescribeReplicationInstanceCreateTasksResponse, DescribeInternalEndpointsRequest, ModifyTagRetentionRuleRequest, ManageExternalEndpointRequest, DeleteReplicationRuleResponse, DescribeNamespacesResponse, DescribeInstanceCustomizedDomainResponse, DescribeSkillDetailResponse, DownloadHelmChartRequest, DuplicateImagePersonalRequest, CreateInstanceResponse, DescribeRepositoryOwnerPersonalResponse, DeleteInstanceTokenRequest, ModifyRepositoryRequest, ModifyReplicationResponse, ListAIModelsRequest, DescribeInternalEndpointDnsStatusRequest, CreateApplicationTriggerPersonalRequest, DeleteInternalEndpointDnsRequest, DeleteSkillResponse, ModifyInstanceRequest, RenewInstanceResponse, ManageInternalEndpointRequest, CreateImmutableTagRulesRequest, DescribeRepositoriesResponse, DeleteInstanceTokenResponse, DescribeInstancesResponse, CreateReplicationInstanceRequest, ValidateRepositoryExistPersonalRequest, ModifyInstanceTokenResponse, DescribeApplicationTriggerLogPersonalResponse, DeleteNamespacePersonalRequest, ModifyImmutableTagRulesResponse, ModifyServiceAccountRequest, DescribeSkillDetailRequest, CreateMultipleSecurityPolicyResponse, CreateTagRetentionRuleResponse, DescribeRegionsResponse, DescribeChartDownloadInfoResponse, DescribeServiceAccountsRequest, DescribeExternalEndpointStatusRequest, DeleteRepositoryResponse, DeleteImagePersonalResponse, DescribeWebhookTriggerLogResponse, CreateGCJobRequest, ManageReplicationRequest, ListAIModelVersionsResponse, DescribeInstanceStatusResponse, DeleteWebhookTriggerResponse, DeleteImageLifecycleGlobalPersonalResponse, DescribeImageManifestsResponse, DescribeReplicationInstanceSyncStatusResponse, DescribeSkillDownloadInfoResponse, DeleteInstanceCustomizedDomainRequest, ModifyRepositoryResponse, DeleteAIModelRequest, CreateImmutableTagRulesResponse, DeleteApplicationTriggerPersonalResponse, DescribeRepositoryFilterPersonalRequest, DescribeTagRetentionExecutionTaskResponse, DescribeInternalEndpointsResponse, DeleteImmutableTagRulesResponse, DescribeRepositoryPersonalRequest, ModifyTagRetentionRuleResponse, DeleteApplicationTriggerPersonalRequest, CreateTagRetentionRuleRequest, DuplicateImagePersonalResponse, DeleteSkillRequest, DeleteReplicationInstanceRequest, CreateImageAccelerationServiceRequest, DescribeWebhookTriggerResponse, DeleteAIModelResponse, ModifyInstanceTokenRequest, CreateNamespaceResponse, ModifyImmutableTagRulesRequest, DescribeReplicationPoliciesRequest, TerminateGCJobResponse, ModifySecurityPolicyRequest, ModifyInstanceStorageRequest, DescribeSecurityPoliciesResponse, CreateSignatureResponse, DeleteRepositoryTagsRequest, DescribeImageLifecycleGlobalPersonalResponse, CreateNamespacePersonalResponse, DescribeReplicationInstanceSyncStatusRequest, DeleteInstanceResponse, DeleteImageLifecycleGlobalPersonalRequest, DescribeInstanceStatusRequest, ModifyWebhookTriggerRequest, CreateImageAccelerationServiceResponse, DeleteNamespaceResponse, CreateSignatureRequest, DescribeRepositoryPersonalResponse, CreateSecurityPolicyResponse, DescribeRepositoriesRequest, CreateUserPersonalRequest, DeleteServiceAccountResponse, ModifyNamespaceResponse, DescribeAIModelVersionDetailResponse, DownloadHelmChartResponse, ModifyUserPasswordPersonalResponse, DescribeImagesResponse, ModifyRepositoryInfoPersonalResponse, DescribeWebhookTriggerLogRequest, RenewInstanceRequest, DescribeImageFilterPersonalRequest, TerminateGCJobRequest, DescribeTagRetentionExecutionTaskRequest, ModifyReplicationRequest, DeleteRepositoryTagsResponse, DeleteMultipleSecurityPolicyRequest, DeleteSecurityPolicyResponse, CreateSignaturePolicyResponse, DescribeInternalEndpointDnsStatusResponse, DescribeNamespacePersonalRequest, DeleteRepositoryPersonalResponse, CreateInstanceTokenResponse, DeleteReplicationRuleRequest, DeleteImagePersonalRequest, DescribeApplicationTriggerPersonalResponse, DescribeImageAccelerateServiceResponse, CreateRepositoryPersonalRequest, ModifyServiceAccountPasswordRequest, DescribeImageFilterPersonalResponse, DescribeReplicationInstancesRequest, DeleteWebhookTriggerRequest, DeleteSignaturePolicyResponse, CreateUserPersonalResponse, DeleteServiceAccountRequest, DescribeImageManifestsRequest, DescribeSkillDownloadInfoRequest, ModifyNamespaceRequest, DeleteImageRequest, ModifyRepositoryAccessPersonalRequest, CreateMultipleSecurityPolicyRequest, DescribeNamespacesRequest, ModifyRepositoryAccessPersonalResponse, DescribeImageLifecycleGlobalPersonalRequest, DescribeImageLifecyclePersonalRequest, DeleteSecurityPolicyRequest, ListSkillsRequest, CreateInstanceRequest, DescribeReplicationPoliciesResponse, DescribeInstanceTokenRequest, BatchDeleteRepositoryPersonalResponse, CreateNamespaceRequest, CreateServiceAccountResponse, BatchDeleteRepositoryPersonalRequest, DescribeChartDownloadInfoRequest, ValidateRepositoryExistPersonalResponse, DeleteImageAccelerateServiceRequest, CheckInstanceResponse, DescribeInstancesRequest, ListAIModelVersionsRequest, CreateInternalEndpointDnsRequest, DescribeImmutableTagRulesRequest, DuplicateImageResponse, DescribeReplicationInstanceCreateTasksRequest, ModifyWebhookTriggerResponse, ManageImageLifecycleGlobalPersonalRequest, DescribeUserQuotaPersonalResponse, DescribeImagePersonalRequest, CreateServiceAccountRequest, DescribeRepositoryFilterPersonalResponse, ModifySecurityPolicyResponse, ModifyApplicationTriggerPersonalResponse, DeleteInstanceRequest, DescribeImageLifecyclePersonalResponse, DescribeNamespacePersonalResponse, DeleteNamespacePersonalResponse, DescribeWebhookTriggerRequest, DescribeReplicationInstancesResponse, CreateSecurityPolicyRequest, ManageReplicationResponse, CreateWebhookTriggerRequest, DescribeAIModelVersionDetailRequest, DeleteImageAccelerateServiceResponse, ListSkillVersionsRequest, ListSkillVersionsResponse, ModifyRepositoryInfoPersonalRequest, DescribeApplicationTriggerLogPersonalRequest, DescribeGCJobsResponse, DescribeFavorRepositoryPersonalRequest, DescribeApplicationTriggerPersonalRequest, DeleteMultipleSecurityPolicyResponse, ManageInternalEndpointResponse, CreateRepositoryPersonalResponse, CreateInstanceCustomizedDomainRequest, CreateTagRetentionExecutionResponse, DescribeFavorRepositoryPersonalResponse, CheckInstanceNameResponse, DeleteTagRetentionRuleResponse, DescribeRepositoryOwnerPersonalRequest, DeleteReplicationInstanceResponse, DescribeExternalEndpointStatusResponse, DescribeTagRetentionRulesResponse, DescribeRegionsRequest, ManageExternalEndpointResponse, DescribeImmutableTagRulesResponse, ModifyApplicationTriggerPersonalRequest, CreateReplicationInstanceResponse, CreateInstanceTokenRequest, DescribeServiceAccountsResponse, CreateInstanceCustomizedDomainResponse, DescribeSecurityPoliciesRequest, ModifyInstanceResponse, CreateGCJobResponse, ValidateNamespaceExistPersonalResponse, CheckInstanceRequest, CreateRepositoryRequest, DeleteImageResponse, DescribeImageAccelerateServiceRequest, DeleteNamespaceRequest, BatchDeleteImagePersonalRequest, DescribeImagesRequest, DescribeGCJobsRequest, DescribeTagRetentionExecutionRequest, CreateRepositoryResponse, DescribeTagRetentionRulesRequest, ModifyInstanceStorageResponse, CheckInstanceNameRequest, DescribeInstanceAllNamespacesRequest, DescribeInstanceTokenResponse, DescribeInstanceCustomizedDomainRequest, DescribeTagRetentionExecutionResponse, CreateNamespacePersonalRequest, DeleteImmutableTagRulesRequest, CreateWebhookTriggerResponse, ModifyServiceAccountResponse, CreateSignaturePolicyRequest, ListSkillsResponse, DeleteTagRetentionRuleRequest, ModifyUserPasswordPersonalRequest, DeleteRepositoryRequest, CreateInternalEndpointDnsResponse, DuplicateImageRequest, CreateTagRetentionExecutionRequest, ListAIModelsResponse, DescribeInstanceAllNamespacesResponse, ValidateNamespaceExistPersonalRequest, ModifyServiceAccountPasswordResponse, CreateApplicationTriggerPersonalResponse, BatchDeleteImagePersonalResponse, DeleteInternalEndpointDnsResponse, DeleteRepositoryPersonalRequest } from "./tcr_models";
/**
 * tcr client
 * @class
 */
export declare class Client extends AbstractClient {
     ...
     * 查询单个 Skill 的完整详情
     */
    DescribeSkillDetail(req: DescribeSkillDetailRequest, cb?: (error: string, rep: DescribeSkillDetailResponse) => void): Promise<DescribeSkillDetailResponse>;
    /**
     * 用于获取个人版全局镜像版本自动清理策略
     */
...
注意：当PolicyIndex和CidrBlock同时存在时，CidrBlock优先级更高
     ...
     */
    ListSkills(req: ListSkillsRequest, cb?: (error: string, rep: ListSkillsResponse) => void): Promise<ListSkillsResponse>;
    /**
     * 管理实例同步
     */
     ...
     */
    ListAIModels(req: ListAIModelsRequest, cb?: (error: string, rep: ListAIModelsResponse) => void): Promise<ListAIModelsResponse>;
    /**
     * 删除实例同步规则
     */
     ...
     * 查询指定 Skill 的版本历史列表
     */
    ListSkillVersions(req: ListSkillVersionsRequest, cb?: (error: string, rep: ListSkillVersionsResponse) => void): Promise<ListSkillVersionsResponse>;
    /**
     * 查询创建从实例任务状态
     */
     ...
     * 创建 GC 作业
     */
    CreateGCJob(req: CreateGCJobRequest, cb?: (error: string, rep: CreateGCJobResponse) => void): Promise<CreateGCJobResponse>;
    /**
     * 用于删除个人版全局镜像版本自动清理策略
     */
     ...
     * 删除指定 Skill
     */
    DeleteSkill(req: DeleteSkillRequest, cb?: (error: string, rep: DeleteSkillResponse) => void): Promise<DeleteSkillResponse>;
    /**
     * 用于删除实例多个公网访问白名单策略
     */
     ...
     * 返回 Skill 下载链接
     */
    DescribeSkillDownloadInfo(req: DescribeSkillDownloadInfoRequest, cb?: (error: string, rep: DescribeSkillDownloadInfoResponse) => void): Promise<DescribeSkillDownloadInfoResponse>;
    /**
     * 创建实例公网访问白名单策略
     */
     ...
     * 查询模型详情
     */
    DescribeAIModelVersionDetail(req: DescribeAIModelVersionDetailRequest, cb?: (error: string, rep: DescribeAIModelVersionDetailResponse) => void): Promise<DescribeAIModelVersionDetailResponse>;
    /**
     * 查询服务级账号
     */
     ...
     * 修改实例同步规则
     */
    ModifyReplication(req: ModifyReplicationRequest, cb?: (error: string, rep: ModifyReplicationResponse) => void): Promise<ModifyReplicationResponse>;
    /**
     ...
     */
    ListAIModelVersions(req: ListAIModelVersionsRequest, cb?: (error: string, rep: ListAIModelVersionsResponse) => void): Promise<ListAIModelVersionsResponse>;
    /**
     * 查询实例当前状态以及过程信息
     */
