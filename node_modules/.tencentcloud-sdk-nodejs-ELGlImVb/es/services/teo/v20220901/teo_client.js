...
export class Client extends AbstractClient {
    ...
    async DescribeInferenceServiceDeploymentRecords(req, cb) {
    ...
    async DescribeIPGroupReferences(req, cb) {
    ...
    async OperateInferenceService(req, cb) {
    ...
    async CreateInferenceAPIToken(req, cb) {
    ...
    async DescribeInferenceHardwareSpecifications(req, cb) {
    ...
    async ModifyInferenceService(req, cb) {
    ...
    async DescribeInferenceAPITokens(req, cb) {
    ...
    async DescribeInferenceServiceMonitorData(req, cb) {
    ...
    async DescribeInferenceServices(req, cb) {
    ...
    async DeleteInferenceAPIToken(req, cb) {
