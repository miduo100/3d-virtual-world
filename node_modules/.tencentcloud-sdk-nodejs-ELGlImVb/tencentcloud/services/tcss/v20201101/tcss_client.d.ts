...
容器网络创建网络策略添加并发布任务
     ...
     * 增加或修改恶意外连的白名单
     */
    AddOrModifyMaliciousConnectionWhiteList(req: AddOrModifyMaliciousConnectionWhiteListRequest, cb?: (error: string, rep: AddOrModifyMaliciousConnectionWhiteListResponse) => void): Promise<AddOrModifyMaliciousConnectionWhiteListResponse>;
    /**
     * 取消漏洞扫描忽略漏洞
     */
...
查询集群网络策略列表
     ...
     * 卸载集群容器安全
     */
    UninstallClusterContainerSecurity(req: UninstallClusterContainerSecurityRequest, cb?: (error: string, rep: UninstallClusterContainerSecurityResponse) => void): Promise<UninstallClusterContainerSecurityResponse>;
    /**
     * 修改异常进程事件的状态信息
     */
...
查询集群策略审计列表
     ...
     * 查询镜像拦截规则统计
     */
    DescribeImageDenyRuleSummary(req?: DescribeImageDenyRuleSummaryRequest, cb?: (error: string, rep: DescribeImageDenyRuleSummaryResponse) => void): Promise<DescribeImageDenyRuleSummaryResponse>;
    /**
     * 添加编辑告警策略
     */
...
查询集群网络空间列表
     ...
     * 运行时查询文件查杀新设置
     */
    DescribeVirusScanConfig(req?: DescribeVirusScanConfigRequest, cb?: (error: string, rep: DescribeVirusScanConfigResponse) => void): Promise<DescribeVirusScanConfigResponse>;
    /**
     * 容器安全搜索查询镜像风险列表导出
     */
...
容器网络创建Yaml网络策略并发布任务
     ...
     * 查询恶意外连白名单
     */
    DescribeMaliciousConnectionWhiteList(req: DescribeMaliciousConnectionWhiteListRequest, cb?: (error: string, rep: DescribeMaliciousConnectionWhiteListResponse) => void): Promise<DescribeMaliciousConnectionWhiteListResponse>;
    /**
     * 运行时查询文件查杀任务状态
     */
     ...
     * 查询镜像拦截事件趋势
     */
    DescribeImageDenyEventTendency(req: DescribeImageDenyEventTendencyRequest, cb?: (error: string, rep: DescribeImageDenyEventTendencyResponse) => void): Promise<DescribeImageDenyEventTendencyResponse>;
    /**
...
容器网络查询网络策略自动发现任务进度
     ...
     * 查询反弹shell正则白名单列表
     */
    DescribeReverseShellRegexpWhiteList(req: DescribeReverseShellRegexpWhiteListRequest, cb?: (error: string, rep: DescribeReverseShellRegexpWhiteListResponse) => void): Promise<DescribeReverseShellRegexpWhiteListResponse>;
    /**
     * 查询漏洞影响的镜像列表
     */
     ...
     * 新增或修改木马白名单规则
     */
    AddOrModifyVirusWhiteListRule(req: AddOrModifyVirusWhiteListRuleRequest, cb?: (error: string, rep: AddOrModifyVirusWhiteListRuleResponse) => void): Promise<AddOrModifyVirusWhiteListRuleResponse>;
    /**
     * 删除运行时反弹shell事件
     */
     ...
     * 查询恶意外连黑名单
     */
    DescribeMaliciousConnectionBlackList(req: DescribeMaliciousConnectionBlackListRequest, cb?: (error: string, rep: DescribeMaliciousConnectionBlackListResponse) => void): Promise<DescribeMaliciousConnectionBlackListResponse>;
    /**
     ...
     * 运行时查询文件查杀实时监控设置信息
     */
    DescribeVirusMonitorConfig(req?: DescribeVirusMonitorConfigRequest, cb?: (error: string, rep: DescribeVirusMonitorConfigResponse) => void): Promise<DescribeVirusMonitorConfigResponse>;
    /**
...
容器网络查询资产任务进度
     ...
     * 查询镜像拦截规则详情
     */
    DescribeImageDenyRuleDetail(req: DescribeImageDenyRuleDetailRequest, cb?: (error: string, rep: DescribeImageDenyRuleDetailResponse) => void): Promise<DescribeImageDenyRuleDetailResponse>;
    /**
     * 查询k8sapi异常事件趋势
     */
     ...
     * 查询镜像拦截事件列表
     */
    DescribeImageDenyEventList(req: DescribeImageDenyEventListRequest, cb?: (error: string, rep: DescribeImageDenyEventListResponse) => void): Promise<DescribeImageDenyEventListResponse>;
    /**
     * 查询本地镜像组件列表
     */
...
容器网络创建网络策略删除任务
     ...
     * 查询镜像拦截事件详情
     */
    DescribeImageDenyEventDetail(req: DescribeImageDenyEventDetailRequest, cb?: (error: string, rep: DescribeImageDenyEventDetailResponse) => void): Promise<DescribeImageDenyEventDetailResponse>;
    /**
     * 查询导出任务管理列表
     */
...
容器网络集群查看Yaml网络策略详情
     ...
     * 查询木马白名单规则列表
     */
    DescribeVirusWhiteListRules(req: DescribeVirusWhiteListRulesRequest, cb?: (error: string, rep: DescribeVirusWhiteListRulesResponse) => void): Promise<DescribeVirusWhiteListRulesResponse>;
    /**
     * 安装检查组件，创建防护容器
     */
...
容器网络集群下发刷新任务
     ...
     * 查询镜像拦截规则列表
     */
    DescribeImageDenyRuleList(req: DescribeImageDenyRuleListRequest, cb?: (error: string, rep: DescribeImageDenyRuleListResponse) => void): Promise<DescribeImageDenyRuleListResponse>;
    /**
     * 查询漏洞扫描忽略的仓库镜像列表
     */
...
查询集群网络空间标签列表
     ...
     * 查询反弹shell正则白名单详情
     */
    DescribeReverseShellRegexpWhiteListInfo(req: DescribeReverseShellRegexpWhiteListInfoRequest, cb?: (error: string, rep: DescribeReverseShellRegexpWhiteListInfoResponse) => void): Promise<DescribeReverseShellRegexpWhiteListInfoResponse>;
    /**
     * 运行时文件查杀事件列表导出
     */
...
容器网络集群查看策略详情
     ...
     * 删除木马白名单规则
     */
    DeleteVirusWhiteListRule(req: DeleteVirusWhiteListRuleRequest, cb?: (error: string, rep: DeleteVirusWhiteListRuleResponse) => void): Promise<DeleteVirusWhiteListRuleResponse>;
    /**
