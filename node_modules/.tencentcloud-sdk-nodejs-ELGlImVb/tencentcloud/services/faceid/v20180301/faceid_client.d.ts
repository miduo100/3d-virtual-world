...
export declare class Client extends AbstractClient {
     ...
     */
    GetWxNFCResult(req: GetWxNFCResultRequest, cb?: (error: string, rep: GetWxNFCResultResponse) => void): Promise<GetWxNFCResultResponse>;
    /**
     ...
     */
    GetNFCToken(req?: GetNFCTokenRequest, cb?: (error: string, rep: GetNFCTokenResponse) => void): Promise<GetNFCTokenResponse>;
    /**
