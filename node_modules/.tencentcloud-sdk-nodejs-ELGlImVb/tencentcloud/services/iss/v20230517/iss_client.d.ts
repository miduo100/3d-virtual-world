...
import { UpdateDeviceStatusRequest, ListDevicesRequest, DeleteRecordBackupPlanResponse, ListOrganizationChannelsRequest, ListSubTasksRequest, AddRecordBackupPlanResponse, DescribeCNAMERequest, ControlRecordTimelineRequest, DeleteOrganizationRequest, SetForbidPlayChannelsRequest, DescribeCNAMEResponse, UpdateOrganizationResponse, BatchDeleteVideoDownloadTaskRequest, UpdateDeviceOrganizationRequest, UpdateDeviceOrganizationResponse, AddOrganizationResponse, BatchOperateDeviceResponse, DescribeDeviceRegionResponse, DescribeVideoBitRateResponse, DescribeDomainResponse, ControlDeviceStreamResponse, DeleteRecordRetrieveTaskResponse, DeleteRecordPlanResponse, DescribeOrganizationResponse, UpdateUserDeviceRequest, DescribeDeviceChannelResponse, AddRecordBackupTemplateRequest, DescribeVideoBitRateRequest, DescribeUserDeviceListRequest, DescribeRecordRetrieveTaskRequest, ControlDeviceSnapshotResponse, RefreshDeviceChannelResponse, DeleteOrganizationResponse, DescribeRecordTemplateRequest, DeleteRecordTemplateRequest, DescribeRecordPlanResponse, DeleteUserDeviceRequest, AddRecordPlanResponse, ListOrganizationChannelNumbersRequest, ListVideoDownloadTaskResponse, DeleteDomainRequest, ListRecordRetrieveTasksRequest, DeleteRecordPlanRequest, AddRecordTemplateResponse, ListRecordPlansRequest, DescribeUserDeviceResponse, ListSubTasksResponse, ListDeviceSnapshotsRequest, UpdateRecordPlanRequest, DescribeOrganizationRequest, ControlRecordResponse, AddRecordPlanRequest, ListRecordTemplatesRequest, DescribeVideoDownloadUrlResponse, DescribeUserDeviceListResponse, CallISAPIRequest, AddRecordRetrieveTaskRequest, DescribeRecordPlanRequest, ControlDevicePresetResponse, ListRecordBackupPlansResponse, DescribeDevicePresetRequest, DescribeDomainRequest, BatchDeleteVideoDownloadTaskResponse, CallISAPIResponse, ListRecordPlanDevicesRequest, ListTasksResponse, AddStreamAuthResponse, ListDevicesResponse, RefreshDeviceChannelRequest, ListOrganizationChannelNumbersResponse, ListRecordBackupTemplatesResponse, ListRecordPlanChannelsResponse, UpdateRecordTemplateRequest, DescribeRecordPlaybackUrlRequest, ListRecordPlansResponse, DescribeRecordTemplateResponse, DescribeRecordSliceResponse, ListRecordPlanDevicesResponse, DescribeDevicePresetResponse, UpdateRecordBackupPlanRequest, ControlRecordRequest, ControlDevicePTZResponse, ListRecordBackupPlansRequest, AddUserDeviceRequest, ListRecordBackupPlanDevicesResponse, DeleteTaskRequest, ControlDevicePTZRequest, DescribeRecordBackupPlanRequest, DescribeRecordBackupPlanResponse, DescribeDeviceChannelRequest, UpdateUserDeviceResponse, ListTasksRequest, CreateVideoDownloadTaskResponse, UpdateOrganizationRequest, DescribeGBDeviceAddrRequest, ControlDeviceSnapshotRequest, DescribeDomainRegionRequest, AddRecordTemplateRequest, DescribeRecordFileRequest, QueryForbidPlayChannelListResponse, DescribeVideoDownloadUrlRequest, ListRecordBackupTemplatesRequest, DescribeRecordSliceRequest, DescribeUserDeviceRequest, DescribeDeviceRegionRequest, AddStreamAuthRequest, PlayRecordRequest, QueryForbidPlayChannelListRequest, DescribeRecordFileResponse, DescribeGBDeviceAddrResponse, ControlDevicePresetRequest, ControlDeviceStreamRequest, ListRecordRetrieveTasksResponse, ListRecordBackupPlanDevicesRequest, DeleteDomainResponse, AddRecordRetrieveTaskResponse, DeleteRecordTemplateResponse, ListRecordTemplatesResponse, DescribeRecordBackupTemplateRequest, UpdateRecordBackupTemplateResponse, ControlRecordTimelineResponse, DeleteRecordRetrieveTaskRequest, UpdateRecordPlanResponse, DescribeTaskResponse, DeleteRecordBackupPlanRequest, ListRecordPlanChannelsRequest, SetForbidPlayChannelsResponse, ListVideoDownloadTaskRequest, DeleteRecordBackupTemplateRequest, UpdateRecordTemplateResponse, AddRecordBackupTemplateResponse, PlayRecordResponse, DescribeRecordBackupTemplateResponse, AddUserDeviceResponse, DeleteTaskResponse, DescribeRecordPlaybackUrlResponse, DescribeTaskRequest, ListOrganizationChannelsResponse, DescribeDomainRegionResponse, BatchOperateDeviceRequest, AddRecordBackupPlanRequest, ListDeviceSnapshotsResponse, UpdateRecordBackupTemplateRequest, UpdateDeviceStatusResponse, DeleteUserDeviceResponse, UpdateRecordBackupPlanResponse, AddOrganizationRequest, DescribeStreamAuthResponse, DeleteRecordBackupTemplateResponse, CreateVideoDownloadTaskRequest, DescribeRecordRetrieveTaskResponse, DescribeStreamAuthRequest } from "./iss_models";
/**
 * iss client
 * @class
 */
...
（注意：只支持标准存储类型的查询）
     ...
     * 用于批量查询设备详细信息。
     */
    DescribeUserDeviceList(req: DescribeUserDeviceListRequest, cb?: (error: string, rep: DescribeUserDeviceListResponse) => void): Promise<DescribeUserDeviceListResponse>;
    /**
     * 用于获取视频通道的码率信息
     */
     ...
     * 创建本地录像下载任务
     */
    CreateVideoDownloadTask(req: CreateVideoDownloadTaskRequest, cb?: (error: string, rep: CreateVideoDownloadTaskResponse) => void): Promise<CreateVideoDownloadTaskResponse>;
    /**
     * 查询禁播通道列表
     */
     ...
     * 用于批量删除本地录像下载失败的任务
     */
    BatchDeleteVideoDownloadTask(req: BatchDeleteVideoDownloadTaskRequest, cb?: (error: string, rep: BatchDeleteVideoDownloadTaskResponse) => void): Promise<BatchDeleteVideoDownloadTaskResponse>;
    /**
     * 用于查询录像上云计划详情。
     */
     ...
     * 用于获取国标设备的公网地址
     */
    DescribeGBDeviceAddr(req: DescribeGBDeviceAddrRequest, cb?: (error: string, rep: DescribeGBDeviceAddrResponse) => void): Promise<DescribeGBDeviceAddrResponse>;
    /**
     * 用于修改实时上云模板
     */
     ...
     * 查询本店里录像下载任务列表
     */
    ListVideoDownloadTask(req: ListVideoDownloadTaskRequest, cb?: (error: string, rep: ListVideoDownloadTaskResponse) => void): Promise<ListVideoDownloadTaskResponse>;
    /**
     * 用于修改实时上云计划
     */
