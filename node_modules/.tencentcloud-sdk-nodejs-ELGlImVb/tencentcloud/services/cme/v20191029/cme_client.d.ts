...
关于平台概念，请参见文档 [平台](https://cloud.tencent.com/document/product/1156/43767)。
     ...
     * 禁用账号。
     */
    ForbidAccount(req: ForbidAccountRequest, cb?: (error: string, rep: ForbidAccountResponse) => void): Promise<ForbidAccountResponse>;
    /**
