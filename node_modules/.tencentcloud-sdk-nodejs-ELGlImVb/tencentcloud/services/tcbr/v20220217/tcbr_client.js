...
class Client extends abstract_client_1.AbstractClient {
     ...
     * 更新配置并使用最新镜像发布
     */
    async SubmitServerConfigChangeDiff(req, cb) {
        return this.request("SubmitServerConfigChangeDiff", req, cb);
    }
    /**
     ...
     * 停止版本实例
     */
    async StopVersionInstance(req, cb) {
     ...
     * 启动版本实例
     */
    async StartVersionInstance(req, cb) {
