...
3. 通过任务ID查询合同归档任务状态
     */
    CreateArchiveFlowTask(req: CreateArchiveFlowTaskRequest, cb?: (error: string, rep: CreateArchiveFlowTaskResponse) => void): Promise<CreateArchiveFlowTaskResponse>;
    /**
...
注：`合同催办是白名单功能，请联系客户经理申请开白后使用`
     */
    CreateFlowGroupReminds(req: CreateFlowGroupRemindsRequest, cb?: (error: string, rep: CreateFlowGroupRemindsResponse) => void): Promise<CreateFlowGroupRemindsResponse>;
    /**
...
![image](https://qcloudimg.tencent-cloud.cn/raw/29a0fba0ceebf9227849459947384862.png)
     ...
     */
    DescribeArchiveFlowTask(req: DescribeArchiveFlowTaskRequest, cb?: (error: string, rep: DescribeArchiveFlowTaskResponse) => void): Promise<DescribeArchiveFlowTaskResponse>;
    /**
...
- 撤销后可以看合同PDF内容的人员： 发起方的超管， 发起方自己，发起方撤销合同的操作人员，已经签署合同、已经填写合同、邀请填写已经补充信息的参与人员， 其他参与人员看不到合同的内容。
     */
    CancelOrganizationFlows(req: CancelOrganizationFlowsRequest, cb?: (error: string, rep: CancelOrganizationFlowsResponse) => void): Promise<CancelOrganizationFlowsResponse>;
    /**
