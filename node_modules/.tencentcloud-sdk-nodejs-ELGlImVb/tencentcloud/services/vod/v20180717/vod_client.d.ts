...
import { ProcessMediaRequest, ModifySampleSnapshotTemplateResponse, CreateAigcVideoRedrawTaskRequest, CreateStorageRegionRequest, ExtractBlindWatermarkRequest, DescribeAllClassRequest, CreateAigcVideoRedrawTaskResponse, DescribeRoundPlaysRequest, WeChatMiniProgramPublishRequest, CreateTranscodeTemplateRequest, DescribeAnimatedGraphicsTemplatesRequest, LiveRealTimeClipResponse, DeleteJustInTimeTranscodeTemplateRequest, DeleteAnimatedGraphicsTemplateResponse, DescribeAigcFaceInfoRequest, DescribeAigcFaceInfoAsyncResponse, ManageTaskResponse, CreateImageProcessingTemplateRequest, ModifyDefaultStorageRegionRequest, ModifyEventConfigResponse, DeleteLLMComprehendTemplateRequest, CreateAigcAdvancedCustomElementRequest, ModifySampleSnapshotTemplateRequest, ModifyJustInTimeTranscodeTemplateRequest, DescribePrepaidProductsRequest, ManageTaskRequest, DescribeImageReviewUsageDataResponse, RebuildMediaRequest, DescribeDefaultDistributionConfigRequest, CreateImageSpriteTemplateRequest, DeleteProcessImageAsyncTemplateResponse, RefreshUrlCacheRequest, DescribeAIAnalysisTemplatesRequest, DeleteAIRecognitionTemplateResponse, DeleteContentReviewTemplateRequest, CreateAigcSubjectResponse, VerifyDomainRecordResponse, DescribeCurrentPlaylistResponse, ModifySuperPlayerConfigRequest, ResetProcedureTemplateRequest, ComposeMediaResponse, DescribeLicenseUsageDataResponse, DeleteMPSTemplateRequest, ModifyWordSampleResponse, DescribeDailyMediaPlayStatResponse, ModifySubAppIdInfoRequest, CreateAigcAdvancedCustomElementResponse, DeleteAigcAdvancedCustomElementRequest, DescribeClientUploadAccelerationUsageDataResponse, ModifyRebuildMediaTemplateRequest, ComposeMediaRequest, DescribeCLSTopicsRequest, CreateAigcCustomElementResponse, CreateAdaptiveDynamicStreamingTemplateRequest, PushUrlCacheResponse, DescribeDailyMediaPlayStatRequest, ModifyTranscodeTemplateRequest, ModifyMPSTemplateRequest, DescribeImageSpriteTemplatesRequest, DeleteImageProcessingTemplateRequest, DescribeDailyPlayStatFileListResponse, SetVodDomainCertificateRequest, DeleteSuperPlayerConfigRequest, ModifyMediaStorageClassResponse, CreateAigcQuotaResponse, DescribeProcedureTemplatesRequest, CreateProcedureTemplateRequest, DeleteAigcQuotaRequest, CreatePersonSampleRequest, ReviewAudioVideoRequest, ModifySuperPlayerConfigResponse, DescribeWordSamplesResponse, DescribeAigcFaceInfoAsyncRequest, RefreshUrlCacheResponse, DeleteAIRecognitionTemplateRequest, CreateKnowledgeBaseResponse, DescribeCDNStatDetailsResponse, AttachMediaSubtitlesRequest, DescribeEventConfigRequest, ModifyLLMComprehendTemplateResponse, CreateKnowledgeBaseRequest, ImportMediaKnowledgeRequest, DescribeEnhanceMediaTemplatesResponse, CreateAigcVideoTaskResponse, ModifyAdaptiveDynamicStreamingTemplateResponse, CreateRebuildMediaTemplateResponse, CreateBlindWatermarkTemplateRequest, CreateAigcAudioTaskResponse, ModifyVodDomainAccelerateConfigRequest, ModifyQualityInspectTemplateResponse, ModifyAdaptiveDynamicStreamingTemplateRequest, ForbidMediaDistributionRequest, DescribeAIRecognitionTemplatesResponse, EditMediaResponse, ProcessMediaByUrlRequest, DescribeDailyMostPlayedStatResponse, ModifyAIRecognitionTemplateResponse, ModifyMediaInfoRequest, ModifyPersonSampleRequest, DescribeSnapshotByTimeOffsetTemplatesRequest, ModifyHeadTailTemplateResponse, DeleteLLMComprehendTemplateResponse, CreateVodDomainRequest, DeleteRoundPlayRequest, EnhanceMediaQualityRequest, DescribeImageProcessingTemplatesRequest, ProcessMediaResponse, CreateWordSamplesResponse, DeleteAdaptiveDynamicStreamingTemplateResponse, DescribeKnowledgeBasesRequest, CreateWordSamplesRequest, DeleteVodDomainRequest, SetCLSPushTargetRequest, DescribeProcessImageAsyncTemplatesRequest, ProcessImageAsyncRequest, CreateAigcImageTaskResponse, ModifyAnimatedGraphicsTemplateResponse, CreateSceneAigcImageTaskResponse, DeleteCLSTopicResponse, LiveRealTimeClipRequest, DeleteAdaptiveDynamicStreamingTemplateRequest, DeleteEnhanceMediaTemplateResponse, ModifyPersonSampleResponse, CreateAigcCustomElementRequest, SimpleHlsClipResponse, DeleteAIAnalysisTemplateRequest, EditMediaRequest, CreateComplexAdaptiveDynamicStreamingTaskRequest, DescribeFileAttributesResponse, ProcessImageAsyncResponse, DescribeBlindWatermarkTemplatesRequest, DescribeAigcAdvancedCustomElementsResponse, DescribeJustInTimeTranscodeTemplatesResponse, CreateReviewTemplateRequest, DescribeMediaInfosResponse, DeleteProcedureTemplateResponse, ModifyAigcQuotaResponse, DescribeReviewTemplatesResponse, DescribeAdaptiveDynamicStreamingTemplatesResponse, ForbidMediaDistributionResponse, DeleteBlindWatermarkTemplateResponse, ExtractBlindWatermarkResponse, DescribeAdaptiveDynamicStreamingTemplatesRequest, ModifyRoundPlayRequest, ModifyWatermarkTemplateRequest, RemoveWatermarkResponse, CreatePersonSampleResponse, CreateContentReviewTemplateResponse, ModifyBlindWatermarkTemplateResponse, ModifyAnimatedGraphicsTemplateRequest, CreateAigcAudioCloneRequest, DeleteWordSamplesRequest, FastEditMediaResponse, DescribeDrmDataKeyResponse, DescribeAigcAdvancedCustomElementsRequest, DescribeMediaPlayStatDetailsResponse, ModifyContentReviewTemplateResponse, DescribeWatermarkTemplatesRequest, CreateAigcAudioTaskRequest, DescribeMediaProcessUsageDataRequest, ModifyProcessImageAsyncTemplateResponse, DescribeAigcQuotasRequest, CreateSuperPlayerConfigResponse, CreateEnhanceMediaTemplateResponse, DeleteReviewTemplateResponse, DescribeCDNUsageDataResponse, ModifyWordSampleRequest, CreateJustInTimeTranscodeTemplateResponse, DeleteMediaResponse, ModifySnapshotByTimeOffsetTemplateResponse, DeleteHeadTailTemplateRequest, SearchMediaResponse, ModifyAIAnalysisTemplateResponse, DescribeAigcApiTokensRequest, ModifyMediaStorageClassRequest, DescribeTranscodeTemplatesResponse, DescribeRebuildMediaTemplatesRequest, CreateCLSTopicResponse, CreateRoundPlayResponse, ProcessImageResponse, ProcessImageRequest, ModifyMediaInfoResponse, DescribeLLMComprehendTemplatesResponse, ModifyReviewTemplateRequest, CreateBlindWatermarkTemplateResponse, DescribeCLSTopicsResponse, ImportMediaKnowledgeResponse, RestoreMediaResponse, ModifyEnhanceMediaTemplateResponse, ModifyWatermarkTemplateResponse, EnhanceMediaByTemplateResponse, CreateJustInTimeTranscodeTemplateRequest, CreateAigcVideoTaskRequest, ModifyBlindWatermarkTemplateRequest, CreateAigcQuotaRequest, DescribeHeadTailTemplatesRequest, CreateLLMComprehendTemplateResponse, DescribeCdnLogsRequest, ProcessMediaByUrlResponse, DeleteContentReviewTemplateResponse, DescribeReviewTemplatesRequest, CreateSuperPlayerConfigRequest, DeleteRebuildMediaTemplateResponse, DescribeSubAppIdsResponse, SimpleHlsClipRequest, DescribeDailyPlayStatFileListRequest, DescribeSuperPlayerConfigsResponse, DescribeDailyMostPlayedStatRequest, ModifyLLMComprehendTemplateRequest, ModifyKnowledgeBaseRequest, DeleteImageSpriteTemplateResponse, DescribeContentReviewTemplatesResponse, DeleteAigcQuotaResponse, ExtractCopyRightWatermarkRequest, DescribeEnhanceMediaTemplatesRequest, DescribeEventsStateResponse, ModifyImageSpriteTemplateResponse, SetVodDomainCertificateResponse, CreateWatermarkTemplateRequest, DescribeMPSTemplatesRequest, DescribePersonSamplesRequest, DescribeEventsStateRequest, DescribeDrmKeyProviderInfoRequest, CreateImageProcessingTemplateResponse, ModifyJustInTimeTranscodeTemplateResponse, ExecuteFunctionResponse, ModifyQualityInspectTemplateRequest, DeleteImageProcessingTemplateResponse, ModifyVodDomainConfigResponse, DeleteAIAnalysisTemplateResponse, ModifyRebuildMediaTemplateResponse, CreateEnhanceMediaTemplateRequest, RebuildMediaByTemplateRequest, ModifyVodDomainConfigRequest, ConfirmEventsRequest, CreateAIRecognitionTemplateResponse, ModifySubAppIdStatusRequest, DeleteBlindWatermarkTemplateRequest, CreateSubAppIdResponse, DeleteTranscodeTemplateRequest, SplitMediaRequest, ModifyEventConfigRequest, DescribeBlindWatermarkTemplatesResponse, AttachMediaSubtitlesResponse, CreateDomainVerifyRecordResponse, ExtractCopyRightWatermarkResponse, ListFilesRequest, ParseStreamingManifestRequest, DeleteSampleSnapshotTemplateResponse, DeleteAigcApiTokenResponse, DescribeStorageDetailsResponse, PullEventsResponse, CreateCLSLogsetResponse, ModifyDefaultDistributionConfigRequest, DescribeImageReviewUsageDataRequest, DescribeEventConfigResponse, DescribeCdnLogsResponse, DeletePersonSampleResponse, CreateAigcSubjectRequest, CreateSnapshotByTimeOffsetTemplateResponse, ModifyContentReviewTemplateRequest, DeleteReviewTemplateRequest, CreateLLMComprehendTemplateRequest, DescribeAigcQuotasResponse, CreateAdaptiveDynamicStreamingTemplateResponse, DeleteSampleSnapshotTemplateRequest, DescribeStorageDataResponse, ProcessMediaByMPSRequest, ProcessMediaByMPSResponse, CreateCLSTopicRequest, ApplyUploadRequest, CreateSampleSnapshotTemplateResponse, WeChatMiniProgramPublishResponse, DeleteMediaRequest, CreateQualityInspectTemplateRequest, ProcessMediaByProcedureRequest, SetCLSPushTargetResponse, DeletePersonSampleRequest, DescribeCDNUsageDataRequest, DescribeLLMComprehendTemplatesRequest, CreateProcessImageAsyncTemplateResponse, DescribeReviewDetailsRequest, ModifySubAppIdInfoResponse, DeleteCLSTopicRequest, ParseStreamingManifestResponse, ListFilesResponse, CreateRoundPlayRequest, DescribeMediaPlayStatDetailsRequest, CreateClassResponse, DeleteSuperPlayerConfigResponse, DescribeSampleSnapshotTemplatesRequest, DeleteKnowledgeBaseResponse, DescribeVodDomainsResponse, DeleteAigcAdvancedCustomElementResponse, DescribeClientUploadAccelerationUsageDataRequest, ModifyAIRecognitionTemplateRequest, DeleteMPSTemplateResponse, DescribeStorageRegionsRequest, DescribeAigcFaceInfoResponse, CreateMPSTemplateResponse, DescribeCDNStatDetailsRequest, DeleteRoundPlayResponse, CreateStorageRegionResponse, DescribePrepaidProductsResponse, HandleCurrentPlaylistResponse, PushUrlCacheRequest, CreateAIAnalysisTemplateResponse, DeleteProcessImageAsyncTemplateRequest, CreateAigcAudioCloneResponse, ModifyClassRequest, DescribeQualityInspectTemplatesRequest, ModifyKnowledgeBaseResponse, DescribeMediaInfosRequest, CreateAigcApiTokenRequest, DescribeDrmDataKeyRequest, CreateAigcCustomVoiceResponse, DescribeDrmKeyProviderInfoResponse, ExtractTraceWatermarkResponse, CreateAIRecognitionTemplateRequest, DescribeTaskDetailRequest, PullUploadRequest, ResetProcedureTemplateResponse, CreateSceneAigcVideoTaskResponse, DeleteQualityInspectTemplateResponse, CreateHeadTailTemplateResponse, DeleteWordSamplesResponse, DescribeDefaultDistributionConfigResponse, DeleteProcedureTemplateRequest, SearchMediaBySemanticsResponse, CreateMPSTemplateRequest, DeleteClassResponse, ModifyTranscodeTemplateResponse, InspectMediaQualityResponse, DeleteRebuildMediaTemplateRequest, CreateDomainVerifyRecordRequest, CreateContentReviewTemplateRequest, DescribeContentReviewTemplatesRequest, CreateComplexAdaptiveDynamicStreamingTaskResponse, DescribeImageSpriteTemplatesResponse, CreateSceneAigcImageTaskRequest, InspectMediaQualityRequest, CreateQualityInspectTemplateResponse, DescribeStorageDataRequest, DescribeTaskDetailResponse, DeleteImageSpriteTemplateRequest, ModifyDefaultDistributionConfigResponse, CreateClassRequest, ModifyRoundPlayResponse, CreateProcedureTemplateResponse, DescribeCLSLogsetsResponse, DescribeMPSTemplatesResponse, RebuildMediaResponse, SetDrmKeyProviderInfoResponse, DescribeMediaProcessUsageDataResponse, DescribeSuperPlayerConfigsRequest, DescribeCLSLogsetsRequest, DescribeAigcUsageDataRequest, CreateVodDomainResponse, ModifyVodDomainAccelerateConfigResponse, ModifyHeadTailTemplateRequest, DescribeTasksResponse, DescribeSubAppIdsRequest, ModifyMPSTemplateResponse, ReviewImageResponse, DescribeStorageRegionsResponse, ModifySnapshotByTimeOffsetTemplateRequest, ModifyReviewTemplateResponse, CreateProcessImageAsyncTemplateRequest, CreateCLSLogsetRequest, ExtractTraceWatermarkRequest, DescribeAigcApiTokensResponse, DescribeSnapshotByTimeOffsetTemplatesResponse, DeleteAigcApiTokenRequest, SetDrmKeyProviderInfoRequest, DeleteSnapshotByTimeOffsetTemplateResponse, DescribeCLSPushTargetsRequest, DescribeTasksRequest, DescribeReviewDetailsResponse, CreateTranscodeTemplateResponse, ModifySubAppIdStatusResponse, CreateAIAnalysisTemplateRequest, UpdateAigcApiTokenResponse, EnhanceMediaByTemplateRequest, DeleteHeadTailTemplateResponse, DescribeAllClassResponse, ModifyImageSpriteTemplateRequest, DeleteWatermarkTemplateRequest, DeleteVodDomainResponse, DescribeWordSamplesRequest, ModifyAIAnalysisTemplateRequest, CommitUploadResponse, DescribeSampleSnapshotTemplatesResponse, ModifyProcessImageAsyncTemplateRequest, CreateAigcImageTaskRequest, ApplyUploadResponse, ReviewAudioVideoResponse, DeleteClassRequest, DescribeTranscodeTemplatesRequest, DescribeCurrentPlaylistRequest, FastEditMediaRequest, CreateRebuildMediaTemplateRequest, DescribeWatermarkTemplatesResponse, DescribeRoundPlaysResponse, UpdateAigcApiTokenRequest, CreateAnimatedGraphicsTemplateRequest, RemoveWatermarkRequest, ExecuteFunctionRequest, ModifyAigcQuotaRequest, ConfirmEventsResponse, CreateAigcApiTokenResponse, DescribeLicenseUsageDataRequest, DeleteTranscodeTemplateResponse, DescribePersonSamplesResponse, DescribeVodDomainsRequest, SplitMediaResponse, RestoreMediaRequest, PullEventsRequest, DescribeAIAnalysisTemplatesResponse, CreateSnapshotByTimeOffsetTemplateRequest, DescribeQualityInspectTemplatesResponse, CreateSubAppIdRequest, DescribeProcedureTemplatesResponse, SearchMediaRequest, CreateSampleSnapshotTemplateRequest, DescribeRebuildMediaTemplatesResponse, ModifyEnhanceMediaTemplateRequest, ModifyClassResponse, ProcessMediaByProcedureResponse, PullUploadResponse, DescribeProcessImageAsyncTemplatesResponse, CreateWatermarkTemplateResponse, DescribeKnowledgeBasesResponse, CommitUploadRequest, DeleteAnimatedGraphicsTemplateRequest, DeleteSnapshotByTimeOffsetTemplateRequest, DescribeAnimatedGraphicsTemplatesResponse, DeleteKnowledgeBaseRequest, DescribeAigcUsageDataResponse, DescribeCLSPushTargetsResponse, DescribeImageProcessingTemplatesResponse, ReviewImageRequest, DescribeHeadTailTemplatesResponse, HandleCurrentPlaylistRequest, RebuildMediaByTemplateResponse, CreateAigcCustomVoiceRequest, CreateAnimatedGraphicsTemplateResponse, VerifyDomainRecordRequest, DeleteEnhanceMediaTemplateRequest, ModifyDefaultStorageRegionResponse, DescribeStorageDetailsRequest, EnhanceMediaQualityResponse, DescribeFileAttributesRequest, CreateReviewTemplateResponse, CreateSceneAigcVideoTaskRequest, DeleteWatermarkTemplateResponse, DeleteQualityInspectTemplateRequest, DeleteJustInTimeTranscodeTemplateResponse, DescribeJustInTimeTranscodeTemplatesRequest, SearchMediaBySemanticsRequest, CreateHeadTailTemplateRequest, CreateImageSpriteTemplateResponse, DescribeAIRecognitionTemplatesRequest } from "./vod_models";
/**
 * vod client
 * @class
 */
...
由于AGC内客生成为异步任务，无法获取实时用量数据，因此配额限制存在一定误差，无法实现与设置额度完全精准的控制。
     */
    ModifyAigcQuota(req: ModifyAigcQuotaRequest, cb?: (error: string, rep: ModifyAigcQuotaResponse) => void): Promise<ModifyAigcQuotaResponse>;
    /**
...
如果删除配额后重新启用，用量将清零并重新计算。
     */
    DeleteAigcQuota(req: DeleteAigcQuotaRequest, cb?: (error: string, rep: DeleteAigcQuotaResponse) => void): Promise<DeleteAigcQuotaResponse>;
    /**
     * 修改大模型解析模板
     */
...
* 否则，请先执行[删除媒体](/document/product/266/31764)及子分类，再删除该分类；
     ...
     */
    DescribeAigcAdvancedCustomElements(req: DescribeAigcAdvancedCustomElementsRequest, cb?: (error: string, rep: DescribeAigcAdvancedCustomElementsResponse) => void): Promise<DescribeAigcAdvancedCustomElementsResponse>;
    /**
...
1、域名删除前需要先关闭所有区域的加速。
   ...
   2. 查询时间跨度不超过90天。
     ...
     */
    CreateAigcAudioClone(req: CreateAigcAudioCloneRequest, cb?: (error: string, rep: CreateAigcAudioCloneResponse) => void): Promise<CreateAigcAudioCloneResponse>;
    /**
     * 对点播中的音视频媒体发起音画质检测任务。
     */
...
注意：模板 ID 为 10000 以下的为系统预置模板，不允许删除。
     ...
     */
    DescribeKnowledgeBases(req: DescribeKnowledgeBasesRequest, cb?: (error: string, rep: DescribeKnowledgeBasesResponse) => void): Promise<DescribeKnowledgeBasesResponse>;
    /**
     * 查询 DRM 密钥提供商信息。
     */
...
<li>标准存储</li>
     ...
     */
    UpdateAigcApiToken(req: UpdateAigcApiTokenRequest, cb?: (error: string, rep: UpdateAigcApiTokenResponse) => void): Promise<UpdateAigcApiTokenResponse>;
    /**
     * 查询雪碧图模板，支持根据条件，分页查询。
     */
...
由于AGC内客生成为异步任务，无法获取实时用量数据，因此配额限制存在一定误差，无法实现与设置额度完全精准的控制。
     */
    CreateAigcQuota(req: CreateAigcQuotaRequest, cb?: (error: string, rep: CreateAigcQuotaResponse) => void): Promise<CreateAigcQuotaResponse>;
    /**
     * 删除用户自定义转动图模板。
     */
...
* 更多参考事件通知的[可靠回调](https://cloud.tencent.com/document/product/266/33779#.E5.8F.AF.E9.9D.A0.E5.9B.9E.E8.B0.83)。
     ...
     */
    DeleteAigcAdvancedCustomElement(req: DeleteAigcAdvancedCustomElementRequest, cb?: (error: string, rep: DeleteAigcAdvancedCustomElementResponse) => void): Promise<DeleteAigcAdvancedCustomElementResponse>;
    /**
...
* 注意：禁播媒体仅能操作标准存储和低频存储的媒体。低频存储媒体，必须存储至少 30 天，提前删除或变更存储类型，仍旧按照 30 天计费；如果禁播低频存储媒体，该媒体低频存储的时长不足 30 天，会产生提前删除计费；同时，禁播后该媒体的低频存储时长会从当前时间重新开始计算，如果不满 30 天继续对该媒体进行删除或变更存储类型，也将产生提前删除计费。例：媒体 001 已经低频存储了 10 天，此时对 001 进行禁播，低频存储的计费仍旧按 30 天计算（提前删除计费时长为 30 - 10 = 20 天）；禁播后 001 的低频存储时长重新开始计算，如果禁播后第 5 天删除了 001，低频存储计费也会按 30 天计算（提前删除计费时长为 30 - 5 = 25 天）；001 实际的低频存储时长为 10 + 5 = 15 天，低频存储计费时长为 10 + 20(提前删除计费)+ 5 + 25(提前删除计费) = 60 天。
     ...
     * 用于查询 AIGC 配额配置。
     */
    DescribeAigcQuotas(req: DescribeAigcQuotasRequest, cb?: (error: string, rep: DescribeAigcQuotasResponse) => void): Promise<DescribeAigcQuotasResponse>;
    /**
     * 用于将智能分析的结果导入到知识库中。
     */
...
修改音画质重生模板。
     ...
     */
    DescribeAigcFaceInfoAsync(req: DescribeAigcFaceInfoAsyncRequest, cb?: (error: string, rep: DescribeAigcFaceInfoAsyncResponse) => void): Promise<DescribeAigcFaceInfoAsyncResponse>;
    /**
