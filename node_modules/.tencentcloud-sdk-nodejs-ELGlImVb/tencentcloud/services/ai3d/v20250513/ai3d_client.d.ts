...
import { Convert3DFormatRequest, DescribeReduceFaceJobResponse, SubmitReduceFaceJobResponse, Convert3DFormatResponse, QueryHunyuanTo3DProJobRequest, QueryHunyuan3DPartJobResponse, QueryHunyuanTo3DRapidJobResponse, SubmitTextureTo3DJobRequest, DescribeReduceFaceJobRequest, DescribeHunyuanTo3DMotionJobRequest, SubmitHunyuanTo3DRapidJobResponse, SubmitAutoRiggingJobResponse, DescribeAutoRiggingJobResponse, SubmitHunyuanTo3DUVJobRequest, SubmitProfileTo3DJobRequest, SubmitHunyuanTo3DMotionJobRequest, DescribeTextureTo3DJobResponse, DescribeProfileTo3DJobRequest, SubmitProfileTo3DJobResponse, DescribeHunyuanTo3DMotionJobResponse, SubmitHunyuanTo3DRapidJobRequest, SubmitAutoRiggingJobRequest, SubmitHunyuanTo3DMotionJobResponse, SubmitHunyuanTo3DUVJobResponse, SubmitHunyuan3DPartJobResponse, SubmitHunyuanTo3DProJobRequest, DescribeProfileTo3DJobResponse, DescribeHunyuanTo3DUVJobResponse, SubmitReduceFaceJobRequest, DescribeTextureTo3DJobRequest, DescribeHunyuanTo3DUVJobRequest, SubmitHunyuan3DPartJobRequest, SubmitHunyuanTo3DProJobResponse, SubmitTextureTo3DJobResponse, QueryHunyuanTo3DProJobResponse, QueryHunyuan3DPartJobRequest, DescribeAutoRiggingJobRequest, QueryHunyuanTo3DRapidJobRequest } from "./ai3d_models";
/**
 * ai3d client
 * @class
 */
...
默认提供1个并发，代表最多能同时处理1个已提交的任务，上一个任务处理完毕后，才能开始处理下一个任务。
     */
    DescribeAutoRiggingJob(req: DescribeAutoRiggingJobRequest, cb?: (error: string, rep: DescribeAutoRiggingJobResponse) => void): Promise<DescribeAutoRiggingJobResponse>;
    /**
...
默认提供1个并发，代表最多能同时处理1个已提交的任务，上一个任务处理完毕后，才能开始处理下一个任务。
     */
    SubmitAutoRiggingJob(req: SubmitAutoRiggingJobRequest, cb?: (error: string, rep: SubmitAutoRiggingJobResponse) => void): Promise<SubmitAutoRiggingJobResponse>;
    /**
