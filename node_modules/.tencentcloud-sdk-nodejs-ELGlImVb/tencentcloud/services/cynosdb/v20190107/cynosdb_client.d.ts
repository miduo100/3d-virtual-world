...
import { OfflineLibraDBClusterRequest, DeleteClusterSaveBackupResponse, ModifyLibraDBClusterDataSourceResponse, UpgradeProxyVersionResponse, DescribeInstanceCLSLogDeliveryResponse, ModifyMaintainPeriodConfigRequest, DescribeZonesRequest, ModifyClusterReadOnlyResponse, ModifyClusterStorageRequest, DescribeResourcePackageDetailResponse, ModifyLibraDBClusterDataSourceRequest, UpgradeInstanceRequest, SearchClusterTablesRequest, DescribeMaintainPeriodRequest, ModifyBackupDownloadRestrictionResponse, UpgradeClusterVersionResponse, TransferClusterZoneResponse, DescribeClusterDatabaseTablesRequest, ModifyClusterBinlogRedoLogAutoCopyVaultRequest, DescribeClusterParamsResponse, RefundResourcePackageResponse, ModifyInstanceNameResponse, DescribeParamTemplatesRequest, DescribeBackupOverviewRequest, DescribeAuditInstanceListResponse, DescribeVaultBackupClusterInfoResponse, DescribeSlaveZonesResponse, DescribeProxiesResponse, DescribeClusterDetailDatabasesRequest, DescribeLibraDBClustersResponse, InquirePriceMultiSpecRequest, CreateClustersResponse, ModifyInstanceParamRequest, ModifyInstanceUpgradeLimitDaysResponse, CreateLibraDBClustersResponse, StopCLSDeliveryRequest, OpenWanRequest, ExportResourcePackageDeductDetailsResponse, DescribeClustersRequest, DescribeSQLExecutionPlanRequest, OpenReadOnlyInstanceExclusiveAccessResponse, SearchClusterDatabasesResponse, CreateParamTemplateRequest, DescribeBackupDownloadUserRestrictionRequest, SearchClusterTablesResponse, DescribeClusterDetailRequest, CopyBackupToVaultResponse, ModifyResourcePackageNameRequest, DescribeClusterPeriodScalePolicyResponse, OpenAIOptimizerRequest, ModifyBackupNameResponse, UpgradeProxyRequest, DescribeBinlogDownloadUrlResponse, DescribeLibraDBInstanceSpecsResponse, SwitchClusterVpcRequest, CloseProxyRequest, CloseSSLRequest, DescribeClusterPasswordComplexityResponse, DescribeAuditRuleWithInstanceIdsRequest, DescribeClusterDatabasesResponse, ModifyLibraDBClusterNameRequest, ResetLibraDBClusterAccountPasswordResponse, DescribeInstanceParamsRequest, ModifyBinlogSaveDaysRequest, AddInstancesResponse, DescribeSaveBackupClustersResponse, ModifyLibraDBClusterAccountHostResponse, DescribeIntegrateTaskRequest, DescribeBinlogListByVaultRequest, AssociateSecurityGroupsResponse, CreateProxyEndPointRequest, ModifyBackupDownloadUserRestrictionResponse, AddLibraDBInstancesResponse, DescribeParamTemplateDetailRequest, OpenReadOnlyInstanceExclusiveAccessRequest, StartCLSDeliveryResponse, UpgradeProxyResponse, DescribeClusterReadOnlyResponse, DescribeInstanceSpecsRequest, ModifyMaintainPeriodConfigResponse, ModifyClusterPeriodScalePolicyResponse, DescribeProxyNodesResponse, CreateIntegrateClusterRequest, DescribeZonesResponse, GrantAccountPrivilegesRequest, ModifyParamTemplateRequest, OpenAuditServiceResponse, DescribeChangedParamsAfterUpgradeResponse, ModifyServerlessStrategyResponse, DescribeProxyNodesRequest, DescribeAuditLogsRequest, InquirePriceCreateResponse, DescribeClusterReadOnlyRequest, DescribeIntegrateTaskResponse, CreateLibraDBClustersRequest, CreateClustersRequest, DescribeLibraDBInstanceSpecsRequest, DescribeClusterParamLogsRequest, CloseProxyResponse, DescribeResourcePackageSaleSpecRequest, UnbindClusterResourcePackagesResponse, DownloadLibraDBClusterListResponse, RollBackClusterResponse, OpenSSLRequest, DescribeVaultsRequest, CheckTransferClusterZoneResponse, DescribeClusterInstanceGrpsResponse, ModifyBackupConfigResponse, ModifyClusterDatabaseRequest, DescribeResourcePackageDetailRequest, InquirePriceMultiSpecResponse, DescribeRedoLogsRequest, DescribeLibraDBInstanceDetailRequest, DescribeLibraDBClusterAccountAllPrivilegesRequest, DisassociateSecurityGroupsRequest, ModifyBackupNameRequest, ModifyLibraDBClusterAccountPrivilegeResponse, DescribeClusterParamsRequest, ModifyAccountHostResponse, DescribeAccountAllGrantPrivilegesRequest, DeleteCLSDeliveryRequest, DescribeLibraDBClusterAccountPrivilegesRequest, CreateCLSDeliveryResponse, DescribeServerlessInstanceSpecsResponse, DescribeBinlogsRequest, DescribeSSLStatusResponse, CancelClusterServerlessScalePlanRequest, ModifyLibraDBClusterReplicationObjectResponse, UpgradeProxyVersionRequest, ModifyProxyRwSplitRequest, DescribeResourcePackageListResponse, DescribeLibraDBInstanceDetailResponse, DescribeInstanceSpecsByOperationTypeResponse, ModifyAuditRuleTemplatesRequest, DescribeProxiesRequest, ModifySnapBackupCrossRegionConfigRequest, AssociateSecurityGroupsRequest, CloseProxyEndPointRequest, DescribeBinlogsResponse, OpenAIOptimizerResponse, AddClusterSlaveZoneResponse, DescribeProxySpecsResponse, BindClusterResourcePackagesRequest, IsolateInstanceResponse, CopyClusterPasswordComplexityResponse, DescribeClusterTransparentEncryptInfoRequest, DescribeClusterLevelsRequest, DeleteVaultsResponse, DeleteParamTemplateRequest, DescribeLibraDBClusterAutoMapRuleRequest, RevokeAccountPrivilegesResponse, DescribeRedoLogsResponse, ModifyBackupDownloadRestrictionRequest, DescribeClusterDetailDatabasesResponse, CreateParamTemplateResponse, DescribeAccountAllGrantPrivilegesResponse, DescribeLibraDBClusterTableMappingRequest, DescribeSupportProxyVersionRequest, DescribeProxySpecsRequest, ResumeServerlessRequest, DeleteAuditLogFileResponse, ModifyClusterDatabaseResponse, IsolateLibraDBInstanceRequest, DescribeVaultsResponse, TransferClusterPrepayToPostpayResponse, DescribeDBSecurityGroupsRequest, UnbindClusterResourcePackagesRequest, ModifyBackupDownloadUserRestrictionRequest, DescribeInstanceParamsResponse, IsolateInstanceRequest, SwitchClusterVpcResponse, DescribeRedoLogListByVaultResponse, StopCLSDeliveryResponse, CreateAuditLogFileResponse, PauseServerlessResponse, DescribeInstanceDetailResponse, RestartLibraDBInstanceRequest, DeleteAccountsResponse, RenewLibraDBClustersRequest, DescribeClusterServerlessScalePlansResponse, CreateResourcePackageResponse, ModifyBinlogConfigRequest, ModifyLibraDBClusterNameResponse, DeleteLibraDBClusterAccountsRequest, SetRenewFlagResponse, CreateClusterDatabaseResponse, DescribeRedoLogListByVaultRequest, DescribeClustersResponse, DescribeBackupConfigResponse, DescribeParamTemplatesResponse, AddServerlessRoInstancesRequest, DescribeProjectSecurityGroupsRequest, DescribeBackupDownloadUrlRequest, CopyClusterPasswordComplexityRequest, DescribeClusterInstanceGroupsResponse, CreateLibraDBClusterAccountsResponse, CreateProxyEndPointResponse, DescribeSQLExecutionPlanResponse, DescribeBackupOverviewResponse, ReplayInstanceAuditLogRequest, TransferClusterPrepayToPostpayRequest, ModifyAccountPrivilegesResponse, InquirePriceCreateRequest, ModifyLibraDBClusterAccountDescriptionRequest, ModifyAuditServiceRequest, DescribeLibraDBClusterDetailResponse, GrantAccountPrivilegesResponse, ModifyClusterNameResponse, ExportInstanceSlowQueriesRequest, RestartLibraDBInstanceResponse, ResumeServerlessResponse, DeleteBackupVaultResponse, DescribeBackupDownloadUserRestrictionResponse, ModifySnapBackupCrossRegionConfigResponse, SwitchProxyVpcResponse, ModifyLibraDBForwardConfigResponse, OpenWanResponse, DescribeChangedParamsAfterUpgradeRequest, DeleteBackupVaultRequest, SwitchProxyVpcRequest, RestartInstanceResponse, DescribeBinlogSaveDaysRequest, DescribeClusterTransparentEncryptInfoResponse, ActivateInstanceResponse, IsolateClusterRequest, AddInstancesRequest, ModifyVaultResponse, DescribeBackupDownloadRestrictionRequest, DescribeInstanceErrorLogsRequest, DescribeInstanceDetailRequest, InquirePriceModifyResponse, DeleteAccountsRequest, OpenClusterTransparentEncryptRequest, ReloadBalanceProxyNodeRequest, DescribeAccountsResponse, CreateClusterDatabaseRequest, OfflineInstanceRequest, CreateProxyResponse, DescribeAuditLogFilesRequest, OpenClusterTransparentEncryptResponse, ModifyBackupConfigRequest, DisassociateSecurityGroupsResponse, DescribeClusterDatabasesRequest, OfflineLibraDBInstanceResponse, RenewLibraDBClustersResponse, RemoveClusterSlaveZoneRequest, ModifyResourcePackagesDeductionPriorityRequest, OfflineLibraDBInstanceRequest, DescribeRollbackTimeRangeRequest, InquirePriceRenewRequest, DescribeAccountPrivilegesResponse, DescribeLibraDBClusterAccountsRequest, CreateResourcePackageRequest, CloseProxyEndPointResponse, DescribeBackupConfigRequest, DescribeAccountsRequest, DescribeVaultBackupClusterInfoRequest, DescribeRollbackTimeRangeResponse, DescribeClusterServerlessScalePlansRequest, DescribeAuditLogFilesResponse, SwitchClusterZoneResponse, DescribeClusterPasswordComplexityRequest, CreateAccountsResponse, ModifyClusterGlobalEncryptionResponse, CheckTransferClusterZoneRequest, CloseWanResponse, ModifyProxyRwSplitResponse, DescribeInstancesResponse, ModifyResourcePackagesDeductionPriorityResponse, CloseWanRequest, ModifyResourcePackageClustersRequest, DescribeFlowResponse, CalculateBackupSaveSecExpiresRequest, ExportInstanceErrorLogsRequest, DescribeLibraDBDataSourceRequest, ActivateInstanceRequest, DescribeLibraDBClusterTableMappingResponse, DescribeInstanceCLSLogDeliveryRequest, ModifyVipVportRequest, ModifyDBInstanceSecurityGroupsResponse, DescribeClusterParamLogsResponse, DescribeClusterInstanceGrpsRequest, DescribeResourcesByDealNameResponse, CreateAccountsRequest, DeleteAuditRuleTemplatesRequest, ExportInstanceSlowQueriesResponse, SwitchClusterZoneRequest, DescribeLibraDBClusterAutoMapRuleResponse, InquirePriceModifyRequest, RemoveClusterSlaveZoneResponse, RenewClustersRequest, OpenClusterReadOnlyInstanceGroupAccessResponse, CreateVaultResponse, DescribeAuditRuleWithInstanceIdsResponse, SetLibraDBClusterRenewFlagResponse, SearchClusterDatabasesRequest, ModifyProxyDescResponse, CreateIntegrateClusterResponse, ModifyClusterSlaveZoneResponse, RollbackToNewClusterRequest, ModifyProxyDescRequest, ReloadBalanceProxyNodeResponse, CreateVaultRequest, CloseAuditServiceResponse, ModifyParamTemplateResponse, ActivateLibraDBClusterResponse, BindClusterResourcePackagesResponse, StartCLSDeliveryRequest, CreateProxyRequest, DescribeResourcePackageSaleSpecResponse, OpenClusterReadOnlyInstanceGroupAccessRequest, ModifyClusterPeriodScalePolicyRequest, DescribeResourcesByDealNameRequest, DescribeLibraDBClusterAccountPrivilegesResponse, DescribeAuditInstanceListRequest, DescribeInstanceSlowQueriesResponse, DescribeInstancesRequest, CopyBackupToVaultRequest, CloseClusterPasswordComplexityResponse, DescribeBackupDownloadUrlResponse, DescribeBinlogConfigRequest, IsolateLibraDBClusterRequest, CreateAuditRuleTemplateRequest, PauseServerlessRequest, DescribeBinlogListByVaultResponse, OfflineClusterResponse, DeleteLibraDBClusterAccountsResponse, ModifyClusterGlobalEncryptionRequest, ModifyAccountHostRequest, DescribeFlowRequest, DescribeLibraDBDataSourceResponse, DescribeClusterDatabaseTablesResponse, ModifyAccountPrivilegesRequest, CreateBackupRequest, CreateCLSDeliveryRequest, DescribeMaintainPeriodResponse, DescribeBackupListResponse, DescribeServerlessStrategyResponse, ModifyClusterParamRequest, ModifyClusterReadOnlyRequest, OfflineInstanceResponse, CreateAuditLogFileRequest, CalculateBackupSaveSecExpiresResponse, ModifyClusterSlaveZoneRequest, DescribeInstanceErrorLogsResponse, DescribeSupportProxyVersionResponse, DescribeLibraDBForwardConfigResponse, DeleteClusterDatabaseResponse, ActivateLibraDBInstanceResponse, RestartInstanceRequest, DescribeLibraDBClusterAccountsResponse, CreateClusterPeriodScalePolicyResponse, DescribeAccountPrivilegesRequest, DescribeInstanceSpecsByOperationTypeRequest, ModifyAccountParamsResponse, DescribeInstanceSpecsResponse, OpenSSLResponse, ModifyAuditServiceResponse, DescribeClusterDetailResponse, DescribeInstanceSlowQueriesRequest, ModifyResourcePackageClustersResponse, DescribeSaveBackupClustersRequest, DescribeLibraDBClusterAccountAllPrivilegesResponse, RollBackClusterRequest, ModifyClusterBinlogRedoLogAutoCopyVaultResponse, ModifyClusterNameRequest, DescribeLibraDBClusterDetailRequest, IsolateLibraDBInstanceResponse, DeleteClusterPeriodScalePolicyRequest, RefundResourcePackageRequest, DescribeBinlogDownloadUrlRequest, ModifyInstanceNameRequest, DescribeClusterPeriodScalePolicyRequest, ModifyLibraDBClusterAccountPrivilegeRequest, DescribeDBSecurityGroupsResponse, DeleteParamTemplateResponse, CreateClusterPeriodScalePolicyRequest, DownloadLibraDBClusterListRequest, DescribeTasksResponse, OpenClusterPasswordComplexityRequest, DescribeAuditLogsResponse, DescribeInstancesWithinSameClusterRequest, AddLibraDBInstancesRequest, ModifyBinlogConfigResponse, ModifyAccountDescriptionResponse, SetRenewFlagRequest, DescribeServerlessInstanceSpecsRequest, ActivateLibraDBClusterRequest, DescribeLibraDBSlowLogsRequest, AddClusterSlaveZoneRequest, CheckCreateLibraDBInstanceRequest, DeleteLibraDBClusterRequest, DescribeTasksRequest, ModifyClusterStorageResponse, ModifyInstanceUpgradeLimitDaysRequest, ModifyLibraDBClusterAccountHostRequest, CloseClusterPasswordComplexityRequest, DescribeClusterLevelsResponse, DescribeIsolatedInstancesRequest, ModifyAccountParamsRequest, ResetAccountPasswordRequest, CheckCreateLibraDBInstanceResponse, DescribeAuditRuleTemplatesResponse, DeleteClusterDatabaseRequest, DeleteBackupResponse, DescribeProjectSecurityGroupsResponse, DeleteLibraDBClusterResponse, OfflineClusterRequest, ResetAccountPasswordResponse, CreateLibraDBClusterAccountsRequest, DescribeClusterInstanceGroupsRequest, OpenAuditServiceRequest, ModifyResourcePackageNameResponse, DescribeBackupListRequest, ModifyAccountDescriptionRequest, TransferStoragePrepayToPostpayRequest, ModifyVaultRequest, ExportInstanceErrorLogsResponse, DescribeLibraDBClustersRequest, IsolateClusterResponse, RenewClustersResponse, ModifyLibraDBForwardConfigRequest, ModifyVipVportResponse, ModifyDBInstanceSecurityGroupsRequest, CloseAuditServiceRequest, ModifyLibraDBClusterReplicationObjectRequest, ModifyClusterPasswordComplexityResponse, UpgradeClusterVersionRequest, TransferStoragePrepayToPostpayResponse, ModifyClusterParamResponse, SetLibraDBClusterRenewFlagRequest, ModifyClusterPasswordComplexityRequest, DescribeLibraDBVersionRequest, ModifyInstanceParamResponse, DeleteVaultsRequest, ResetLibraDBClusterAccountPasswordRequest, CreateBackupResponse, DescribeLibraDBVersionResponse, DescribeInstancesWithinSameClusterResponse, CancelClusterServerlessScalePlanResponse, RollbackToNewClusterResponse, DeleteClusterSaveBackupRequest, DescribeSlaveZonesRequest, ModifyLibraDBClusterAccountDescriptionResponse, DescribeBackupDownloadRestrictionResponse, DescribeLibraDBForwardConfigRequest, UpgradeInstanceResponse, IsolateLibraDBClusterResponse, CreateAuditRuleTemplateResponse, DescribeResourcePackageListRequest, TransferClusterZoneRequest, CloseSSLResponse, OfflineLibraDBClusterResponse, RevokeAccountPrivilegesRequest, OpenClusterPasswordComplexityResponse, DescribeBackupListByVaultResponse, DescribeAuditRuleTemplatesRequest, AddServerlessRoInstancesResponse, ModifyServerlessStrategyRequest, DescribeBinlogConfigResponse, DescribeSSLStatusRequest, DeleteAuditLogFileRequest, DescribeIsolatedInstancesResponse, DescribeLibraDBSlowLogsResponse, ActivateLibraDBInstanceRequest, ExportResourcePackageDeductDetailsRequest, DescribeServerlessStrategyRequest, ReplayInstanceAuditLogResponse, DescribeBinlogSaveDaysResponse, ModifyLibraDBClusterProjectRequest, DeleteClusterPeriodScalePolicyResponse, DeleteBackupRequest, DescribeParamTemplateDetailResponse, ModifyBinlogSaveDaysResponse, ModifyLibraDBClusterProjectResponse, DeleteAuditRuleTemplatesResponse, DescribeBackupListByVaultRequest, DeleteCLSDeliveryResponse, InquirePriceRenewResponse, ModifyAuditRuleTemplatesResponse } from "./cynosdb_models";
/**
 * cynosdb client
 * @class
 */
export declare class Client extends AbstractClient {
     ...
     * 更新集群的周期弹性策略
     */
    ModifyClusterPeriodScalePolicy(req: ModifyClusterPeriodScalePolicyRequest, cb?: (error: string, rep: ModifyClusterPeriodScalePolicyResponse) => void): Promise<ModifyClusterPeriodScalePolicyResponse>;
    /**
     * 查询保险箱内binlog备份
     */
     ...
     */
    OpenAIOptimizer(req: OpenAIOptimizerRequest, cb?: (error: string, rep: OpenAIOptimizerResponse) => void): Promise<OpenAIOptimizerResponse>;
    /**
     ...
     * 查询可支持的集群类型列表
     */
    DescribeClusterLevels(req: DescribeClusterLevelsRequest, cb?: (error: string, rep: DescribeClusterLevelsResponse) => void): Promise<DescribeClusterLevelsResponse>;
    /**
     ...
     * 添加serverless集群只读实例
     */
    AddServerlessRoInstances(req: AddServerlessRoInstancesRequest, cb?: (error: string, rep: AddServerlessRoInstancesResponse) => void): Promise<AddServerlessRoInstancesResponse>;
    /**
     * 查询Serverless弹性扩容计划
     */
    DescribeClusterServerlessScalePlans(req: DescribeClusterServerlessScalePlansRequest, cb?: (error: string, rep: DescribeClusterServerlessScalePlansResponse) => void): Promise<DescribeClusterServerlessScalePlansResponse>;
    /**
     ...
     * 创建集群的周期弹性策略
     */
    CreateClusterPeriodScalePolicy(req: CreateClusterPeriodScalePolicyRequest, cb?: (error: string, rep: CreateClusterPeriodScalePolicyResponse) => void): Promise<CreateClusterPeriodScalePolicyResponse>;
    /**
     ...
     * 删除周期弹性策略
     */
    DeleteClusterPeriodScalePolicy(req: DeleteClusterPeriodScalePolicyRequest, cb?: (error: string, rep: DeleteClusterPeriodScalePolicyResponse) => void): Promise<DeleteClusterPeriodScalePolicyResponse>;
    /**
     ...
     * 查询集群内所有的周期弹性策略
     */
    DescribeClusterPeriodScalePolicy(req: DescribeClusterPeriodScalePolicyRequest, cb?: (error: string, rep: DescribeClusterPeriodScalePolicyResponse) => void): Promise<DescribeClusterPeriodScalePolicyResponse>;
    /**
     ...
     */
    AddLibraDBInstances(req: AddLibraDBInstancesRequest, cb?: (error: string, rep: AddLibraDBInstancesResponse) => void): Promise<AddLibraDBInstancesResponse>;
    /**
     ...
     * 取消Serverless集群的弹性计划
     */
    CancelClusterServerlessScalePlan(req: CancelClusterServerlessScalePlanRequest, cb?: (error: string, rep: CancelClusterServerlessScalePlanResponse) => void): Promise<CancelClusterServerlessScalePlanResponse>;
    /**
     * 创建备份保险箱
     */
     ...
     */
    DescribeSQLExecutionPlan(req: DescribeSQLExecutionPlanRequest, cb?: (error: string, rep: DescribeSQLExecutionPlanResponse) => void): Promise<DescribeSQLExecutionPlanResponse>;
    /**
