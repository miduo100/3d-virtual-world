...
import { UpgradeProxyVersionRequest, ModifyInstanceChargeTypeRequest, DescribeInstanceMonitorSIPResponse, RemoveReplicationGroupRequest, UpgradeSmallVersionRequest, DescribeLogsRequest, ModifyInstanceParamsResponse, EnableReplicaReadonlyRequest, ModifyInstanceAvailabilityZonesRequest, DescribeInstanceMonitorTopNCmdResponse, DeleteExportTaskResponse, ModifyInstanceAvailabilityZonesResponse, ModifyAutoBackupConfigResponse, RestoreInstanceRequest, AllocateWanAddressRequest, ApplyParamsTemplateRequest, DescribeReplicationGroupInstanceRequest, UpgradeInstanceVersionResponse, CreateInstancesRequest, CreateReplicationGroupRequest, RemoveReplicationInstanceResponse, DescribeInstanceSpecBandwidthResponse, DescribeInstanceZoneInfoRequest, ModifyConnectionConfigResponse, ModifyNetworkConfigResponse, DescribeInstanceMonitorBigKeyResponse, AssociateSecurityGroupsRequest, DescribeTaskListResponse, ModifyInstancePasswordResponse, DescribeSecondLevelBackupInfoResponse, RenewInstanceResponse, DescribeSlowLogResponse, DescribeCommonDBInstancesRequest, DescribeDBSecurityGroupsResponse, RestoreInstanceResponse, ModifyBackupDownloadRestrictionResponse, DeleteParamTemplateRequest, DeleteExportTaskRequest, DescribeInstancesResponse, DescribeInstanceZoneInfoResponse, ModifyLogRequest, ClearInstanceRequest, UpgradeInstanceVersionRequest, DescribeBandwidthRangeResponse, DescribeParamTemplatesRequest, RenewInstanceRequest, UpgradeVersionToMultiAvailabilityZonesResponse, DescribeBandwidthRangeRequest, DescribeInstanceParamRecordsResponse, ModifyAutoBackupConfigRequest, DescribeInstanceDealDetailRequest, KillMasterGroupResponse, OpenLogResponse, ModifyLogResponse, DescribeProjectSecurityGroupRequest, DescribeInstanceShardsResponse, DescribeRedisClusterOverviewResponse, DisableReplicaReadonlyRequest, ModifyInstanceLogDeliveryResponse, ModifyBackupDownloadRestrictionRequest, DisableReplicaReadonlyResponse, DestroyPrepaidInstanceRequest, CreateParamTemplateResponse, DescribeInstanceDTSInfoResponse, DescribeInstanceEventsRequest, DescribeGlobalReplicationAreaRequest, AddReplicationInstanceResponse, DestroyPostpaidInstanceResponse, SwitchInstanceVipRequest, ChangeReplicaToMasterRequest, ModifyInstanceResponse, ModifyDBInstanceSecurityGroupsResponse, ChangeMasterInstanceRequest, DescribeInstanceDTSInfoRequest, DescribeLogInstanceListResponse, CreateParamTemplateRequest, DescribeTendisSlowLogResponse, DescribeProductInfoResponse, ModifyInstanceAccountRequest, ModifyMaintenanceWindowRequest, DescribeParamTemplateInfoRequest, DescribeBackupUrlResponse, InquiryPriceRenewInstanceResponse, DescribeDBSecurityGroupsRequest, CloseLogRequest, DescribeProductInfoRequest, InquiryPriceCreateInstanceResponse, DescribeInstanceParamsResponse, DescribeReplicationGroupInstanceResponse, StartupInstanceRequest, UpgradeProxyVersionResponse, ResetPasswordRequest, ModifyInstanceAccountResponse, DescribeProjectSecurityGroupsResponse, ModifyInstanceReadOnlyResponse, DescribeBackupDetailRequest, DescribeInstanceMonitorTookDistResponse, DescribeInstanceBackupsResponse, StartupInstanceResponse, UpgradeVersionToMultiAvailabilityZonesRequest, ModfiyInstancePasswordResponse, AllocateWanAddressResponse, DescribeInstanceMonitorTookDistRequest, DeleteReplicationInstanceRequest, SwitchAccessNewInstanceRequest, RemoveReplicationGroupResponse, KillMasterGroupRequest, SwitchAccessNewInstanceResponse, CloneInstancesResponse, DescribeBackupDownloadRestrictionResponse, DescribeInstanceMonitorTopNCmdTookResponse, CloseSSLRequest, DescribeInstanceMonitorBigKeySizeDistRequest, DescribeInstanceAccountRequest, DescribeInstanceLogDeliveryResponse, DescribeInstanceParamRecordsRequest, DescribeTaskListRequest, ChangeMasterInstanceResponse, ModifyInstanceEventRequest, DescribeBackupDetailResponse, ChangeReplicaToMasterResponse, CreateInstancesResponse, DescribeTaskInfoRequest, CloneInstancesRequest, ApplyParamsTemplateResponse, CreateExportTaskResponse, DescribeReplicationGroupRequest, DescribeInstanceSupportFeatureRequest, DescribeInstanceMonitorTopNCmdRequest, CreateExportTaskRequest, DescribeInstanceSecurityGroupRequest, DescribeInstanceParamsRequest, CleanUpInstanceResponse, ModifyDBInstanceSecurityGroupsRequest, DescribeParamTemplatesResponse, DescribeInstanceShardsRequest, DescribeAutoBackupConfigResponse, InquiryPriceUpgradeInstanceRequest, ModifyParamTemplateResponse, DescribeProjectSecurityGroupsRequest, DescribeInstanceMonitorBigKeySizeDistResponse, DescribeInstanceEventsResponse, CreateInstanceAccountRequest, RemoveReplicationInstanceRequest, EnableReplicaReadonlyResponse, ModifyInstanceRequest, DescribeMaintenanceWindowResponse, DescribeInstanceSecurityGroupResponse, DescribeExportTasksResponse, ModifyConnectionConfigRequest, ManualBackupInstanceResponse, ModifyInstanceBackupModeResponse, SwitchProxyResponse, ResetPasswordResponse, AssociateSecurityGroupsResponse, DescribeTaskInfoResponse, DescribeInstanceMonitorBigKeyTypeDistResponse, DeleteReplicationInstanceResponse, CleanUpInstanceRequest, DescribeInstanceDealDetailResponse, ModifyReplicationGroupRequest, DescribeInstancesRequest, ModfiyInstancePasswordRequest, DescribeSlowLogRequest, ModifyInstancePasswordRequest, ModifyReplicationGroupResponse, ReleaseWanAddressResponse, DescribeAutoBackupConfigRequest, DescribeBackupUrlRequest, DestroyPostpaidInstanceRequest, ChangeInstanceRoleRequest, CloseLogResponse, DeleteInstanceAccountRequest, DescribeInstanceMonitorHotKeyRequest, DeleteParamTemplateResponse, UpgradeInstanceResponse, ManualBackupInstanceRequest, DescribeReplicationGroupResponse, ModifyParamTemplateRequest, ReleaseWanAddressRequest, InquiryPriceRenewInstanceRequest, CloseSSLResponse, ModifyMaintenanceWindowResponse, CreateReplicationGroupResponse, DescribeInstanceMonitorBigKeyTypeDistRequest, DescribeInstanceMonitorTopNCmdTookRequest, DestroyPrepaidInstanceResponse, DescribeRedisClusterOverviewRequest, OpenLogRequest, UpgradeInstanceRequest, DescribeCommonDBInstancesResponse, InquiryPriceCreateInstanceRequest, DescribeRedisClustersRequest, UpgradeSmallVersionResponse, ModifyInstanceParamsRequest, DescribeSSLStatusRequest, OpenSSLRequest, DescribeInstanceNodeInfoRequest, DescribeLogsResponse, DescribeInstanceSupportFeatureResponse, DescribeInstanceLogDeliveryRequest, AddReplicationInstanceRequest, DescribeSSLStatusResponse, DescribeExportTasksRequest, DescribeProxySlowLogRequest, DescribeRedisClustersResponse, DescribeLogInstanceListRequest, ModifyInstanceBackupModeRequest, DescribeProxySlowLogResponse, ModifyInstanceReadOnlyRequest, DescribeInstanceAccountResponse, DescribeInstanceMonitorBigKeyRequest, DescribeBackupDownloadRestrictionRequest, DescribeParamTemplateInfoResponse, SwitchProxyRequest, DescribeInstanceSpecBandwidthRequest, SwitchInstanceVipResponse, DisassociateSecurityGroupsRequest, ModifyNetworkConfigRequest, ModifyInstanceChargeTypeResponse, CreateInstanceAccountResponse, DescribeMaintenanceWindowRequest, DescribeInstanceBackupsRequest, DescribeSecondLevelBackupInfoRequest, InquiryPriceUpgradeInstanceResponse, DeleteInstanceAccountResponse, DescribeInstanceMonitorSIPRequest, OpenSSLResponse, ModifyInstanceLogDeliveryRequest, ChangeInstanceRoleResponse, DescribeGlobalReplicationAreaResponse, ModifyInstanceEventResponse, DescribeInstanceNodeInfoResponse, DescribeProjectSecurityGroupResponse, DescribeInstanceMonitorHotKeyResponse, DisassociateSecurityGroupsResponse, ClearInstanceResponse, DescribeTendisSlowLogRequest } from "./redis_models";
/**
 * redis client
 * @class
 */
...
- 可查询近30天内任务列表数据。
     ...
     * 删除日志下载任务
     */
    DeleteExportTask(req: DeleteExportTaskRequest, cb?: (error: string, rep: DeleteExportTaskResponse) => void): Promise<DeleteExportTaskResponse>;
    /**
     ...
     * 本接口用于变更实例的计费类型
     */
    ModifyInstanceChargeType(req: ModifyInstanceChargeTypeRequest, cb?: (error: string, rep: ModifyInstanceChargeTypeResponse) => void): Promise<ModifyInstanceChargeTypeResponse>;
    /**
     ...
     */
    DescribeExportTasks(req: DescribeExportTasksRequest, cb?: (error: string, rep: DescribeExportTasksResponse) => void): Promise<DescribeExportTasksResponse>;
    /**
     * 查询日志
     */
     ...
     * 关闭日志
     */
    CloseLog(req: CloseLogRequest, cb?: (error: string, rep: CloseLogResponse) => void): Promise<CloseLogResponse>;
    /**
     ...
     * 日志实例列表查询
     */
    DescribeLogInstanceList(req: DescribeLogInstanceListRequest, cb?: (error: string, rep: DescribeLogInstanceListResponse) => void): Promise<DescribeLogInstanceListResponse>;
    /**
     ...
     * 开启日志
     */
    OpenLog(req: OpenLogRequest, cb?: (error: string, rep: OpenLogResponse) => void): Promise<OpenLogResponse>;
    /**
