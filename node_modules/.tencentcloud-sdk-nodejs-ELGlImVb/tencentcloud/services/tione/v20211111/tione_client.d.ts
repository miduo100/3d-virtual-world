...
https://cloud.tencent.com/document/product/1278/85305
     ...
     * 获取单个训练任务实例的登录链接
     */
    DescribeTrainingTaskPodUrl(req: DescribeTrainingTaskPodUrlRequest, cb?: (error: string, rep: DescribeTrainingTaskPodUrlResponse) => void): Promise<DescribeTrainingTaskPodUrlResponse>;
    /**
     * 用于创建、发布一个新的模型服务
     */
     ...
     * 该接口用于查询内置镜像列表
     */
    DescribePresetImageList(req: DescribePresetImageListRequest, cb?: (error: string, rep: DescribePresetImageListResponse) => void): Promise<DescribePresetImageListResponse>;
    /**
