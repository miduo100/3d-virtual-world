...
import { DescribeInstanceSSLAttributesResponse, DescribeUserTasksResponse, InitDCDBInstancesResponse, DescribeDBTmpInstancesRequest, DescribeAccountPrivilegesResponse, DescribeDatabasesRequest, DestroyDCDBInstanceResponse, DescribeDBParametersRequest, DescribeAccountsRequest, UpgradeHourDCDBInstanceResponse, ModifyRealServerAccessStrategyResponse, ModifyBackupConfigsRequest, ActiveHourDCDBInstanceResponse, DescribeDCDBPriceResponse, ModifyInstanceVportResponse, DescribeDCDBInstanceDetailRequest, DescribeFileDownloadUrlResponse, ModifyInstanceSSLAttributesRequest, ModifyInstanceVipResponse, AssociateSecurityGroupsRequest, CancelOnlineDDLJobRequest, FlushBinlogResponse, DescribeDBSecurityGroupsResponse, CancelDcnJobResponse, DescribeFileDownloadUrlRequest, UpgradeDCDBInstanceResponse, DescribeInstanceSSLAttributesRequest, DescribeDBSyncModeResponse, DescribeProjectSecurityGroupsRequest, DescribeDCDBUpgradePriceResponse, DescribeDBSlowLogsRequest, CreateAccountRequest, UpgradeDedicatedDCDBInstanceResponse, CreateOnlineDDLJobResponse, DescribeDBParametersResponse, DescribeDatabaseTableRequest, IsolateHourDCDBInstanceRequest, ModifyDBInstanceNameResponse, DescribeFlowResponse, CloneAccountResponse, IsolateDCDBInstanceRequest, IsolateDedicatedDBInstanceRequest, ModifyAccountDescriptionResponse, DestroyDCDBInstanceRequest, OpenDBExtranetAccessResponse, DescribeProcessListRequest, CreateDCDBInstanceResponse, ModifyDBInstancesProjectResponse, ModifyDBEncryptAttributesResponse, DescribeDCDBInstanceNodeInfoRequest, SwitchDBInstanceHAResponse, DescribeDBLogFilesRequest, DescribeOrdersResponse, CreateDedicatedClusterDCDBInstanceRequest, ResetAccountPasswordRequest, CopyAccountPrivilegesResponse, CloneAccountRequest, DescribeDCDBInstanceDetailResponse, ModifyInstanceNetworkResponse, DescribeDBSecurityGroupsRequest, DescribeDCDBPriceRequest, DescribeOnlineDDLJobRequest, DescribeBackupFilesResponse, DescribeProjectSecurityGroupsResponse, ResetAccountPasswordResponse, DescribeDCDBSaleInfoRequest, ModifyRealServerAccessStrategyRequest, ModifyAccountConfigRequest, TerminateDedicatedDBInstanceResponse, RenewDCDBInstanceRequest, DescribeDBEncryptAttributesResponse, ModifyInstanceProtectedPropertyRequest, CreateTmpDCDBInstanceRequest, DescribeDBEncryptAttributesRequest, GrantAccountPrivilegesRequest, DescribeShardSpecRequest, DescribeDCDBShardsRequest, SwitchDBInstanceHARequest, ModifyDBParametersRequest, DescribeBackupConfigsRequest, ModifyDBInstanceSecurityGroupsRequest, DescribeDcnDetailRequest, ModifyDBParametersResponse, CopyAccountPrivilegesRequest, DescribeBackupFilesRequest, DescribeDCDBInstanceNodeInfoResponse, KillSessionRequest, TerminateDedicatedDBInstanceRequest, DescribeDatabaseObjectsResponse, ModifyDBInstanceNameRequest, DescribeDcnDetailResponse, DescribeBackupConfigsResponse, ModifyDBEncryptAttributesRequest, RenewDCDBInstanceResponse, DescribeDCDBRenewalPriceResponse, UpgradeDedicatedDCDBInstanceRequest, AssociateSecurityGroupsResponse, DescribeDCDBBinlogTimeRequest, DescribeShardSpecResponse, DescribeDCDBShardsResponse, CreateHourDCDBInstanceResponse, GrantAccountPrivilegesResponse, ModifyAccountPrivilegesRequest, CancelDcnJobRequest, IsolateHourDCDBInstanceResponse, ModifyInstanceVipRequest, OpenDBExtranetAccessRequest, ModifyBackupConfigsResponse, DescribeDCDBSaleInfoResponse, ModifyDBInstancesProjectRequest, CreateHourDCDBInstanceRequest, ModifyInstanceProtectedPropertyResponse, DescribeDBSyncModeRequest, CloseDBExtranetAccessResponse, ModifyAccountDescriptionRequest, KillSessionResponse, DescribeProjectsRequest, ModifyInstanceSSLAttributesResponse, CreateOnlineDDLJobRequest, DescribeDatabasesResponse, DescribeOrdersRequest, DescribeDBLogFilesResponse, CloseDBExtranetAccessRequest, InitDCDBInstancesRequest, DeleteAccountRequest, DescribeDCDBInstancesResponse, ModifyAccountPrivilegesResponse, DescribeFlowRequest, DescribeProcessListResponse, CreateDCDBInstanceRequest, DescribeDCDBUpgradePriceRequest, CreateDedicatedClusterDCDBInstanceResponse, UpgradeHourDCDBInstanceRequest, DescribeDBTmpInstancesResponse, DescribeDCDBBinlogTimeResponse, ModifyDBSyncModeRequest, ModifyAccountConfigResponse, IsolateDCDBInstanceResponse, DescribeProjectsResponse, CreateTmpDCDBInstanceResponse, CreateAccountResponse, IsolateDedicatedDBInstanceResponse, DescribeLogFileRetentionPeriodResponse, DescribeDatabaseObjectsRequest, UpgradeDCDBInstanceRequest, ModifyInstanceNetworkRequest, DestroyHourDCDBInstanceResponse, DescribeDCDBRenewalPriceRequest, ActiveHourDCDBInstanceRequest, DisassociateSecurityGroupsRequest, DescribeDatabaseTableResponse, DescribeAccountPrivilegesRequest, DescribeAccountsResponse, DescribeDBSlowLogsResponse, DescribeDCDBInstancesRequest, DescribeLogFileRetentionPeriodRequest, DescribeOnlineDDLJobResponse, ModifyInstanceVportRequest, ModifyDBInstanceSecurityGroupsResponse, DestroyHourDCDBInstanceRequest, FlushBinlogRequest, CancelOnlineDDLJobResponse, ModifyDBSyncModeResponse, DisassociateSecurityGroupsResponse, DescribeUserTasksRequest, DeleteAccountResponse } from "./dcdb_models";
/**
 * dcdb client
 * @class
 */
...
注意：相同用户名，不同Host是不同的账号。
     ...
     */
    DescribeInstanceSSLAttributes(req: DescribeInstanceSSLAttributesRequest, cb?: (error: string, rep: DescribeInstanceSSLAttributesResponse) => void): Promise<DescribeInstanceSSLAttributesResponse>;
    /**
     ...
     * 该接口用于修改实例的保护属性
     */
    ModifyInstanceProtectedProperty(req: ModifyInstanceProtectedPropertyRequest, cb?: (error: string, rep: ModifyInstanceProtectedPropertyResponse) => void): Promise<ModifyInstanceProtectedPropertyResponse>;
    /**
     * 隔离TDSQL按量计费实例
     */
...
- 不传权限参数表示保留现有权限，如需清除，请在复杂类型Privileges字段传空数组
     ...
     */
    ModifyInstanceSSLAttributes(req: ModifyInstanceSSLAttributesRequest, cb?: (error: string, rep: ModifyInstanceSSLAttributesResponse) => void): Promise<ModifyInstanceSSLAttributesResponse>;
    /**
...
- 如果参数为空，返回当前用户一定数量（Limit所指定的数量，默认为20）的线程信息。
     */
    DescribeProcessList(req: DescribeProcessListRequest, cb?: (error: string, rep: DescribeProcessListResponse) => void): Promise<DescribeProcessListResponse>;
    /**
