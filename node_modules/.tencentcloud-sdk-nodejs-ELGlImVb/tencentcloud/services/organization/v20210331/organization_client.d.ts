...
export declare class Client extends AbstractClient {
     ...
     * 更新新建ip白名单
     */
    UpdateIPWhitelist(req: UpdateIPWhitelistRequest, cb?: (error: string, rep: UpdateIPWhitelistResponse) => void): Promise<UpdateIPWhitelistResponse>;
    /**
     * 查询CAM用户同步
     */
     ...
     * 查询组织成员访问策略列表
     */
    DescribeOrganizationMembersAuthPolicy(req: DescribeOrganizationMembersAuthPolicyRequest, cb?: (error: string, rep: DescribeOrganizationMembersAuthPolicyResponse) => void): Promise<DescribeOrganizationMembersAuthPolicyResponse>;
    /**
     * 查询用户同步异步任务的状态
     */
     ...
     * 获取CIC的ip白名单
     */
    GetIPWhitelist(req: GetIPWhitelistRequest, cb?: (error: string, rep: GetIPWhitelistResponse) => void): Promise<GetIPWhitelistResponse>;
    /**
     * 更新共享单元。
     */
