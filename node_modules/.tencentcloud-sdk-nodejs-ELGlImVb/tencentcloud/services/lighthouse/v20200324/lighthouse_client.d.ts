...
import { RunDockerContainersRequest, DescribeDockerContainersRequest, AssociateInstancesKeyPairsResponse, DescribeInstancesTrafficPackagesRequest, DescribeDisksDeniedActionsRequest, StopMcpServersResponse, DescribeMcpServersResponse, DescribeDiskBackupsRequest, DescribeInstancesDeniedActionsRequest, DeleteKeyPairsResponse, DescribeFirewallTemplateRulesRequest, AttachCcnRequest, CreateInstancesRequest, DescribeZonesRequest, RebootInstancesResponse, StopMcpServersRequest, DescribeBlueprintInstancesResponse, InquirePriceCreateDisksRequest, DetachCcnResponse, ShareBlueprintAcrossAccountsRequest, SyncBlueprintRequest, DescribeScenesResponse, InquirePriceRenewInstancesResponse, RenewDisksResponse, DeleteFirewallRulesResponse, ModifyInstancesAttributeRequest, DescribeDockerContainerDetailRequest, DescribeGeneralResourceQuotasRequest, RestartDockerContainersRequest, DeleteKeyPairsRequest, RerunDockerContainerResponse, DescribeBundlesResponse, ResetFirewallTemplateRulesRequest, ModifyImageSharePermissionResponse, DeleteFirewallTemplateRulesResponse, DescribeFirewallTemplatesRequest, ModifyDiskBackupsAttributeResponse, ModifyInstancesBundleRequest, DeleteDiskBackupsRequest, InquirePriceRenewInstancesRequest, DescribeDiskConfigsRequest, DescribeFirewallTemplateQuotaResponse, DescribeRegionsResponse, DescribeFirewallTemplateApplyRecordsRequest, DescribeMcpServerTemplatesResponse, DescribeDiskBackupsResponse, AttachDisksRequest, ModifyDiskBackupsAttributeRequest, AttachCcnResponse, RebootInstancesRequest, ResetAttachCcnRequest, CreateDisksRequest, AssociateInstancesKeyPairsRequest, RestartMcpServersResponse, CancelShareBlueprintAcrossAccountsResponse, DescribeSnapshotsRequest, TerminateDisksResponse, DescribeInstancesTrafficPackagesResponse, DescribeDiskBackupsDeniedActionsRequest, DescribeFirewallRulesTemplateRequest, DescribeDockerContainerConfigurationRequest, ModifyBlueprintAttributeRequest, InquirePriceRenewDisksRequest, ShareBlueprintAcrossAccountsResponse, ModifyFirewallRulesResponse, DescribeBlueprintInstancesRequest, ApplyInstanceSnapshotResponse, DetachDisksRequest, ModifyFirewallRulesRequest, CreateBlueprintRequest, CreateMcpServerResponse, RerunDockerContainerRequest, DescribeInstanceVncUrlRequest, ModifyFirewallRuleDescriptionRequest, ModifyImageSharePermissionRequest, TerminateInstancesResponse, DescribeInstancesDiskNumRequest, StopDockerContainersResponse, ApplyDiskBackupResponse, DeleteFirewallRulesRequest, DescribeBlueprintsRequest, ResetInstancesPasswordRequest, DescribeInstancesDeniedActionsResponse, RestartDockerContainersResponse, CreateFirewallTemplateRequest, ModifyMcpServerResponse, RenewDisksRequest, ModifyDisksAttributeRequest, DescribeKeyPairsResponse, DescribeSnapshotsDeniedActionsResponse, DescribeScenesRequest, DeleteDiskBackupsResponse, DeleteSnapshotsRequest, ModifyDisksRenewFlagResponse, ModifySnapshotAttributeRequest, DeleteSnapshotsResponse, ReplaceFirewallTemplateRuleResponse, DescribeDisksResponse, DescribeMcpServersRequest, DescribeBundleDiscountResponse, DescribeAllScenesRequest, ModifyDisksRenewFlagRequest, StartDockerContainersResponse, DisassociateInstancesKeyPairsRequest, DescribeFirewallTemplateQuotaRequest, RemoveMcpServersResponse, ImportKeyPairRequest, DescribeDockerActivitiesRequest, ImportKeyPairResponse, DeleteBlueprintsResponse, IsolateInstancesRequest, DeleteFirewallTemplateResponse, CreateInstancesResponse, ModifyBlueprintAttributeResponse, DescribeBlueprintBundlesRequest, DescribeBlueprintBundlesResponse, StopDockerContainersRequest, DescribeModifyInstanceBundlesRequest, DescribeRegionsRequest, CreateMcpServerRequest, DescribeInstancesDiskNumResponse, InquirePriceCreateBlueprintResponse, InquirePriceCreateBlueprintRequest, ModifyFirewallTemplateResponse, ResetInstancesPasswordResponse, DescribeInstancesReturnableRequest, DescribeBlueprintsResponse, DescribeKeyPairsRequest, DescribeCcnAttachedInstancesRequest, SyncBlueprintResponse, ApplyDiskBackupRequest, DescribeBlueprintsShareAcrossAccountInfosResponse, StartInstancesResponse, DescribeDockerContainerConfigurationResponse, StartInstancesRequest, IsolateInstancesResponse, CreateKeyPairResponse, DescribeBlueprintsShareAcrossAccountInfosRequest, DescribeInstanceVncUrlResponse, DescribeDockerActivitiesResponse, DescribeFirewallTemplateRuleQuotaRequest, CreateFirewallTemplateResponse, DescribeCcnAttachedInstancesResponse, DescribeBundlesRequest, InquirePriceCreateInstancesResponse, RemoveMcpServersRequest, DescribeAllScenesResponse, InquirePriceRenewDisksResponse, CreateDiskBackupResponse, DescribeSnapshotsDeniedActionsRequest, DescribeDiskDiscountResponse, CreateFirewallTemplateRulesResponse, ResizeDisksRequest, RunDockerContainersResponse, ModifyDisksBackupQuotaRequest, CreateKeyPairRequest, DescribeMcpServerTemplatesRequest, ModifyDockerContainerRequest, DescribeInstancesRequest, DescribeFirewallTemplateRuleQuotaResponse, DetachCcnRequest, DescribeImagesToShareResponse, DescribeFirewallTemplateApplyRecordsResponse, DescribeSnapshotsResponse, ApplyFirewallTemplateRequest, ModifyFirewallRuleDescriptionResponse, DescribeDiskDiscountRequest, CreateDisksResponse, AttachDisksResponse, CreateDiskBackupRequest, CreateFirewallRulesRequest, DescribeFirewallRulesResponse, DescribeInstancesReturnableResponse, DescribeImagesToShareRequest, DeleteBlueprintsRequest, RenameDockerContainerResponse, CreateFirewallRulesResponse, DescribeDisksRequest, DescribeInstancesResponse, DescribeZonesResponse, CreateBlueprintResponse, DescribeFirewallTemplatesResponse, DetachDisksResponse, DescribeResetInstanceBlueprintsRequest, RemoveDockerContainersResponse, ResetAttachCcnResponse, ModifyInstancesRenewFlagResponse, ApplyInstanceSnapshotRequest, DisassociateInstancesKeyPairsResponse, TerminateInstancesRequest, ModifyFirewallTemplateRequest, RestartMcpServersRequest, ApplyFirewallTemplateResponse, TerminateDisksRequest, ModifyMcpServerRequest, ResetInstanceRequest, ResizeDisksResponse, DescribeDiskConfigsResponse, CreateFirewallTemplateRulesRequest, ReplaceFirewallTemplateRuleRequest, DescribeDockerContainersResponse, ModifyDockerContainerResponse, DescribeDiskBackupsDeniedActionsResponse, DescribeDockerContainerDetailResponse, DescribeBundleDiscountRequest, DescribeFirewallTemplateRulesResponse, DescribeDisksReturnableResponse, DeleteFirewallTemplateRequest, StopInstancesResponse, IsolateDisksRequest, CreateInstanceSnapshotResponse, StopInstancesRequest, StartMcpServersRequest, ModifyInstancesBundleResponse, DescribeResetInstanceBlueprintsResponse, DescribeDisksReturnableRequest, ResetFirewallTemplateRulesResponse, ModifySnapshotAttributeResponse, ModifyDisksBackupQuotaResponse, DescribeGeneralResourceQuotasResponse, ModifyInstancesRenewFlagRequest, StartDockerContainersRequest, StartMcpServersResponse, RenewInstancesRequest, DescribeFirewallRulesTemplateResponse, RenewInstancesResponse, RenameDockerContainerRequest, DescribeDisksDeniedActionsResponse, ResetInstanceResponse, IsolateDisksResponse, DescribeFirewallRulesRequest, RemoveDockerContainersRequest, InquirePriceCreateInstancesRequest, DescribeModifyInstanceBundlesResponse, ModifyDisksAttributeResponse, CreateInstanceSnapshotRequest, CancelShareBlueprintAcrossAccountsRequest, InquirePriceCreateDisksResponse, ModifyInstancesAttributeResponse, DeleteFirewallTemplateRulesRequest } from "./lighthouse_models";
/**
 * lighthouse client
 * @class
 */
...
<li> DETACHING （卸载中）</li>
     ...
     */
    DescribeImagesToShare(req: DescribeImagesToShareRequest, cb?: (error: string, rep: DescribeImagesToShareResponse) => void): Promise<DescribeImagesToShareResponse>;
    /**
     ...
     */
    DescribeBlueprintsShareAcrossAccountInfos(req: DescribeBlueprintsShareAcrossAccountInfosRequest, cb?: (error: string, rep: DescribeBlueprintsShareAcrossAccountInfosResponse) => void): Promise<DescribeBlueprintsShareAcrossAccountInfosResponse>;
    /**
...
<li> UNATTACHED（待挂载）</li>
     ...
     */
    DescribeBlueprintBundles(req: DescribeBlueprintBundlesRequest, cb?: (error: string, rep: DescribeBlueprintBundlesResponse) => void): Promise<DescribeBlueprintBundlesResponse>;
    /**
...
- 本接口在操作多个MCP Server时，不会因为某一个失败而停止。您需要通过调用 DescribeMcpServers 接口查询最终操作结果，如无法查询到，代表删除成功。
     */
    RemoveMcpServers(req: RemoveMcpServersRequest, cb?: (error: string, rep: RemoveMcpServersResponse) => void): Promise<RemoveMcpServersResponse>;
    /**
...
- 本接口在操作多个MCP Server时，不会因为某一个失败而停止。您需要通过调用 DescribeMcpServers 接口查询最终操作结果。
     */
    StartMcpServers(req: StartMcpServersRequest, cb?: (error: string, rep: StartMcpServersResponse) => void): Promise<StartMcpServersResponse>;
    /**
...
* 可以通过[DescribeBlueprints](https://cloud.tencent.com/document/api/1207/47689)查询镜像状态，当镜像状态为NORMAL时表示源地域同步结束。
     */
    SyncBlueprint(req: SyncBlueprintRequest, cb?: (error: string, rep: SyncBlueprintResponse) => void): Promise<SyncBlueprintResponse>;
    /**
...
6.NORMAL状态的镜像才支持共享。
     ...
     */
    DescribeMcpServerTemplates(req: DescribeMcpServerTemplatesRequest, cb?: (error: string, rep: DescribeMcpServerTemplatesResponse) => void): Promise<DescribeMcpServerTemplatesResponse>;
    /**
...
- 本接口在操作多个MCP Server时，不会因为某一个失败而停止。您需要通过调用 DescribeMcpServers 接口查询最终操作结果。
     */
    StopMcpServers(req: StopMcpServersRequest, cb?: (error: string, rep: StopMcpServersResponse) => void): Promise<StopMcpServersResponse>;
    /**
...
- 本接口在操作多个MCP Server时，不会因为某一个失败而停止。您需要通过调用 DescribeMcpServers 接口查询最终操作结果。
     */
    RestartMcpServers(req: RestartMcpServersRequest, cb?: (error: string, rep: RestartMcpServersResponse) => void): Promise<RestartMcpServersResponse>;
    /**
