...
注意：模板需要审核通过才可以使用。
     ...
     * 获取垃圾投诉数据
     */
    GetAbuseReport(req: GetAbuseReportRequest, cb?: (error: string, rep: GetAbuseReportResponse) => void): Promise<GetAbuseReportResponse>;
    /**
     * 获取自定义黑名单列表
     */
