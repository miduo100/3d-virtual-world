...
export class Client extends AbstractClient {
    ...
    async RevokeShareDeviceFromUser(req, cb) {
    ...
    async UnbindTWeTalkAgent(req, cb) {
    ...
    async CreateTWeSeeDirectUploadCredential(req, cb) {
    ...
    async CreateDevicePublishSDPAnswer(req, cb) {
        return this.request("CreateDevicePublishSDPAnswer", req, cb);
    }
    async CallDeviceRRPCSync(req, cb) {
    ...
    async CreateTWeTalkAgent(req, cb) {
    ...
    async DescribeTWeTalkAgentList(req, cb) {
        return this.request("DescribeTWeTalkAgentList", req, cb);
    }
    async RevokeBindUserDevice(req, cb) {
    ...
    async ModifyTWeTalkAgent(req, cb) {
    ...
    async DescribeLicenseOverview(req, cb) {
    ...
    async ShareDeviceToUser(req, cb) {
    ...
    async DeleteTWeTalkAgent(req, cb) {
    ...
    async DescribeTWeTalkAgent(req, cb) {
