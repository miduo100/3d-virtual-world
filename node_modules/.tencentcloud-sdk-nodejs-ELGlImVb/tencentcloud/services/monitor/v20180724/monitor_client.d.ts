...
| /alertmanager/api/v2/silence/{id} | GET | 告警静默详情查询 |
     ...
     * 修改值班表
     */
    UpdateOnCallForm(req: UpdateOnCallFormRequest, cb?: (error: string, rep: UpdateOnCallFormResponse) => void): Promise<UpdateOnCallFormResponse>;
    /**
     ...
     * 查询通知模板中配置的发送用户信息
     */
    DescribeAlarmNoticeOnCallUsersFromPrometheusAlertID(req: DescribeAlarmNoticeOnCallUsersFromPrometheusAlertIDRequest, cb?: (error: string, rep: DescribeAlarmNoticeOnCallUsersFromPrometheusAlertIDResponse) => void): Promise<DescribeAlarmNoticeOnCallUsersFromPrometheusAlertIDResponse>;
    /**
     * 获取基础指标属性
     */
...
| /alertmanager/api/v2/silence/{id} | GET, DELETE | 告警静默详情查询/删除 |
     */
    RoutePrometheusDynamicAPI(req: RoutePrometheusDynamicAPIRequest, cb?: (error: string, rep: RoutePrometheusDynamicAPIResponse) => void): Promise<RoutePrometheusDynamicAPIResponse>;
    /**
...
同一项目下相同的告警策略类型，就会被设置为非默认。
     ...
     * 创建值班表
     */
    CreateOnCallForm(req: CreateOnCallFormRequest, cb?: (error: string, rep: CreateOnCallFormResponse) => void): Promise<CreateOnCallFormResponse>;
    /**
     * 修改告警策略绑定的告警通知模板
     */
     ...
     */
    DescribePrometheusAlertmanagerConfig(req: DescribePrometheusAlertmanagerConfigRequest, cb?: (error: string, rep: DescribePrometheusAlertmanagerConfigResponse) => void): Promise<DescribePrometheusAlertmanagerConfigResponse>;
    /**
...
支持单个告警分组下分别创建启用/禁用的告警规则。
     ...
     */
    ReplacePrometheusAlertmanagerConfig(req: ReplacePrometheusAlertmanagerConfigRequest, cb?: (error: string, rep: ReplacePrometheusAlertmanagerConfigResponse) => void): Promise<ReplacePrometheusAlertmanagerConfigResponse>;
    /**
     * 之前TPS接口，迁移后不需要
...
<li>如果参数为空，返回当前用户一定数量（Limit所指定的数量，默认为20）的实例。</li>
     ...
     * 查询值班表详情
     */
    DescribeOnCallForm(req: DescribeOnCallFormRequest, cb?: (error: string, rep: DescribeOnCallFormResponse) => void): Promise<DescribeOnCallFormResponse>;
    /**
     * 查询告警指标列表
     */
     ...
     * 删除值班表接口
     */
    DeleteOnCallForms(req: DeleteOnCallFormsRequest, cb?: (error: string, rep: DeleteOnCallFormsResponse) => void): Promise<DeleteOnCallFormsResponse>;
    /**
     * 删除2.0实例告警策略
     */
     ...
     * 一键启用（创建）某个云产品下的预设策略
     */
    EnablePredefinedPolicies(req: EnablePredefinedPoliciesRequest, cb?: (error: string, rep: EnablePredefinedPoliciesResponse) => void): Promise<EnablePredefinedPoliciesResponse>;
    /**
     ...
     * 查询值班列表
     */
    DescribeOnCallForms(req: DescribeOnCallFormsRequest, cb?: (error: string, rep: DescribeOnCallFormsResponse) => void): Promise<DescribeOnCallFormsResponse>;
    /**
...
配额不分地域，可从任意支持地域请求
     */
    DescribePrometheusCreateInstanceQuota(req?: DescribePrometheusCreateInstanceQuotaRequest, cb?: (error: string, rep: DescribePrometheusCreateInstanceQuotaResponse) => void): Promise<DescribePrometheusCreateInstanceQuotaResponse>;
    /**
     * 注册外部集群到云上 TMP 实例
     */
