...
export declare class Client extends AbstractClient {
     ...
     */
    DescribeWorkOrderCarCollectList(req: DescribeWorkOrderCarCollectListRequest, cb?: (error: string, rep: DescribeWorkOrderCarCollectListResponse) => void): Promise<DescribeWorkOrderCarCollectListResponse>;
    /**
     * 获取机位列表
     */
     ...
     */
    DescribeWorkOrderPersonnelCollectList(req: DescribeWorkOrderPersonnelCollectListRequest, cb?: (error: string, rep: DescribeWorkOrderPersonnelCollectListResponse) => void): Promise<DescribeWorkOrderPersonnelCollectListResponse>;
    /**
     ...
     */
    DescribeWorkOrderContactCollectList(req: DescribeWorkOrderContactCollectListRequest, cb?: (error: string, rep: DescribeWorkOrderContactCollectListResponse) => void): Promise<DescribeWorkOrderContactCollectListResponse>;
    /**
     * 创建设备上架工单
     */
