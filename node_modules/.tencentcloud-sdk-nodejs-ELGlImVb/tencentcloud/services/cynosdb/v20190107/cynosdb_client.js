...
class Client extends abstract_client_1.AbstractClient {
     ...
     * 更新集群的周期弹性策略
     */
    async ModifyClusterPeriodScalePolicy(req, cb) {
     ...
     * 查询可支持的集群类型列表
     */
    async DescribeClusterLevels(req, cb) {
     ...
     * 添加serverless集群只读实例
     */
    async AddServerlessRoInstances(req, cb) {
        return this.request("AddServerlessRoInstances", req, cb);
    }
    /**
     * 查询Serverless弹性扩容计划
     */
    async DescribeClusterServerlessScalePlans(req, cb) {
     ...
     * 创建集群的周期弹性策略
     */
    async CreateClusterPeriodScalePolicy(req, cb) {
     ...
     * 删除周期弹性策略
     */
    async DeleteClusterPeriodScalePolicy(req, cb) {
     ...
     * 查询集群内所有的周期弹性策略
     */
    async DescribeClusterPeriodScalePolicy(req, cb) {
     ...
     */
    async AddLibraDBInstances(req, cb) {
     ...
     * 取消Serverless集群的弹性计划
     */
    async CancelClusterServerlessScalePlan(req, cb) {
     ...
     */
    async DescribeSQLExecutionPlan(req, cb) {
