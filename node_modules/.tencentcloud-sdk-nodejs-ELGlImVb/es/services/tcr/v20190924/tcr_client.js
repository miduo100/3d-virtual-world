...
export class Client extends AbstractClient {
    ...
    async ListSkillVersions(req, cb) {
    ...
    async DescribeSkillDownloadInfo(req, cb) {
    ...
    async DescribeAIModelVersionDetail(req, cb) {
    ...
    async ModifyReplication(req, cb) {
    ...
    async ListAIModelVersions(req, cb) {
