...
export declare class Client extends AbstractClient {
     ...
     * 获取反弹Shell规则列表
     */
    DescribeMemShellRules(req: DescribeMemShellRulesRequest, cb?: (error: string, rep: DescribeMemShellRulesResponse) => void): Promise<DescribeMemShellRulesResponse>;
    /**
     * 大屏可视化获取主机相关统计
     */
     ...
     * 补丁详情
     */
    DescribeSkillInfo(req: DescribeSkillInfoRequest, cb?: (error: string, rep: DescribeSkillInfoResponse) => void): Promise<DescribeSkillInfoResponse>;
    /**
     * 根据任务id查询基线检测进度
     */
     ...
     * 应用防御事件详情
     */
    DescribeRaspEventDetailTCSS(req: DescribeRaspEventDetailTCSSRequest, cb?: (error: string, rep: DescribeRaspEventDetailTCSSResponse) => void): Promise<DescribeRaspEventDetailTCSSResponse>;
    /**
     * 该接口可以对入侵检测-文件查杀扫描检测
     */
     ...
     * 获取漏洞防御概览信息，包括事件趋势及插件开启情况
     */
    RaspEventOverview(req?: RaspEventOverviewRequest, cb?: (error: string, rep: RaspEventOverviewResponse) => void): Promise<RaspEventOverviewResponse>;
    /**
     * 获取全网勒索态势
     */
     ...
     * 应用防护事件列表接口
     */
    DescribeRaspEventTCSS(req: DescribeRaspEventTCSSRequest, cb?: (error: string, rep: DescribeRaspEventTCSSResponse) => void): Promise<DescribeRaspEventTCSSResponse>;
    /**
     * 导出弱口令配置列表
     */
     ...
     * 查询漏洞防御设置列表
     */
    DescribeVulDefenceSettingList(req: DescribeVulDefenceSettingListRequest, cb?: (error: string, rep: DescribeVulDefenceSettingListResponse) => void): Promise<DescribeVulDefenceSettingListResponse>;
    /**
     * 对旗舰版机器单次触发事件调查及告警回溯
     */
     ...
     * 应用防御事件详情
     */
    DescribeRaspEventDetailCWP(req: DescribeRaspEventDetailCWPRequest, cb?: (error: string, rep: DescribeRaspEventDetailCWPResponse) => void): Promise<DescribeRaspEventDetailCWPResponse>;
    /**
     * 资产指纹启动扫描
     */
...
预付费订单仅下单不支付,需要调用计费支付接口进行支付
     ...
     * 查询应用防护白名单规则
     */
    DescribeYDRaspBlackWhite(req: DescribeYDRaspBlackWhiteRequest, cb?: (error: string, rep: DescribeYDRaspBlackWhiteResponse) => void): Promise<DescribeYDRaspBlackWhiteResponse>;
    /**
     * 获取忽略规则主机列表
     */
     ...
     * 查询反弹shell系统策略配置
     */
    DescribeReverseShellSystemPolicyConfig(req: DescribeReverseShellSystemPolicyConfigRequest, cb?: (error: string, rep: DescribeReverseShellSystemPolicyConfigResponse) => void): Promise<DescribeReverseShellSystemPolicyConfigResponse>;
    /**
     * 大屏可视化主机安全防护引擎介绍
     */
     ...
     * 获取容器视角内存马扫描事件列表
     */
    DescribeRaspMemShellListTCSS(req: DescribeRaspMemShellListTCSSRequest, cb?: (error: string, rep: DescribeRaspMemShellListTCSSResponse) => void): Promise<DescribeRaspMemShellListTCSSResponse>;
    /**
     * 获取基线检测概览
     */
     ...
     * 查询应用防护授权列表
     */
    DescribeRaspLicenseList(req: DescribeRaspLicenseListRequest, cb?: (error: string, rep: DescribeRaspLicenseListResponse) => void): Promise<DescribeRaspLicenseListResponse>;
    /**
     * 查询java内存马和rasp的是否注入风险服务配置
     */
    DescribeInjectRiskyServiceSwitch(req?: DescribeInjectRiskyServiceSwitchRequest, cb?: (error: string, rep: DescribeInjectRiskyServiceSwitchResponse) => void): Promise<DescribeInjectRiskyServiceSwitchResponse>;
    /**
     ...
     * 应用防护事件列表接口
     */
    DescribeRaspEventCWP(req: DescribeRaspEventCWPRequest, cb?: (error: string, rep: DescribeRaspEventCWPResponse) => void): Promise<DescribeRaspEventCWPResponse>;
    /**
     * 获取基线修复列表
     */
     ...
     * 添加漏洞忽略规则
     */
    AddVulIgnoreRule(req: AddVulIgnoreRuleRequest, cb?: (error: string, rep: AddVulIgnoreRuleResponse) => void): Promise<AddVulIgnoreRuleResponse>;
    /**
     * 获取漏洞列表数据
     */
     ...
     * 获取扫码登录主机列表
     */
    DescribeLoginTypeHost(req: DescribeLoginTypeHostRequest, cb?: (error: string, rep: DescribeLoginTypeHostResponse) => void): Promise<DescribeLoginTypeHostResponse>;
    /**
     * 查询资产管理计划任务列表
     */
     ...
     * 获取漏洞防御策略和事件统计
     */
    DescribeVulDefenceOverviewCount(req?: DescribeVulDefenceOverviewCountRequest, cb?: (error: string, rep: DescribeVulDefenceOverviewCountResponse) => void): Promise<DescribeVulDefenceOverviewCountResponse>;
    /**
     ...
     * 获取容器视角应用防护内存马扫描事件详情
     */
    DescribeRaspMemShellDetailTCSS(req: DescribeRaspMemShellDetailTCSSRequest, cb?: (error: string, rep: DescribeRaspMemShellDetailTCSSResponse) => void): Promise<DescribeRaspMemShellDetailTCSSResponse>;
    /**
     * 批量添加异地登录白名单
     */
     ...
     * 重保防护授权插件详情列表
     */
    DescribeRaspPluginList(req: DescribeRaspPluginListRequest, cb?: (error: string, rep: DescribeRaspPluginListResponse) => void): Promise<DescribeRaspPluginListResponse>;
    /**
     * 获取日志直方图信息
     */
     ...
     * 查询反弹shell策略列表
     */
    DescribeShellPolicyList(req: DescribeShellPolicyListRequest, cb?: (error: string, rep: DescribeShellPolicyListResponse) => void): Promise<DescribeShellPolicyListResponse>;
    /**
     ...
     * 获取扫码登录全局配置
     */
    DescribeLoginTypeGlobalConf(req?: DescribeLoginTypeGlobalConfRequest, cb?: (error: string, rep: DescribeLoginTypeGlobalConfResponse) => void): Promise<DescribeLoginTypeGlobalConfResponse>;
    /**
     * 导出主机快照备份列表
     */
...
3）给定quuid列表，scope为0，quuids为用户选择quuid
     ...
     * 获取反弹Shell规则列表
     */
    DescribeReverseShellRulesAggregation(req: DescribeReverseShellRulesAggregationRequest, cb?: (error: string, rep: DescribeReverseShellRulesAggregationResponse) => void): Promise<DescribeReverseShellRulesAggregationResponse>;
    /**
     * 获取客户端异常事件
     */
