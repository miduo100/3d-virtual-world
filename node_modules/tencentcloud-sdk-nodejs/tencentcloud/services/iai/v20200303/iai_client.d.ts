...
- 公共参数中的签名方式请使用V3版本，即配置SignatureMethod参数为TC3-HMAC-SHA256。
     */
    DetectFaceSimilarity(req: DetectFaceSimilarityRequest, cb?: (error: string, rep: DetectFaceSimilarityResponse) => void): Promise<DetectFaceSimilarityResponse>;
    /**
     * 获取人员库信息。
     */
...
人脸静态活体检测（高精度版）接口于2022年8月1日 00:00起正式开始计费，采取后付费按量计费模式，详见[计费概述](https://cloud.tencent.com/document/product/867/17640)。
     */
    DetectLiveFaceAccurate(req: DetectLiveFaceAccurateRequest, cb?: (error: string, rep: DetectLiveFaceAccurateResponse) => void): Promise<DetectLiveFaceAccurateResponse>;
    /**
     * 避免官网歧义
