...
注：只有在主监启动前设置才生效，主监启动后设置，下次推流生效。
     ...
     * 该接口用于查询场景化视频任务进展及结果。
     */
    DescribeSceneVideoTask(req: DescribeSceneVideoTaskRequest, cb?: (error: string, rep: DescribeSceneVideoTaskResponse) => void): Promise<DescribeSceneVideoTaskResponse>;
    /**
     * 该接口用来查询某个导播台的水印列表。
     */
...
2. 点播源任务的重启，会根据VodRefreshType决定是续播还是从头开始播。
     ...
     * 该接口用于创建场景化视频任务。
     */
    CreateSceneVideoTask(req: CreateSceneVideoTaskRequest, cb?: (error: string, rep: CreateSceneVideoTaskResponse) => void): Promise<CreateSceneVideoTaskResponse>;
    /**
     * 获取直播垫片模板。
     */
