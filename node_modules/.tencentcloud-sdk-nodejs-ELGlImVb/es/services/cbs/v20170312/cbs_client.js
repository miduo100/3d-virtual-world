...
export class Client extends AbstractClient {
    ...
    async SwitchParameterCreateRemoteDisks(req, cb) {
    ...
    async InquirePriceCreateRemoteDisks(req, cb) {
    ...
    async DescribeRemoteDisksDeniedActions(req, cb) {
    ...
    async ModifyRemoteDiskAttributes(req, cb) {
        return this.request("ModifyRemoteDiskAttributes", req, cb);
    }
    async InquirePriceRenewRemoteDisks(req, cb) {
    ...
    async DetachRemoteDisks(req, cb) {
    ...
    async DescribeRemoteDiskConfigQuota(req, cb) {
    ...
    async AttachRemoteDisks(req, cb) {
