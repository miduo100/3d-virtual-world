...
export class Client extends AbstractClient {
    ...
    async DetectVideoSubtitleArea(req, cb) {
    ...
    async DetectVideoWatermark(req, cb) {
    ...
    async TextToSpeechAsync(req, cb) {
    ...
    async DescribeCloneViralTask(req, cb) {
    ...
    async DescribeAigcAudioTask(req, cb) {
    ...
    async DescribeTextToSpeechAsyncTask(req, cb) {
        return this.request("DescribeTextToSpeechAsyncTask", req, cb);
    }
    async UpdateVoice(req, cb) {
