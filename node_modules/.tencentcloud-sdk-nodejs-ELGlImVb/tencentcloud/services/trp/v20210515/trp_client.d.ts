...
import { DescribeScanStatsRequest, DescribeScanLogsResponse, DescribeRawScanLogsRequest, DescribeProductsRequest, CreateCorporationOrderResponse, ModifyProductResponse, ModifyProductRequest, ModifyCustomRuleRequest, DeleteCodeBatchRequest, DescribeMerchantsRequest, ModifyTraceCodeRequest, DescribeFlavorKingCycleBrandScanMetricsRequest, CreateMerchantRequest, DescribeCodeBatchByIdRequest, DescribeTraceCodeByIdResponse, DescribeProductsResponse, CreateTraceChainResponse, DescribeTraceDataListResponse, DescribeFlavorKingCycleBrandProvinceCityScanAnalysisResponse, ReportScanDetailResponse, DescribeTraceCodesRequest, DescribeFlavorKingCycleBrandScanAnalysisRequest, DescribeFlavorKingCycleBrandImportantProvinceUserAnalysisResponse, ModifyTraceDataResponse, AuthorizedTransferResponse, CreateCodeBatchResponse, DescribePlanQRCodesResponse, DescribePlanQRCodesRequest, DescribeFlavorKingCycleBrandProvinceScanAnalysisResponse, CreateCustomRuleRequest, DescribeCodePackStatusRequest, ModifyTraceDataRequest, DescribeCodeBatchsRequest, DescribeAgentCorpsResponse, ModifyTraceDataRanksResponse, CreateTraceCodesRequest, DescribeCodeBatchByIdResponse, DescribeCorpQuotasResponse, DescribeCodePackStatusResponse, EffectFeedbackResponse, DescribeFlavorKingCycleBrandImportantProvinceUserAnalysisRequest, ModifyCustomRuleResponse, ModifyMerchantResponse, DescribeFlavorKingCycleBrandProvinceScanAnalysisRequest, DescribeCodesByPackResponse, CreateTraceDataRequest, DownloadGEOResponse, CreateCodePackRequest, DescribeCorpQuotasRequest, AuthorizedTransferRequest, ReportBatchCallbackStatusRequest, DescribeCodeBatchesResponse, CreateProductResponse, CreateTraceCodesAsyncRequest, CreateCustomPackRequest, CreateCodeBatchRequest, DescribeCustomRuleByIdRequest, DescribeAgentCorpsRequest, ReportBatchCallbackStatusResponse, DescribeFlavorKingCycleBrandImportantProvinceScanAnalysisResponse, ReportScanDetailRequest, DeleteProductRequest, ModifyTraceDataRanksRequest, ModifyCustomRuleStatusResponse, CreateCustomPackResponse, ModifyMerchantRequest, DescribeTmpTokenResponse, DescribeCodePackUrlRequest, DeleteProductResponse, CreateChainBatchRequest, DeleteTraceDataResponse, ModifyCustomRuleStatusRequest, CreateCodePackResponse, DescribeFlavorKingCycleBrandImportantProvinceScanAnalysisRequest, DescribeMerchantByIdResponse, EffectFeedbackRequest, DescribeTraceDataByIdResponse, DownloadGEORequest, CreateTraceDataResponse, DescribeCustomRuleByIdResponse, DescribeCodeBatchsResponse, CreateCustomRuleResponse, DescribePlanQRCodeScanRecordsResponse, ModifyTraceCodeUnlinkRequest, DescribeCodePacksResponse, DescribeCodesByPackRequest, DescribeJobFileUrlRequest, CreateTraceCodesAsyncResponse, DescribePlanQRCodeScanRecordsRequest, DescribeCustomRulesRequest, CreateProductRequest, CreateChainBatchResponse, ModifyCodeBatchRequest, DescribeProductByIdRequest, DescribeTraceCodesResponse, CreateCorporationOrderRequest, CreateTraceCodesResponse, DeleteTraceDataRequest, DescribeScanLogsRequest, ModifyTraceCodeUnlinkResponse, DescribeCodeBatchesRequest, DescribeFlavorKingCycleBrandImportantCityScanAnalysisRequest, DescribeTmpTokenRequest, DescribeScanStatsResponse, CreateMerchantResponse, DescribeMerchantsResponse, DescribeRawScanLogsResponse, DescribeTraceDataListRequest, DescribeFlavorKingCycleBrandProvinceCityScanAnalysisRequest, DeleteMerchantResponse, DeleteCodeBatchResponse, CreateTraceChainRequest, DescribeFlavorKingCycleBrandScanMetricsResponse, DescribeFlavorKingCycleBrandScanAnalysisResponse, DescribeMerchantByIdRequest, DescribeFlavorKingCycleBrandImportantCityScanAnalysisResponse, DescribeTraceDataByIdRequest, DescribeProductByIdResponse, DescribeCodePacksRequest, DescribeJobFileUrlResponse, DescribeCustomRulesResponse, DescribeTraceCodeByIdRequest, ModifyCodeBatchResponse, ModifyTraceCodeResponse, DescribeCodePackUrlResponse, DeleteMerchantRequest } from "./trp_models";
/**
 * trp client
 * @class
 */
...
注意：溯源码必须属于指定的批次才会解绑
     ...
     * 统计扫码次数
     */
    DescribeFlavorKingCycleBrandScanAnalysis(req: DescribeFlavorKingCycleBrandScanAnalysisRequest, cb?: (error: string, rep: DescribeFlavorKingCycleBrandScanAnalysisResponse) => void): Promise<DescribeFlavorKingCycleBrandScanAnalysisResponse>;
    /**
     ...
     * 统计用户次数
     */
    DescribeFlavorKingCycleBrandImportantCityScanAnalysis(req: DescribeFlavorKingCycleBrandImportantCityScanAnalysisRequest, cb?: (error: string, rep: DescribeFlavorKingCycleBrandImportantCityScanAnalysisResponse) => void): Promise<DescribeFlavorKingCycleBrandImportantCityScanAnalysisResponse>;
    /**
     * 查询码包的二维码列表，上限 3 万
     */
     ...
     * 地理位置信息下载
     */
    DownloadGEO(req?: DownloadGEORequest, cb?: (error: string, rep: DownloadGEOResponse) => void): Promise<DownloadGEOResponse>;
    /**
     * 查询批次列表
     */
     ...
     * 扫码数据上报
     */
    ReportScanDetail(req: ReportScanDetailRequest, cb?: (error: string, rep: ReportScanDetailResponse) => void): Promise<ReportScanDetailResponse>;
    /**
     * 统计用户次数
     */
    DescribeFlavorKingCycleBrandImportantProvinceScanAnalysis(req: DescribeFlavorKingCycleBrandImportantProvinceScanAnalysisRequest, cb?: (error: string, rep: DescribeFlavorKingCycleBrandImportantProvinceScanAnalysisResponse) => void): Promise<DescribeFlavorKingCycleBrandImportantProvinceScanAnalysisResponse>;
    /**
     * 编辑商品
     */
     ...
     * 统计用户次数
     */
    DescribeFlavorKingCycleBrandImportantProvinceUserAnalysis(req: DescribeFlavorKingCycleBrandImportantProvinceUserAnalysisRequest, cb?: (error: string, rep: DescribeFlavorKingCycleBrandImportantProvinceUserAnalysisResponse) => void): Promise<DescribeFlavorKingCycleBrandImportantProvinceUserAnalysisResponse>;
    /**
     * 删除商户
     */
...
旧版接口已经弃用，新业务请使用新版的接口 DescribeCodeBatches
     ...
     * 统计用户次数
     */
    DescribeFlavorKingCycleBrandScanMetrics(req: DescribeFlavorKingCycleBrandScanMetricsRequest, cb?: (error: string, rep: DescribeFlavorKingCycleBrandScanMetricsResponse) => void): Promise<DescribeFlavorKingCycleBrandScanMetricsResponse>;
    /**
     * 新增批次
     */
     ...
     * 统计用户次数
     */
    DescribeFlavorKingCycleBrandProvinceScanAnalysis(req: DescribeFlavorKingCycleBrandProvinceScanAnalysisRequest, cb?: (error: string, rep: DescribeFlavorKingCycleBrandProvinceScanAnalysisResponse) => void): Promise<DescribeFlavorKingCycleBrandProvinceScanAnalysisResponse>;
    /**
     * 修改批次
     */
     ...
     * 统计用户次数
     */
    DescribeFlavorKingCycleBrandProvinceCityScanAnalysis(req: DescribeFlavorKingCycleBrandProvinceCityScanAnalysisRequest, cb?: (error: string, rep: DescribeFlavorKingCycleBrandProvinceCityScanAnalysisResponse) => void): Promise<DescribeFlavorKingCycleBrandProvinceCityScanAnalysisResponse>;
}
