 ...
 */
export interface CreateGroupLiveCodesRequest {
    /**
     * <p>低代码互动课堂的SdkAppId。</p>
     */
    SdkAppId: number;
 ...
 */
export interface CreateGroupLiveCodesResponse {
    /**
     * <p>分组直播参加码</p>
     */
    GroupLiveCodes?: Array<string>;
    /**
     * 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
     */
    RequestId?: string;
 ...
 */
export interface DescribeGroupLiveCodesRequest {
    /**
     * <p>学校ID</p>
     */
    SdkAppId?: number;
 ...
 */
export interface DescribeGroupLiveCodesResponse {
    /**
     * <p>分组直播参加码</p>
     */
    GroupLiveCodes?: Array<string>;
