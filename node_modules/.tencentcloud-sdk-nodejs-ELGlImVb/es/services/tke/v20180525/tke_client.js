...
export class Client extends AbstractClient {
    ...
    async RotateClusterToken(req, cb) {
    ...
    async DescribeControlPlaneLogs(req, cb) {
    ...
    async DescribeClusterSchedulerPolicy(req, cb) {
    ...
    async DisableControlPlaneLogs(req, cb) {
    ...
    async DescribeUserPermissions(req, cb) {
    ...
    async GrantUserPermissions(req, cb) {
    ...
    async ModifyClusterSchedulerPolicy(req, cb) {
    ...
    async EnableControlPlaneLogs(req, cb) {
    ...
    async DeleteUserPermissions(req, cb) {
