...
export class Client extends AbstractClient {
    ...
    async CreateDBDiagReportUrls(req, cb) {
    ...
    async DescribeDatabaseAutonomyStatus(req, cb) {
    ...
    async CreateIgnoreDiagRecord(req, cb) {
    ...
    async DescribeDBAuditLogTopSqls(req, cb) {
    ...
    async UpdateDatabaseAutonomyStatus(req, cb) {
