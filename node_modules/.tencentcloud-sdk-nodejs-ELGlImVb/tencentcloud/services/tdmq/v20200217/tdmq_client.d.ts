...
当前 API 适用集群：4.x 通用集群。查询 5.x 集群的售卖规格接口文档见 [DescribeProductSKUs](https://cloud.tencent.com/document/api/1493/107676)。
     */
    DescribeRocketMQGeneralSKUs(req?: DescribeRocketMQGeneralSKUsRequest, cb?: (error: string, rep: DescribeRocketMQGeneralSKUsResponse) => void): Promise<DescribeRocketMQGeneralSKUsResponse>;
    /**
     * 枚举cmq全量主题
     */
...
当前 API 适用集群：4.x 虚拟集群，4.x 专享集群 和 4.x 通用集群。创建 5.x 集群消费组的接口文档见 [CreateConsumerGroup](https://cloud.tencent.com/document/api/1493/97943)。
     */
    CreateRocketMQGroupV2(req: CreateRocketMQGroupV2Request, cb?: (error: string, rep: CreateRocketMQGroupV2Response) => void): Promise<CreateRocketMQGroupV2Response>;
    /**
     * 查询 RocketMQ 虚拟集群列表。
...
当前 API 适用集群：4.x 虚拟集群和 4.x 专享集群，其他集群类型均不支持该功能。
     ...
     */
    CreateRocketMQMigrationTask(req: CreateRocketMQMigrationTaskRequest, cb?: (error: string, rep: CreateRocketMQMigrationTaskResponse) => void): Promise<CreateRocketMQMigrationTaskResponse>;
    /**
     * 创建 RocketMQ 集群。
...
当前 API 适用集群：4.x 虚拟集群，4.x 专享集群 和 4.x 通用集群。5.x 集群的删除角色接口文档见 [DeleteRole](https://cloud.tencent.com/document/api/1493/98863)。
     ...
     * 创建RocketMQ Router规则
     */
    CreateRocketMQRouterRule(req: CreateRocketMQRouterRuleRequest, cb?: (error: string, rep: CreateRocketMQRouterRuleResponse) => void): Promise<CreateRocketMQRouterRuleResponse>;
    /**
     * 运营端获取命名空间bundle列表
     */
