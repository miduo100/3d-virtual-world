...
export class Client extends AbstractClient {
    ...
    async AddOrModifyMaliciousConnectionWhiteList(req, cb) {
    ...
    async DescribeVirusScanConfig(req, cb) {
    ...
    async AddOrModifyVirusWhiteListRule(req, cb) {
    ...
    async DescribeVirusMonitorConfig(req, cb) {
    ...
    async DescribeVirusWhiteListRules(req, cb) {
    ...
    async DeleteVirusWhiteListRule(req, cb) {
