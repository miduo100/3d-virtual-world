...
export declare class Client extends AbstractClient {
     ...
     * 跨集群灾备场景下查询设备证书同步记录
     */
    DescribeDeviceCertificateBackupHistory(req: DescribeDeviceCertificateBackupHistoryRequest, cb?: (error: string, rep: DescribeDeviceCertificateBackupHistoryResponse) => void): Promise<DescribeDeviceCertificateBackupHistoryResponse>;
    /**
     * 创建一条消息属性增强规则
     */
...
2. TopicType，主题类型查询，支持多选，可选值：Normal,Order,Transaction,DelayScheduled
     ...
     * 遗嘱消息查询
     */
    DescribeWillMessage(req: DescribeWillMessageRequest, cb?: (error: string, rep: DescribeWillMessageResponse) => void): Promise<DescribeWillMessageResponse>;
    /**
     * 购买新的MQTT实例
     */
...
当使用TagFilters查询时，Filters参数失效。
     ...
     * 跨集群容灾场景下查询设备标识同步记录
     */
    DescribeDeviceIdentityBackupHistory(req: DescribeDeviceIdentityBackupHistoryRequest, cb?: (error: string, rep: DescribeDeviceIdentityBackupHistoryResponse) => void): Promise<DescribeDeviceIdentityBackupHistoryResponse>;
    /**
     * 查询设备一机一密标识
     */
