...
import { DescribeSlowLogTimeSeriesStatsRequest, DescribeUserAutonomyProfileRequest, DescribeMetricTopProxiesResponse, DescribeDBAuditLogTopSqlsRequest, DescribeDBAutonomyActionsRequest, CancelDBAutonomyActionResponse, OpenAuditServiceResponse, DescribeUserAutonomyProfileResponse, DescribeRedisTopHotKeysRequest, CreateDBDiagReportTaskRequest, DescribeDBDiagReportContentRequest, DescribeAuditLogFilesResponse, DescribeIndexRecommendAggregationSlowLogsRequest, DescribeSlowLogsRequest, DescribeRedisCmdPerfTimeSeriesRequest, CreateRedisBigKeyAnalysisTaskResponse, UpdateDatabaseAutonomyStatusRequest, CreateSecurityAuditLogExportTaskRequest, DescribeTopSpaceTableTimeSeriesResponse, DescribeDBDiagEventResponse, DescribeDBDiagHistoryRequest, DescribeDBAutonomyActionsResponse, DescribeSlowLogTopSqlsRequest, DescribeRedisBigKeyAnalysisTasksResponse, DescribeDBDiagReportTasksResponse, AddUserContactResponse, CancelKillTaskResponse, DescribeRedisTopBigKeysResponse, DescribeSqlTemplateRequest, DescribeTopSpaceSchemaTimeSeriesResponse, ModifySqlFiltersRequest, CreateKillTaskResponse, DescribeAuditInstanceListResponse, DescribeRedisSlowLogTopSqlsResponse, DescribeDBInstancesResponse, CreateUserAutonomyProfileResponse, DescribeProxySessionKillTasksRequest, ModifyAlarmPolicyResponse, ModifyUserAutonomyProfileResponse, DescribeIndexRecommendInfoResponse, CreateRedisBigKeyAnalysisTaskRequest, DescribeMySqlProcessListResponse, UpdateMonitorSwitchRequest, DescribeRedisSlowLogTopSqlsRequest, DescribeTopSpaceTablesResponse, DescribeMongoDBProcessListRequest, DescribeDatabaseAutonomyStatusRequest, KillMySqlThreadsResponse, CreateSchedulerMailProfileRequest, DescribeDBAutonomyEventsResponse, DeleteAuditLogFileResponse, DescribeDBSpaceStatusRequest, DescribeRedisProcessListRequest, DescribeRedisCommandCostStatisticsRequest, ModifyDiagDBInstanceConfRequest, DescribeSlowLogsResponse, DescribeSecurityAuditLogDownloadUrlsRequest, CreateDBDiagReportTaskResponse, DescribeDBInstancesRequest, CreateDBDiagReportUrlsResponse, UpdateMonitorSwitchResponse, DescribeDBAutonomyActionRequest, DescribeRedisTopKeyPrefixListRequest, CancelKillTaskRequest, CreateIgnoreDiagRecordResponse, CreateAuditLogFileResponse, OpenAuditServiceRequest, DescribeDatabaseAutonomyStatusResponse, DeleteSqlFiltersResponse, DescribeHealthScoreTimeSeriesRequest, DescribeDBDiagEventsRequest, CreateDBDiagReportUrlsRequest, CreateDBDiagReportUrlResponse, DescribeRedisUnExpiredKeyStatisticsResponse, CreateProxySessionKillTaskRequest, DeleteDBDiagReportTasksResponse, DescribeProxyProcessStatisticsResponse, DescribeHealthScoreTimeSeriesResponse, UpdateAgentSwitchRequest, DescribeRedisCmdPerfTimeSeriesResponse, ModifySqlFiltersResponse, CreateMailProfileRequest, UpdateAgentSwitchResponse, VerifyUserAccountRequest, DescribeSlowLogUserHostStatsResponse, DescribeIndexRecommendInfoRequest, DescribeMailProfileRequest, ModifyAuditServiceRequest, DeleteSecurityAuditLogExportTasksResponse, KillMySqlThreadsRequest, DescribeSqlFiltersResponse, CreateDBDiagReportUrlRequest, CloseAuditServiceResponse, UpdateDatabaseAutonomyStatusResponse, DeleteRedisBigKeyAnalysisTasksResponse, CloseAuditServiceRequest, DescribeSqlTemplateResponse, DescribeRedisTopCostCommandsRequest, DescribeDBDiagHistoryResponse, CreateUserAutonomyProfileRequest, DescribeAllUserContactResponse, DescribeRedisCommandCostStatisticsResponse, CancelDBAutonomyEventResponse, AddUserContactRequest, CreateSqlFilterRequest, CreateMongoDBKillTaskRequest, DescribeTopSpaceTablesRequest, DescribeRedisTopCostCommandsResponse, DescribeAllUserContactRequest, DescribeDBDiagEventRequest, DescribeNoPrimaryKeyTablesRequest, DescribeTopSpaceSchemasRequest, DescribeAuditInstanceListRequest, DescribeRedisBigKeyAnalysisTasksRequest, DescribeSqlFiltersRequest, DescribeSecurityAuditLogExportTasksRequest, DescribeRedisUnExpiredKeyStatisticsRequest, DeleteSecurityAuditLogExportTasksRequest, CreateSchedulerMailProfileResponse, DescribeAlarmTemplateResponse, DescribeTopSpaceSchemaTimeSeriesRequest, DescribeDBAuditLogTopSqlsResponse, DescribeIndexRecommendAggregationSlowLogsResponse, DescribeDBDiagEventsResponse, DescribeMailProfileResponse, DescribeRedisTopBigKeysRequest, ModifyUserAutonomyProfileRequest, DescribeMetricTopProxiesRequest, CancelRedisBigKeyAnalysisTasksRequest, ModifyAuditServiceResponse, DescribeDBAutonomyEventsRequest, DescribeHealthScoreRequest, CreateIgnoreDiagRecordRequest, DeleteRedisBigKeyAnalysisTasksRequest, DescribeDiagDBInstancesResponse, DescribeAllUserGroupRequest, CreateKillTaskRequest, DescribeRedisTopHotKeysResponse, CreateSecurityAuditLogExportTaskResponse, DescribeRedisCommandOverviewResponse, CreateSqlFilterResponse, DescribeSlowLogUserHostStatsRequest, DescribeTopSpaceSchemasResponse, DescribeSlowLogQueryTimeStatsResponse, CreateProxySessionKillTaskResponse, CancelDBAutonomyActionRequest, DeleteDBDiagReportTasksRequest, DescribeAlarmTemplateRequest, VerifyUserAccountResponse, DescribeSlowLogTimeSeriesStatsResponse, DescribeProxyProcessStatisticsRequest, ModifyAlarmPolicyRequest, CreateMongoDBKillTaskResponse, DescribeRedisCommandOverviewRequest, DescribeAllUserGroupResponse, DescribeRedisProcessListResponse, CreateAuditLogFileRequest, DeleteAuditLogFileRequest, ModifyDiagDBInstanceConfResponse, DescribeUserSqlAdviceResponse, DescribeDBSpaceStatusResponse, CancelDBAutonomyEventRequest, DescribeTopSpaceTableTimeSeriesRequest, DescribeUserSqlAdviceRequest, DescribeDBAutonomyActionResponse, DescribeDBDiagReportTasksRequest, DescribeDBPerfTimeSeriesResponse, DescribeRedisTopKeyPrefixListResponse, DescribeHealthScoreResponse, DescribeMongoDBProcessListResponse, CancelRedisBigKeyAnalysisTasksResponse, DescribeSecurityAuditLogExportTasksResponse, DescribeDBDiagReportContentResponse, DescribeSlowLogTopSqlsResponse, DescribeNoPrimaryKeyTablesResponse, DescribeDBPerfTimeSeriesRequest, DescribeAuditLogFilesRequest, DeleteSqlFiltersRequest, CreateMailProfileResponse, DescribeDiagDBInstancesRequest, DescribeMySqlProcessListRequest, DescribeSecurityAuditLogDownloadUrlsResponse, DescribeSlowLogQueryTimeStatsRequest, DescribeProxySessionKillTasksResponse } from "./dbbrain_models";
/**
 * dbbrain client
 * @class
 */
export declare class Client extends AbstractClient {
     ...
     */
    CreateDBDiagReportUrls(req: CreateDBDiagReportUrlsRequest, cb?: (error: string, rep: CreateDBDiagReportUrlsResponse) => void): Promise<CreateDBDiagReportUrlsResponse>;
    /**
     * 延迟分析-查询实例访问命令统计
     */
     ...
     */
    DescribeDatabaseAutonomyStatus(req: DescribeDatabaseAutonomyStatusRequest, cb?: (error: string, rep: DescribeDatabaseAutonomyStatusResponse) => void): Promise<DescribeDatabaseAutonomyStatusResponse>;
    /**
     ...
     */
    CreateIgnoreDiagRecord(req: CreateIgnoreDiagRecordRequest, cb?: (error: string, rep: CreateIgnoreDiagRecordResponse) => void): Promise<CreateIgnoreDiagRecordResponse>;
    /**
     * 查询健康报告生成任务列表。
     */
     ...
     */
    DescribeDBAuditLogTopSqls(req: DescribeDBAuditLogTopSqlsRequest, cb?: (error: string, rep: DescribeDBAuditLogTopSqlsResponse) => void): Promise<DescribeDBAuditLogTopSqlsResponse>;
    /**
     * 更新Agent实例状态（停止或重连实例）
     */
     ...
     */
    UpdateDatabaseAutonomyStatus(req: UpdateDatabaseAutonomyStatusRequest, cb?: (error: string, rep: UpdateDatabaseAutonomyStatusResponse) => void): Promise<UpdateDatabaseAutonomyStatusResponse>;
    /**
     * 开启数据库审计服务
     */
