...
| /alertmanager/api/v2/silence/{id} | GET | 告警静默详情查询 |
     ...
     * 查询通知模板中配置的发送用户信息
     */
    async DescribeAlarmNoticeOnCallUsersFromPrometheusAlertID(req, cb) {
...
| /alertmanager/api/v2/silence/{id} | GET, DELETE | 告警静默详情查询/删除 |
     */
    async RoutePrometheusDynamicAPI(req, cb) {
...
同一项目下相同的告警策略类型，就会被设置为非默认。
     ...
     */
    async DescribePrometheusAlertmanagerConfig(req, cb) {
...
支持单个告警分组下分别创建启用/禁用的告警规则。
     ...
     */
    async ReplacePrometheusAlertmanagerConfig(req, cb) {
...
<li>如果参数为空，返回当前用户一定数量（Limit所指定的数量，默认为20）的实例。</li>
     ...
     * 查询值班表详情
     */
    async DescribeOnCallForm(req, cb) {
     ...
     * 删除值班表接口
     */
    async DeleteOnCallForms(req, cb) {
     ...
     * 一键启用（创建）某个云产品下的预设策略
     */
    async EnablePredefinedPolicies(req, cb) {
     ...
     * 查询值班列表
     */
    async DescribeOnCallForms(req, cb) {
...
配额不分地域，可从任意支持地域请求
     */
    async DescribePrometheusCreateInstanceQuota(req, cb) {
