...
export declare class Client extends AbstractClient {
     ...
     */
    ModifyInstanceDestroyProtect(req: ModifyInstanceDestroyProtectRequest, cb?: (error: string, rep: ModifyInstanceDestroyProtectResponse) => void): Promise<ModifyInstanceDestroyProtectResponse>;
    /**
...
说明：参数模板为公共组件，配置完成后全地域生效。接口调用配置地域可选择广州、新加坡。
     ...
     */
    UpgradeRoGroup(req: UpgradeRoGroupRequest, cb?: (error: string, rep: UpgradeRoGroupResponse) => void): Promise<UpgradeRoGroupResponse>;
    /**
