...
import { CreateRecordRequest, DescribeDomainListRequest, CreateSubdomainValidateTXTValueRequest, CreateTXTRecordResponse, ModifyDomainToGroupRequest, RollbackSnapshotRequest, DeleteDomainAliasResponse, CreateLineGroupResponse, DescribeDomainShareUserListResponse, DescribeVASStatisticRequest, DeleteDomainBatchResponse, DescribeDomainVipListResponse, ModifySubdomainStatusRequest, DownloadSnapshotRequest, CreateRecordBatchResponse, DescribeSnapshotListResponse, DescribeDomainLogFilterFileRequest, ModifyRecordGroupRequest, DescribeVASStatisticResponse, RollbackSnapshotResponse, DescribeBatchTaskRequest, CreateSnapshotResponse, DescribeDomainCustomLineListRequest, DeleteRecordGroupRequest, PayOrderWithBalanceResponse, DescribeRecordTypeResponse, DescribeDomainResponse, DescribeSnapshotListRequest, DescribePackageDetailResponse, DescribeDomainFilterListResponse, DescribeRecordLineListResponse, CreateDomainBatchRequest, DescribeDomainShareInfoRequest, ModifyRecordGroupResponse, CreateSubDomainsAnalyticsFileResponse, DescribeFileInfoByJobIdRequest, DeleteDomainBatchRequest, DeleteDomainCustomLineRequest, DescribeSnapshotRollbackResultResponse, DescribeRecordLineCategoryListResponse, CreateLineGroupCopyRequest, DescribeLineGroupListRequest, ModifyRecordResponse, DeleteSnapshotRequest, DeleteRecordBatchResponse, DescribeDomainAliasListResponse, ModifyLineGroupRequest, RollbackRecordSnapshotRequest, ModifyRecordToGroupRequest, DescribeSnapshotConfigResponse, DeleteShareDomainResponse, DescribeDomainAndRecordListResponse, ModifyDomainRemarkResponse, DeleteDomainRequest, ModifyDomainOwnerRequest, DescribeSubdomainAnalyticsResponse, ModifyPackageDomainResponse, DescribeSnapshotConfigRequest, ModifyRecordBatchV3Request, DeleteLineGroupResponse, DescribeRecordLineListRequest, DescribeDomainVipListRequest, CreateRecordBatchRequest, DeleteDomainAliasRequest, CreateDealRequest, ModifyDomainLockRequest, DescribeDomainWhoisRequest, ModifyTXTRecordRequest, ModifyDomainStatusResponse, DescribeRecordRequest, ModifyRecordBatchV3Response, CreateDomainGroupResponse, DescribeSubdomainAnalyticsRequest, DeleteRecordRequest, DescribeDomainRequest, DeleteLineGroupRequest, ModifyRecordStatusRequest, CreateRecordResponse, DeleteRecordGroupResponse, ModifyDomainRecursiveStatusBatchResponse, DescribeSnapshotRollbackTaskRequest, CheckRecordSnapshotRollbackResponse, DescribeDomainPreviewRequest, DescribeRecordResponse, DescribeRecordLineCategoryListRequest, ModifyRecordToGroupResponse, DescribeLineGroupListResponse, ModifyDomainUnlockResponse, DescribeDomainLogListRequest, DescribeDomainListResponse, DescribeUserDetailResponse, ModifyRecordBatchRequest, ModifyRecordFieldsResponse, DeleteRecordResponse, CreateDomainResponse, CreateSubdomainValidateTXTValueResponse, ModifyDomainToGroupResponse, ModifyPackageAutoRenewResponse, ModifyRecordBatchResponse, CheckSnapshotRollbackRequest, CheckSnapshotRollbackResponse, CreateAndPayDealResponse, DescribeRecordTypeRequest, DeleteDomainCustomLineResponse, DescribeSnapshotRollbackTaskResponse, DescribeDomainPreviewResponse, CreateDomainBatchResponse, DescribeDomainShareInfoResponse, ModifyDomainOwnerResponse, ModifyDomainRecursiveStatusBatchRequest, DescribeSnapshotRollbackResultRequest, DescribeDomainShareUserListRequest, CreateDomainRequest, ModifyDomainCustomLineRequest, DescribeDomainGroupListResponse, ModifyPackageAutoRenewRequest, CreateDomainsAnalyticsFileRequest, ModifyDomainRemarkRequest, ModifyDomainCustomLineResponse, DescribeVasListRequest, CreateLineGroupCopyResponse, CreateDomainAliasResponse, DescribeDomainLogFilterFileResponse, DescribeRecordListRequest, PayOrderWithBalanceRequest, CreateTXTRecordRequest, DescribePackageDetailRequest, DescribeRecordFilterListRequest, ModifyVasAutoRenewStatusResponse, ModifyRecordFieldsRequest, DeleteSnapshotResponse, DescribeDomainPurviewResponse, ModifySubdomainStatusResponse, DescribeSubdomainValidateStatusResponse, DescribeDomainAnalyticsResponse, ModifyRecordStatusResponse, CreateRecordGroupRequest, DescribeDomainAndRecordListRequest, DescribeRecordGroupListResponse, ModifyDomainCNAMESpeedupStatusBatchRequest, DescribeSubdomainValidateStatusRequest, CreateDomainGroupRequest, CreateSnapshotRequest, ModifyPackageDomainRequest, DeleteDomainResponse, DescribeRecordSnapshotRollbackResultResponse, DescribeVasListResponse, ModifySnapshotConfigRequest, DescribeResolveCountRequest, DescribeDomainAliasListRequest, CreateDomainAliasRequest, DeleteShareDomainRequest, ModifyLineGroupResponse, ModifyDynamicDNSRequest, DescribeRecordGroupListRequest, DescribeDomainFilterListRequest, CreateSubDomainsAnalyticsFileRequest, DescribeRecordExistExceptDefaultNSRequest, ModifyDomainCNAMESpeedupStatusBatchResponse, ModifySnapshotConfigResponse, DescribeRecordFilterListResponse, DescribeUserDetailRequest, DescribeFileInfoByJobIdResponse, ModifyDomainStatusRequest, ModifyRecordRemarkResponse, CreateAndPayDealRequest, DescribeDomainCustomLineListResponse, ModifyRecordRemarkRequest, DeleteRecordBatchRequest, DescribeDomainPurviewRequest, ModifyDomainUnlockRequest, DescribeRecordSnapshotRollbackResultRequest, ModifyDomainLockResponse, DescribeRecordListResponse, CreateLineGroupRequest, CreateDomainCustomLineRequest, RollbackRecordSnapshotResponse, CreateDealResponse, DescribeRecordExistExceptDefaultNSResponse, ModifyTXTRecordResponse, ModifyVasAutoRenewStatusRequest, DescribeResolveCountResponse, DownloadSnapshotResponse, DescribeDomainWhoisResponse, CreateRecordGroupResponse, DescribeDomainGroupListRequest, DescribeBatchTaskResponse, CheckRecordSnapshotRollbackRequest, CreateDomainCustomLineResponse, DescribeDomainAnalyticsRequest, ModifyDynamicDNSResponse, ModifyRecordRequest, DescribeDomainLogListResponse, CreateDomainsAnalyticsFileResponse } from "./dnspod_models";
/**
 * dnspod client
 * @class
 */
...
备注：新添加的解析记录存在短暂的索引延迟，如果查询不到新增记录，请在 30 秒后重试
     ...
     * 批量修改域名递归解析加速状态
     */
    ModifyDomainRecursiveStatusBatch(req: ModifyDomainRecursiveStatusBatchRequest, cb?: (error: string, rep: ModifyDomainRecursiveStatusBatchResponse) => void): Promise<ModifyDomainRecursiveStatusBatchResponse>;
    /**
     * 获取域名别名列表
     */
     ...
     * DNSPod商品下单并支付
     */
    CreateAndPayDeal(req: CreateAndPayDealRequest, cb?: (error: string, rep: CreateAndPayDealResponse) => void): Promise<CreateAndPayDealResponse>;
    /**
     * 获取某个域名下的解析记录列表
备注：
...
2.  API获取的记录总条数会比控制台多2条，原因是： 为了防止用户误操作导致解析服务不可用，对2021-10-29 14:24:26之后添加的域名，在控制台都不显示这2条NS记录。
     ...
     * 批量修改域名CNAME加速状态
     */
    ModifyDomainCNAMESpeedupStatusBatch(req: ModifyDomainCNAMESpeedupStatusBatchRequest, cb?: (error: string, rep: ModifyDomainCNAMESpeedupStatusBatchResponse) => void): Promise<ModifyDomainCNAMESpeedupStatusBatchResponse>;
    /**
     * 修改域名的自定义线路
     */
...
备注：新添加的解析记录存在短暂的索引延迟，如果查询不到新增记录，请在 30 秒后重试
     ...
     * 批量修改记录
     */
    ModifyRecordBatchV3(req: ModifyRecordBatchV3Request, cb?: (error: string, rep: ModifyRecordBatchV3Response) => void): Promise<ModifyRecordBatchV3Response>;
    /**
     * 获取域名操作日志导出文件下载地址
     */
    DescribeDomainLogFilterFile(req: DescribeDomainLogFilterFileRequest, cb?: (error: string, rep: DescribeDomainLogFilterFileResponse) => void): Promise<DescribeDomainLogFilterFileResponse>;
    /**
     * 套餐绑定、解绑、更换域名
     */
    ModifyPackageDomain(req: ModifyPackageDomainRequest, cb?: (error: string, rep: ModifyPackageDomainResponse) => void): Promise<ModifyPackageDomainResponse>;
    /**
     * 创建域名别名
     */
